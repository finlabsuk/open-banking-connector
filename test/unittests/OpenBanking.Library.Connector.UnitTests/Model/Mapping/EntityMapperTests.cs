...
using OBAddressTypeCode =
    FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model.OBAddressTypeCode;
...
namespace FinnovationLabs.OpenBanking.Library.Connector.UnitTests.Model.Mapping
{
    public class EntityMapperTests
    {
        ...
        public void PublicToOpenBanking_SimpleMap_To_v3_1_1()
        {
            ...
            var r1 =
                mapper.Map(m1, typeof(ObModel.PaymentInitiation.V3p1p1.Model.Meta)) as
                    ObModel.PaymentInitiation.V3p1p1.Model.Meta;
        ...
        public void PublicToOpenBanking_SimpleMap_To_v3_1_2_RC1()
        {
            ...
            var r1 =
                mapper.Map(m1, typeof(ObModel.PaymentInitiation.V3p1p2.Model.Meta)) as
                    ObModel.PaymentInitiation.V3p1p2.Model.Meta;
        ...
        public void OpenBankingToPublic_SimpleMap_V3_1_1_ToPublic()
        {
            ...
            var m1 = new ObModel.PaymentInitiation.V3p1p1.Model.Meta
            {
                FirstAvailableDateTime = DateTime.MaxValue,
                LastAvailableDateTime = DateTime.UnixEpoch,
                TotalPages = 123
        ...
        public void OpenBankingToPublic_SimpleMap_V3_1_2_RC1_ToPublic()
        {
            ...
            var m1 = new ObModel.PaymentInitiation.V3p1p2.Model.Meta
            {
                FirstAvailableDateTime = DateTime.MaxValue,
                LastAvailableDateTime = DateTime.UnixEpoch,
                TotalPages = 123
