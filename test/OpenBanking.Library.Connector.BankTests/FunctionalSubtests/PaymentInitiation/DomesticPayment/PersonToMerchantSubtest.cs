...
namespace FinnovationLabs.OpenBanking.Library.Connector.BankTests.FunctionalSubtests.PaymentInitiation.DomesticPayment
{
    ...
    {
        public static DomesticPaymentFunctionalSubtest PersonToMerchantSubtest { get; } =
            new DomesticPaymentFunctionalSubtest(
                domesticPaymentFunctionalSubtestEnum: DomesticPaymentFunctionalSubtestEnum.PersonToMerchantSubtest);
    }
}
