...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDomestic2 :  IEquatable<OBWriteDomestic2>, IValidatableObject
    {
        ...
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomestic2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomestic2" /> class.
        /// </summary>
        /// <param name="data">data (required).</param>
        /// <param name="risk">risk (required).</param>
        public OBWriteDomestic2(OBWriteDataDomestic2 data = default(OBWriteDataDomestic2), OBRisk1 risk = default(OBRisk1))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for OBWriteDomestic2 and cannot be null");
            }
            else
            {
                this.Data = data;
            ...
            if (risk == null)
            {
                throw new InvalidDataException("risk is a required property for OBWriteDomestic2 and cannot be null");
            }
            else
            {
                this.Risk = risk;
        ...
        public OBWriteDataDomestic2 Data { get; set; }
