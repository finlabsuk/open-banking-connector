...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBDomestic2 :  IEquatable<OBDomestic2>, IValidatableObject
    {
        ...
        public OBDomestic2(string instructionIdentification = default(string), string endToEndIdentification = default(string), string localInstrument = default(string), OBInternational2InstructedAmount instructedAmount = default(OBInternational2InstructedAmount), OBCashAccountDebtor4 debtorAccount = default(OBCashAccountDebtor4), OBCashAccountCreditor3 creditorAccount = default(OBCashAccountCreditor3), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6), OBRemittanceInformation1 remittanceInformation = default(OBRemittanceInformation1), OBSupplementaryData1 supplementaryData = default(OBSupplementaryData1))
        {
            ...
            {
                throw new InvalidDataException("endToEndIdentification is a required property for OBDomestic2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instructedAmount is a required property for OBDomestic2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditorAccount is a required property for OBDomestic2 and cannot be null");
            }
            else
            {
