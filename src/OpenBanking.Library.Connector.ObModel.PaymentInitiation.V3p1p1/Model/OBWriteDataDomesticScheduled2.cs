...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDataDomesticScheduled2 :  IEquatable<OBWriteDataDomesticScheduled2>, IValidatableObject
    {
        ...
        public OBWriteDataDomesticScheduled2(string consentId = default(string), OBDomesticScheduled2 initiation = default(OBDomesticScheduled2))
        {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataDomesticScheduled2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataDomesticScheduled2 and cannot be null");
            }
            else
            {
