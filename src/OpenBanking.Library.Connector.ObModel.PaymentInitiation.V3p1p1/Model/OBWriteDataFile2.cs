...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataFile2 :  IEquatable<OBWriteDataFile2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataFile2" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataFile2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataFile2" /> class.
        /// </summary>
        ...
        public OBWriteDataFile2(string consentId = default(string), OBFile2 initiation = default(OBFile2))
        {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataFile2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataFile2 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDataFile2);
        }

        /// <summary>
        /// Returns true if OBWriteDataFile2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataFile2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataFile2 input)
        {
            if (input == null)
                return false;
