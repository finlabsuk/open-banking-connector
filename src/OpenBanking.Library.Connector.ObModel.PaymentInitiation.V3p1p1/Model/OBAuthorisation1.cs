...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBAuthorisation1 :  IEquatable<OBAuthorisation1>, IValidatableObject
    {
        ...
        public OBAuthorisation1(OBExternalAuthorisation1Code authorisationType = default(OBExternalAuthorisation1Code), DateTime? completionDateTime = default(DateTime?))
        {
            // to ensure "authorisationType" is required (not null)
            if (authorisationType == null)
            {
                throw new InvalidDataException("authorisationType is a required property for OBAuthorisation1 and cannot be null");
            }
            else
            {
