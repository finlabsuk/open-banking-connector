...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDataDomestic2 :  IEquatable<OBWriteDataDomestic2>, IValidatableObject
    {
        ...
        public OBWriteDataDomestic2(string consentId = default(string), OBDomestic2 initiation = default(OBDomestic2))
        {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataDomestic2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataDomestic2 and cannot be null");
            }
            else
            {
