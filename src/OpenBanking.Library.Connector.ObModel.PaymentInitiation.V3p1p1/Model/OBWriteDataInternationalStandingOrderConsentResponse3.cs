...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataInternationalStandingOrderConsentResponse3 :  IEquatable<OBWriteDataInternationalStandingOrderConsentResponse3>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataInternationalStandingOrderConsentResponse3" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataInternationalStandingOrderConsentResponse3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataInternationalStandingOrderConsentResponse3" /> class.
        /// </summary>
        ...
        public OBWriteDataInternationalStandingOrderConsentResponse3(string consentId = default(string), DateTime? creationDateTime = default(DateTime?), OBExternalConsentStatus1Code status = default(OBExternalConsentStatus1Code), DateTime? statusUpdateDateTime = default(DateTime?), OBExternalPermissions2Code permission = default(OBExternalPermissions2Code), DateTime? cutOffDateTime = default(DateTime?), List<OBCharge2> charges = default(List<OBCharge2>), OBInternationalStandingOrder3 initiation = default(OBInternationalStandingOrder3), OBAuthorisation1 authorisation = default(OBAuthorisation1))
        {
            // to ensure "consentId" is required (not null)
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataInternationalStandingOrderConsentResponse3 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDataInternationalStandingOrderConsentResponse3 and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDataInternationalStandingOrderConsentResponse3 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDataInternationalStandingOrderConsentResponse3 and cannot be null");
            }
            else
            {
            ...
            if (permission == null)
            {
                throw new InvalidDataException("permission is a required property for OBWriteDataInternationalStandingOrderConsentResponse3 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataInternationalStandingOrderConsentResponse3 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDataInternationalStandingOrderConsentResponse3);
        }

        /// <summary>
        /// Returns true if OBWriteDataInternationalStandingOrderConsentResponse3 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataInternationalStandingOrderConsentResponse3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataInternationalStandingOrderConsentResponse3 input)
        {
            if (input == null)
                return false;
