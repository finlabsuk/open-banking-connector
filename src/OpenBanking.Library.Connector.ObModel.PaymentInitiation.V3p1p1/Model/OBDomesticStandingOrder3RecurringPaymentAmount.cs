...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBDomesticStandingOrder3RecurringPaymentAmount :  IEquatable<OBDomesticStandingOrder3RecurringPaymentAmount>, IValidatableObject
    {
        ...
        public OBDomesticStandingOrder3RecurringPaymentAmount(string amount = default(string), string currency = default(string))
        {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for OBDomesticStandingOrder3RecurringPaymentAmount and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for OBDomesticStandingOrder3RecurringPaymentAmount and cannot be null");
            }
            else
            {
