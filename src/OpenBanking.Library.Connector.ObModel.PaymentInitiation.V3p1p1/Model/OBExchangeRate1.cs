...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBExchangeRate1 :  IEquatable<OBExchangeRate1>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBExchangeRate1" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBExchangeRate1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBExchangeRate1" /> class.
        /// </summary>
        ...
        public OBExchangeRate1(string unitCurrency = default(string), decimal? exchangeRate = default(decimal?), OBExchangeRateType2Code rateType = default(OBExchangeRateType2Code), string contractIdentification = default(string))
        {
            // to ensure "unitCurrency" is required (not null)
            if (unitCurrency == null)
            {
                throw new InvalidDataException("unitCurrency is a required property for OBExchangeRate1 and cannot be null");
            }
            else
            {
            ...
            if (rateType == null)
            {
                throw new InvalidDataException("rateType is a required property for OBExchangeRate1 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBExchangeRate1);
        }

        /// <summary>
        /// Returns true if OBExchangeRate1 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBExchangeRate1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBExchangeRate1 input)
        {
            if (input == null)
                return false;
