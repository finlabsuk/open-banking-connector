...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBError1 :  IEquatable<OBError1>, IValidatableObject
    {
        ...
        public OBError1(string errorCode = default(string), string message = default(string), string path = default(string), string url = default(string))
        {
            ...
            if (errorCode == null)
            {
                throw new InvalidDataException("errorCode is a required property for OBError1 and cannot be null");
            }
            else
            {
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for OBError1 and cannot be null");
            }
            else
            {
