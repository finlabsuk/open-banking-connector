...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDataDomesticStandingOrder3 :  IEquatable<OBWriteDataDomesticStandingOrder3>, IValidatableObject
    {
        ...
        public OBWriteDataDomesticStandingOrder3(string consentId = default(string), OBDomesticStandingOrder3 initiation = default(OBDomesticStandingOrder3))
        {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataDomesticStandingOrder3 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataDomesticStandingOrder3 and cannot be null");
            }
            else
            {
