...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDataInternationalStandingOrder3 :  IEquatable<OBWriteDataInternationalStandingOrder3>, IValidatableObject
    {
        ...
        public OBWriteDataInternationalStandingOrder3(string consentId = default(string), OBInternationalStandingOrder3 initiation = default(OBInternationalStandingOrder3))
        {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataInternationalStandingOrder3 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataInternationalStandingOrder3 and cannot be null");
            }
            else
            {
