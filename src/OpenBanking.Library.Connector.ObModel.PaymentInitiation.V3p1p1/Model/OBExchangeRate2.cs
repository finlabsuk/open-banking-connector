...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBExchangeRate2 :  IEquatable<OBExchangeRate2>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets RateType
        /// </summary>
        [DataMember(Name="RateType", EmitDefaultValue=false)]
        public OBExchangeRateType2Code RateType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBExchangeRate2" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBExchangeRate2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBExchangeRate2" /> class.
        /// </summary>
        ...
        public OBExchangeRate2(string unitCurrency = default(string), decimal? exchangeRate = default(decimal?), OBExchangeRateType2Code rateType = default(OBExchangeRateType2Code), string contractIdentification = default(string), DateTime? expirationDateTime = default(DateTime?))
        {
            // to ensure "unitCurrency" is required (not null)
            if (unitCurrency == null)
            {
                throw new InvalidDataException("unitCurrency is a required property for OBExchangeRate2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("exchangeRate is a required property for OBExchangeRate2 and cannot be null");
            }
            else
            {
            ...
            if (rateType == null)
            {
                throw new InvalidDataException("rateType is a required property for OBExchangeRate2 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBExchangeRate2);
        }

        /// <summary>
        /// Returns true if OBExchangeRate2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBExchangeRate2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBExchangeRate2 input)
        {
            if (input == null)
                return false;
