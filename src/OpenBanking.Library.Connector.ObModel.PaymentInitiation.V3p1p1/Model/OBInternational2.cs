...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBInternational2 :  IEquatable<OBInternational2>, IValidatableObject
    {
        /// <summary>
        ...
        public OBInternational2(string instructionIdentification = default(string), string endToEndIdentification = default(string), string localInstrument = default(string), OBPriority2Code? instructionPriority = default(OBPriority2Code?), string purpose = default(string), OBChargeBearerType1Code? chargeBearer = default(OBChargeBearerType1Code?), string currencyOfTransfer = default(string), OBInternational2InstructedAmount instructedAmount = default(OBInternational2InstructedAmount), OBExchangeRate1 exchangeRateInformation = default(OBExchangeRate1), OBCashAccountDebtor4 debtorAccount = default(OBCashAccountDebtor4), OBPartyIdentification43 creditor = default(OBPartyIdentification43), OBBranchAndFinancialInstitutionIdentification6 creditorAgent = default(OBBranchAndFinancialInstitutionIdentification6), OBCashAccountCreditor3 creditorAccount = default(OBCashAccountCreditor3), OBRemittanceInformation1 remittanceInformation = default(OBRemittanceInformation1), OBSupplementaryData1 supplementaryData = default(OBSupplementaryData1))
        {
            ...
            {
                throw new InvalidDataException("instructionIdentification is a required property for OBInternational2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("endToEndIdentification is a required property for OBInternational2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("currencyOfTransfer is a required property for OBInternational2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instructedAmount is a required property for OBInternational2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditorAccount is a required property for OBInternational2 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBInternational2);
        }

        /// <summary>
        /// Returns true if OBInternational2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBInternational2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBInternational2 input)
        {
            if (input == null)
                return false;
