...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDataDomesticScheduledResponse2 :  IEquatable<OBWriteDataDomesticScheduledResponse2>, IValidatableObject
    {
        ...
        public OBWriteDataDomesticScheduledResponse2(string domesticScheduledPaymentId = default(string), string consentId = default(string), DateTime? creationDateTime = default(DateTime?), OBExternalStatus1Code status = default(OBExternalStatus1Code), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), DateTime? expectedSettlementDateTime = default(DateTime?), List<OBCharge2> charges = default(List<OBCharge2>), OBDomesticScheduled2 initiation = default(OBDomesticScheduled2), OBMultiAuthorisation1 multiAuthorisation = default(OBMultiAuthorisation1))
        {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataDomesticScheduledResponse2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDataDomesticScheduledResponse2 and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDataDomesticScheduledResponse2 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDataDomesticScheduledResponse2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataDomesticScheduledResponse2 and cannot be null");
            }
            else
            {
