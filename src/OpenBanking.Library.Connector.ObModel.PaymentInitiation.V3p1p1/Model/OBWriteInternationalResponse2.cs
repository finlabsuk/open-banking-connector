...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteInternationalResponse2 :  IEquatable<OBWriteInternationalResponse2>, IValidatableObject
    {
        ...
        public OBWriteInternationalResponse2(OBWriteDataInternationalResponse2 data = default(OBWriteDataInternationalResponse2), Links links = default(Links), Meta meta = default(Meta))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for OBWriteInternationalResponse2 and cannot be null");
            }
            else
            {
                this.Data = data;
            ...
            if (links == null)
            {
                throw new InvalidDataException("links is a required property for OBWriteInternationalResponse2 and cannot be null");
            }
            else
            {
                this.Links = links;
            ...
            if (meta == null)
            {
                throw new InvalidDataException("meta is a required property for OBWriteInternationalResponse2 and cannot be null");
            }
            else
            {
                this.Meta = meta;
