...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBFundsAvailableResult1 :  IEquatable<OBFundsAvailableResult1>, IValidatableObject
    {
        ...
        public OBFundsAvailableResult1(DateTime? fundsAvailableDateTime = default(DateTime?), bool? fundsAvailable = default(bool?))
        {
            // to ensure "fundsAvailableDateTime" is required (not null)
            if (fundsAvailableDateTime == null)
            {
                throw new InvalidDataException("fundsAvailableDateTime is a required property for OBFundsAvailableResult1 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fundsAvailable is a required property for OBFundsAvailableResult1 and cannot be null");
            }
            else
            {
