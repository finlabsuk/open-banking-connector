...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataFileConsent2 :  IEquatable<OBWriteDataFileConsent2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataFileConsent2" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataFileConsent2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataFileConsent2" /> class.
        /// </summary>
        ...
        public OBWriteDataFileConsent2(OBFile2 initiation = default(OBFile2), OBAuthorisation1 authorisation = default(OBAuthorisation1))
        {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataFileConsent2 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDataFileConsent2);
        }

        /// <summary>
        /// Returns true if OBWriteDataFileConsent2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataFileConsent2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataFileConsent2 input)
        {
            if (input == null)
                return false;
