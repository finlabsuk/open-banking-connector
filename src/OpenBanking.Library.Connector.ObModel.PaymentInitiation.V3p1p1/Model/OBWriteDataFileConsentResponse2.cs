...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataFileConsentResponse2 :  IEquatable<OBWriteDataFileConsentResponse2>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        [DataMember(Name="Status", EmitDefaultValue=false)]
        public OBExternalConsentStatus2Code Status { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataFileConsentResponse2" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataFileConsentResponse2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataFileConsentResponse2" /> class.
        /// </summary>
        ...
        public OBWriteDataFileConsentResponse2(string consentId = default(string), DateTime? creationDateTime = default(DateTime?), OBExternalConsentStatus2Code status = default(OBExternalConsentStatus2Code), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? cutOffDateTime = default(DateTime?), List<OBCharge2> charges = default(List<OBCharge2>), OBFile2 initiation = default(OBFile2), OBAuthorisation1 authorisation = default(OBAuthorisation1))
        {
            // to ensure "consentId" is required (not null)
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataFileConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDataFileConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDataFileConsentResponse2 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDataFileConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataFileConsentResponse2 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDataFileConsentResponse2);
        }

        /// <summary>
        /// Returns true if OBWriteDataFileConsentResponse2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataFileConsentResponse2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataFileConsentResponse2 input)
        {
            if (input == null)
                return false;
