...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWritePaymentDetailsResponse1DataPaymentStatus :  IEquatable<OBWritePaymentDetailsResponse1DataPaymentStatus>, IValidatableObject
    {
        ...
        public OBWritePaymentDetailsResponse1DataPaymentStatus(string paymentTransactionId = default(string), StatusEnum status = default(StatusEnum), DateTime? statusUpdateDateTime = default(DateTime?), OBWritePaymentDetailsResponse1DataStatusDetail statusDetail = default(OBWritePaymentDetailsResponse1DataStatusDetail))
        {
            // to ensure "paymentTransactionId" is required (not null)
            if (paymentTransactionId == null)
            {
                throw new InvalidDataException("paymentTransactionId is a required property for OBWritePaymentDetailsResponse1DataPaymentStatus and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWritePaymentDetailsResponse1DataPaymentStatus and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWritePaymentDetailsResponse1DataPaymentStatus and cannot be null");
            }
            else
            {
