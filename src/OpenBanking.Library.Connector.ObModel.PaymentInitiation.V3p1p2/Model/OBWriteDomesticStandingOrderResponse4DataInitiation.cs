...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticStandingOrderResponse4DataInitiation :  IEquatable<OBWriteDomesticStandingOrderResponse4DataInitiation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderResponse4DataInitiation" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticStandingOrderResponse4DataInitiation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderResponse4DataInitiation" /> class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrderResponse4DataInitiation(OBSupplementaryData1 supplementaryData = default(OBSupplementaryData1), OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount), string reference = default(string), DateTime? recurringPaymentDateTime = default(DateTime?), OBWriteDomesticStandingOrderResponse4DataInitiationRecurringPaymentAmount recurringPaymentAmount = default(OBWriteDomesticStandingOrderResponse4DataInitiationRecurringPaymentAmount), OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount creditorAccount = default(OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount), string frequency = default(string), OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount firstPaymentAmount = default(OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount), DateTime? firstPaymentDateTime = default(DateTime?), OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount finalPaymentAmount = default(OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount), string numberOfPayments = default(string), DateTime? finalPaymentDateTime = default(DateTime?))
        {
            // to ensure "creditorAccount" is required (not null)
            if (creditorAccount == null)
            {
                throw new InvalidDataException("creditorAccount is a required property for OBWriteDomesticStandingOrderResponse4DataInitiation and cannot be null");
            }
            else
            {
            ...
            if (frequency == null)
            {
                throw new InvalidDataException("frequency is a required property for OBWriteDomesticStandingOrderResponse4DataInitiation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("firstPaymentAmount is a required property for OBWriteDomesticStandingOrderResponse4DataInitiation and cannot be null");
            }
            else
            {
                this.FirstPaymentAmount = firstPaymentAmount;
            }
            // to ensure "firstPaymentDateTime" is required (not null)
            if (firstPaymentDateTime == null)
            {
                throw new InvalidDataException("firstPaymentDateTime is a required property for OBWriteDomesticStandingOrderResponse4DataInitiation and cannot be null");
            }
            else
            {
        ...
        public OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public DateTime? RecurringPaymentDateTime { get; set; }

        /// <summary>
        /// Gets or Sets RecurringPaymentAmount
        /// </summary>
        [DataMember(Name="RecurringPaymentAmount", EmitDefaultValue=false)]
        public OBWriteDomesticStandingOrderResponse4DataInitiationRecurringPaymentAmount RecurringPaymentAmount { get; set; }

        /// <summary>
        /// Gets or Sets CreditorAccount
        /// </summary>
        [DataMember(Name="CreditorAccount", EmitDefaultValue=false)]
        public OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount FirstPaymentAmount { get; set; }
        ...
        public OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount FinalPaymentAmount { get; set; }
        ...
        {
            return this.Equals(input as OBWriteDomesticStandingOrderResponse4DataInitiation);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticStandingOrderResponse4DataInitiation instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticStandingOrderResponse4DataInitiation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticStandingOrderResponse4DataInitiation input)
        {
            if (input == null)
                return false;
