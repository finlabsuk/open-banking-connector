...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalScheduledResponse3Data :  IEquatable<OBWriteInternationalScheduledResponse3Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalScheduledResponse3Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalScheduledResponse3Data" /> class.
        /// </summary>
        ...
        public OBWriteInternationalScheduledResponse3Data(StatusEnum status = default(StatusEnum), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? creationDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), OBWriteInternationalScheduledResponse3DataExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalScheduledResponse3DataExchangeRateInformation), string internationalScheduledPaymentId = default(string), List<OBWriteDomesticStandingOrderResponse4DataCharges> charges = default(List<OBWriteDomesticStandingOrderResponse4DataCharges>), string consentId = default(string), OBWriteInternationalScheduledResponse3DataInitiation initiation = default(OBWriteInternationalScheduledResponse3DataInitiation), DateTime? expectedSettlementDateTime = default(DateTime?), OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation multiAuthorisation = default(OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteInternationalScheduledResponse3Data and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteInternationalScheduledResponse3Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteInternationalScheduledResponse3Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("internationalScheduledPaymentId is a required property for OBWriteInternationalScheduledResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteInternationalScheduledResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteInternationalScheduledResponse3Data and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteInternationalScheduledResponse3Data);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalScheduledResponse3Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalScheduledResponse3Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalScheduledResponse3Data input)
        {
            if (input == null)
                return false;
