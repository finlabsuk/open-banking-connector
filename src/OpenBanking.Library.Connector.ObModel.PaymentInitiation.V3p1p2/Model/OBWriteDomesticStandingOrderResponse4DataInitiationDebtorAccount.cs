...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount :  IEquatable<OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount" /> class.
        /// </summary>
        ...
        /// <param name="name">The account name is the name or names of the account owner(s) represented at an account level, as displayed by the ASPSP&#39;s online channels. Note, the account name is not the product name or the nickname of the account..</param>
        public OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount(string secondaryIdentification = default(string), string schemeName = default(string), string identification = default(string), string name = default(string))
        {
            // to ensure "schemeName" is required (not null)
            if (schemeName == null)
            {
                throw new InvalidDataException("schemeName is a required property for OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identification is a required property for OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The account name is the name or names of the account owner(s) represented at an account level, as displayed by the ASPSP&#39;s online channels. Note, the account name is not the product name or the nickname of the account.</value>
        ...
        {
            return this.Equals(input as OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount input)
        {
            if (input == null)
                return false;
