...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteInternationalConsent3Data :  IEquatable<OBWriteInternationalConsent3Data>, IValidatableObject
    {
        ...
        public OBWriteInternationalConsent3Data(OBWriteFileConsent3DataSCASupportData sCASupportData = default(OBWriteFileConsent3DataSCASupportData), OBWriteFileConsent3DataAuthorisation authorisation = default(OBWriteFileConsent3DataAuthorisation), OBWriteInternationalConsent3DataInitiation initiation = default(OBWriteInternationalConsent3DataInitiation))
        {
            // to ensure "initiation" is required (not null)
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteInternationalConsent3Data and cannot be null");
            }
            else
            {
