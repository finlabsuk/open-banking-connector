...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteInternationalScheduled2Data :  IEquatable<OBWriteInternationalScheduled2Data>, IValidatableObject
    {
        ...
        public OBWriteInternationalScheduled2Data(string consentId = default(string), OBWriteInternationalScheduledResponse3DataInitiation initiation = default(OBWriteInternationalScheduledResponse3DataInitiation))
        {
            // to ensure "consentId" is required (not null)
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteInternationalScheduled2Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteInternationalScheduled2Data and cannot be null");
            }
            else
            {
