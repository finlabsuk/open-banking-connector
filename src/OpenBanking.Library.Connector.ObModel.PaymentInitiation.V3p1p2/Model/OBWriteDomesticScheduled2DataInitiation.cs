...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteDomesticScheduled2DataInitiation :  IEquatable<OBWriteDomesticScheduled2DataInitiation>, IValidatableObject
    {
        ...
        public OBWriteDomesticScheduled2DataInitiation(OBSupplementaryData1 supplementaryData = default(OBSupplementaryData1), string localInstrument = default(string), OBWriteFile2DataInitiationDebtorAccount debtorAccount = default(OBWriteFile2DataInitiationDebtorAccount), OBWriteFile2DataInitiationRemittanceInformation remittanceInformation = default(OBWriteFile2DataInitiationRemittanceInformation), string endToEndIdentification = default(string), string instructionIdentification = default(string), OBWriteDomesticScheduled2DataInitiationCreditorAccount creditorAccount = default(OBWriteDomesticScheduled2DataInitiationCreditorAccount), DateTime? requestedExecutionDateTime = default(DateTime?), OBWriteDomesticScheduled2DataInitiationInstructedAmount instructedAmount = default(OBWriteDomesticScheduled2DataInitiationInstructedAmount), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6))
        {
            // to ensure "instructionIdentification" is required (not null)
            if (instructionIdentification == null)
            {
                throw new InvalidDataException("instructionIdentification is a required property for OBWriteDomesticScheduled2DataInitiation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditorAccount is a required property for OBWriteDomesticScheduled2DataInitiation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("requestedExecutionDateTime is a required property for OBWriteDomesticScheduled2DataInitiation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instructedAmount is a required property for OBWriteDomesticScheduled2DataInitiation and cannot be null");
            }
            else
            {
