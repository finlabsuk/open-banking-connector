...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWritePaymentDetailsResponse1DataStatusDetail :  IEquatable<OBWritePaymentDetailsResponse1DataStatusDetail>, IValidatableObject
    {
        ...
        public OBWritePaymentDetailsResponse1DataStatusDetail(string status = default(string), string localInstrument = default(string), StatusReasonEnum? statusReason = default(StatusReasonEnum?), string statusReasonDescription = default(string))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWritePaymentDetailsResponse1DataStatusDetail and cannot be null");
            }
            else
            {
                this.Status = status;
