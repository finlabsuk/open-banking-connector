...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalConsent3DataInitiation :  IEquatable<OBWriteInternationalConsent3DataInitiation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalConsent3DataInitiation" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalConsent3DataInitiation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalConsent3DataInitiation" /> class.
        /// </summary>
        ...
        public OBWriteInternationalConsent3DataInitiation(OBSupplementaryData1 supplementaryData = default(OBSupplementaryData1), OBWriteFile2DataInitiationDebtorAccount debtorAccount = default(OBWriteFile2DataInitiationDebtorAccount), OBWriteInternationalConsent3DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalConsent3DataInitiationCreditorAgent), string endToEndIdentification = default(string), string instructionIdentification = default(string), string currencyOfTransfer = default(string), OBWriteDomesticScheduled2DataInitiationCreditorAccount creditorAccount = default(OBWriteDomesticScheduled2DataInitiationCreditorAccount), string purpose = default(string), OBChargeBearerType1Code? chargeBearer = default(OBChargeBearerType1Code?), InstructionPriorityEnum? instructionPriority = default(InstructionPriorityEnum?), string localInstrument = default(string), OBWriteFile2DataInitiationRemittanceInformation remittanceInformation = default(OBWriteFile2DataInitiationRemittanceInformation), OBWriteInternationalConsent3DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalConsent3DataInitiationExchangeRateInformation), OBWriteInternationalConsent3DataInitiationCreditor creditor = default(OBWriteInternationalConsent3DataInitiationCreditor), OBWriteDomesticScheduled2DataInitiationInstructedAmount instructedAmount = default(OBWriteDomesticScheduled2DataInitiationInstructedAmount))
        {
            ...
            {
                throw new InvalidDataException("instructionIdentification is a required property for OBWriteInternationalConsent3DataInitiation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("currencyOfTransfer is a required property for OBWriteInternationalConsent3DataInitiation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditorAccount is a required property for OBWriteInternationalConsent3DataInitiation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instructedAmount is a required property for OBWriteInternationalConsent3DataInitiation and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteInternationalConsent3DataInitiation);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalConsent3DataInitiation instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalConsent3DataInitiation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalConsent3DataInitiation input)
        {
            if (input == null)
                return false;
