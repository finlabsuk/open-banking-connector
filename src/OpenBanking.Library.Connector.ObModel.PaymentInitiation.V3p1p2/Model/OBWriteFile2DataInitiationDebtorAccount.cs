...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteFile2DataInitiationDebtorAccount :  IEquatable<OBWriteFile2DataInitiationDebtorAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteFile2DataInitiationDebtorAccount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteFile2DataInitiationDebtorAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteFile2DataInitiationDebtorAccount" /> class.
        /// </summary>
        ...
        public OBWriteFile2DataInitiationDebtorAccount(string secondaryIdentification = default(string), string schemeName = default(string), string identification = default(string), string name = default(string))
        {
            // to ensure "schemeName" is required (not null)
            if (schemeName == null)
            {
                throw new InvalidDataException("schemeName is a required property for OBWriteFile2DataInitiationDebtorAccount and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identification is a required property for OBWriteFile2DataInitiationDebtorAccount and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteFile2DataInitiationDebtorAccount);
        }

        /// <summary>
        /// Returns true if OBWriteFile2DataInitiationDebtorAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteFile2DataInitiationDebtorAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteFile2DataInitiationDebtorAccount input)
        {
            if (input == null)
                return false;
