...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalConsentResponse3Data :  IEquatable<OBWriteInternationalConsentResponse3Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalConsentResponse3Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalConsentResponse3Data" /> class.
        /// </summary>
        ...
        public OBWriteInternationalConsentResponse3Data(StatusEnum status = default(StatusEnum), DateTime? statusUpdateDateTime = default(DateTime?), OBWriteFileConsent3DataSCASupportData sCASupportData = default(OBWriteFileConsent3DataSCASupportData), DateTime? creationDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), DateTime? cutOffDateTime = default(DateTime?), OBWriteInternationalScheduledResponse3DataExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalScheduledResponse3DataExchangeRateInformation), OBWriteFileConsent3DataAuthorisation authorisation = default(OBWriteFileConsent3DataAuthorisation), List<OBWriteDomesticStandingOrderResponse4DataCharges> charges = default(List<OBWriteDomesticStandingOrderResponse4DataCharges>), string consentId = default(string), OBWriteInternationalConsent3DataInitiation initiation = default(OBWriteInternationalConsent3DataInitiation), DateTime? expectedSettlementDateTime = default(DateTime?))
        {
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteInternationalConsentResponse3Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteInternationalConsentResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteInternationalConsentResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteInternationalConsentResponse3Data and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteInternationalConsentResponse3Data);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalConsentResponse3Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalConsentResponse3Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalConsentResponse3Data input)
        {
            if (input == null)
                return false;
