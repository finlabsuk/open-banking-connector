...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticScheduled2DataInitiationCreditorAccount :  IEquatable<OBWriteDomesticScheduled2DataInitiationCreditorAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticScheduled2DataInitiationCreditorAccount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticScheduled2DataInitiationCreditorAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticScheduled2DataInitiationCreditorAccount" /> class.
        /// </summary>
        ...
        public OBWriteDomesticScheduled2DataInitiationCreditorAccount(string secondaryIdentification = default(string), string schemeName = default(string), string identification = default(string), string name = default(string))
        {
            // to ensure "schemeName" is required (not null)
            if (schemeName == null)
            {
                throw new InvalidDataException("schemeName is a required property for OBWriteDomesticScheduled2DataInitiationCreditorAccount and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identification is a required property for OBWriteDomesticScheduled2DataInitiationCreditorAccount and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for OBWriteDomesticScheduled2DataInitiationCreditorAccount and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OBWriteDomesticScheduled2DataInitiationCreditorAccount {\n");
        ...
        {
            return this.Equals(input as OBWriteDomesticScheduled2DataInitiationCreditorAccount);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticScheduled2DataInitiationCreditorAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticScheduled2DataInitiationCreditorAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticScheduled2DataInitiationCreditorAccount input)
        {
            if (input == null)
                return false;
