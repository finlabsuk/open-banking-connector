...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteDomesticScheduledResponse3Data :  IEquatable<OBWriteDomesticScheduledResponse3Data>, IValidatableObject
    {
        ...
        public OBWriteDomesticScheduledResponse3Data(StatusEnum status = default(StatusEnum), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? creationDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), string domesticScheduledPaymentId = default(string), List<OBWriteDomesticStandingOrderResponse4DataCharges> charges = default(List<OBWriteDomesticStandingOrderResponse4DataCharges>), string consentId = default(string), OBWriteDomesticScheduled2DataInitiation initiation = default(OBWriteDomesticScheduled2DataInitiation), DateTime? expectedSettlementDateTime = default(DateTime?), OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation multiAuthorisation = default(OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation))
        {
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDomesticScheduledResponse3Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDomesticScheduledResponse3Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("domesticScheduledPaymentId is a required property for OBWriteDomesticScheduledResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDomesticScheduledResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDomesticScheduledResponse3Data and cannot be null");
            }
            else
            {
