...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticStandingOrderConsentResponse4Data :  IEquatable<OBWriteDomesticStandingOrderConsentResponse4Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderConsentResponse4Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticStandingOrderConsentResponse4Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderConsentResponse4Data" /> class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrderConsentResponse4Data(StatusEnum status = default(StatusEnum), DateTime? statusUpdateDateTime = default(DateTime?), OBWriteFileConsent3DataSCASupportData sCASupportData = default(OBWriteFileConsent3DataSCASupportData), DateTime? creationDateTime = default(DateTime?), DateTime? cutOffDateTime = default(DateTime?), OBWriteFileConsent3DataAuthorisation authorisation = default(OBWriteFileConsent3DataAuthorisation), PermissionEnum permission = default(PermissionEnum), List<OBWriteDomesticStandingOrderResponse4DataCharges> charges = default(List<OBWriteDomesticStandingOrderResponse4DataCharges>), string consentId = default(string), OBWriteDomesticStandingOrderResponse4DataInitiation initiation = default(OBWriteDomesticStandingOrderResponse4DataInitiation))
        {
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDomesticStandingOrderConsentResponse4Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDomesticStandingOrderConsentResponse4Data and cannot be null");
            }
            else
            {
            ...
            if (permission == null)
            {
                throw new InvalidDataException("permission is a required property for OBWriteDomesticStandingOrderConsentResponse4Data and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDomesticStandingOrderConsentResponse4Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDomesticStandingOrderConsentResponse4Data and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDomesticStandingOrderConsentResponse4Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticStandingOrderConsentResponse4Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticStandingOrderConsentResponse4Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticStandingOrderConsentResponse4Data input)
        {
            if (input == null)
                return false;
