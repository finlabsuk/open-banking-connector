...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticResponse3Data :  IEquatable<OBWriteDomesticResponse3Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticResponse3Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticResponse3Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticResponse3Data" /> class.
        /// </summary>
        ...
        public OBWriteDomesticResponse3Data(string domesticPaymentId = default(string), StatusEnum status = default(StatusEnum), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? creationDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), List<OBWriteDomesticStandingOrderResponse4DataCharges> charges = default(List<OBWriteDomesticStandingOrderResponse4DataCharges>), string consentId = default(string), OBWriteDomesticResponse3DataInitiation initiation = default(OBWriteDomesticResponse3DataInitiation), DateTime? expectedSettlementDateTime = default(DateTime?), OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation multiAuthorisation = default(OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation))
        {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDomesticResponse3Data and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDomesticResponse3Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDomesticResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDomesticResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDomesticResponse3Data and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>OB: Unique identification as assigned by the ASPSP to uniquely identify the domestic payment resource.</value>
        [DataMember(Name="DomesticPaymentId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DomesticPaymentId: ").Append(DomesticPaymentId).Append("\n");
        ...
        {
            return this.Equals(input as OBWriteDomesticResponse3Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticResponse3Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticResponse3Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticResponse3Data input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.DomesticPaymentId == input.DomesticPaymentId ||
                    (this.DomesticPaymentId != null &&
                    this.DomesticPaymentId.Equals(input.DomesticPaymentId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.DomesticPaymentId != null)
                    hashCode = hashCode * 59 + this.DomesticPaymentId.GetHashCode();
                if (this.Status != null)
        ...
        {
            // DomesticPaymentId (string) maxLength
            if(this.DomesticPaymentId != null && this.DomesticPaymentId.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DomesticPaymentId, length must be less than 40.", new [] { "DomesticPaymentId" });
            }

            // DomesticPaymentId (string) minLength
            if(this.DomesticPaymentId != null && this.DomesticPaymentId.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DomesticPaymentId, length must be greater than 1.", new [] { "DomesticPaymentId" });
            }
