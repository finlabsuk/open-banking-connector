...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteInternationalStandingOrderResponse4Data :  IEquatable<OBWriteInternationalStandingOrderResponse4Data>, IValidatableObject
    {
        ...
        public OBWriteInternationalStandingOrderResponse4Data(StatusEnum status = default(StatusEnum), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? creationDateTime = default(DateTime?), List<OBWriteDomesticStandingOrderResponse4DataCharges> charges = default(List<OBWriteDomesticStandingOrderResponse4DataCharges>), string internationalStandingOrderId = default(string), string consentId = default(string), OBWriteInternationalStandingOrderConsent4DataInitiation initiation = default(OBWriteInternationalStandingOrderConsent4DataInitiation), OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation multiAuthorisation = default(OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteInternationalStandingOrderResponse4Data and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteInternationalStandingOrderResponse4Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteInternationalStandingOrderResponse4Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("internationalStandingOrderId is a required property for OBWriteInternationalStandingOrderResponse4Data and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteInternationalStandingOrderResponse4Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteInternationalStandingOrderResponse4Data and cannot be null");
            }
            else
            {
