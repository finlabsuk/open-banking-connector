...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteFile2Data :  IEquatable<OBWriteFile2Data>, IValidatableObject
    {
        ...
        public OBWriteFile2Data(string consentId = default(string), OBWriteFile2DataInitiation initiation = default(OBWriteFile2DataInitiation))
        {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteFile2Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteFile2Data and cannot be null");
            }
            else
            {
