...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount :  IEquatable<OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount" /> class.
        /// </summary>
        ...
        public OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount(string secondaryIdentification = default(string), string schemeName = default(string), string identification = default(string), string name = default(string))
        {
            // to ensure "schemeName" is required (not null)
            if (schemeName == null)
            {
                throw new InvalidDataException("schemeName is a required property for OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identification is a required property for OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount {\n");
        ...
        {
            return this.Equals(input as OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount input)
        {
            if (input == null)
                return false;
