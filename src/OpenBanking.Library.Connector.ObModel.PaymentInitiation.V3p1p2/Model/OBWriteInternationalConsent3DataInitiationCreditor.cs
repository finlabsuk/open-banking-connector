...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModel.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalConsent3DataInitiationCreditor :  IEquatable<OBWriteInternationalConsent3DataInitiationCreditor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalConsent3DataInitiationCreditor" /> class.
        /// </summary>
        ...
        public OBWriteInternationalConsent3DataInitiationCreditor(OBPostalAddress6 postalAddress = default(OBPostalAddress6), string name = default(string))
        {
        ...
        {
            return this.Equals(input as OBWriteInternationalConsent3DataInitiationCreditor);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalConsent3DataInitiationCreditor instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalConsent3DataInitiationCreditor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalConsent3DataInitiationCreditor input)
        {
            if (input == null)
                return false;
