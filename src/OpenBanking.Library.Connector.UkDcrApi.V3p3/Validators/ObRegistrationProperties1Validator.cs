...
using FinnovationLabs.OpenBanking.Library.Connector.UkDcrApi.V3p3.Models;
using FluentValidation;
using MSValidationException = Microsoft.Rest.ValidationException;

namespace FinnovationLabs.OpenBanking.Library.Connector.UkDcrApi.V3p3.Validators
{
    public class
