...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrderConsentResponse4DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalStandingOrderConsentResponse4DataInitiationCreditorAccount
        /// class.
        /// </summary>
        public OBWriteInternationalStandingOrderConsentResponse4DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalStandingOrderConsentResponse4DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
