...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderResponse4DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticStandingOrderResponse4DataInitiation class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrderResponse4DataInitiation(string frequency, System.DateTimeOffset firstPaymentDateTime, OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount firstPaymentAmount, OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount creditorAccount, string reference = default(string), string numberOfPayments = default(string), System.DateTimeOffset? recurringPaymentDateTime = default(System.DateTimeOffset?), System.DateTimeOffset? finalPaymentDateTime = default(System.DateTimeOffset?), OBWriteDomesticStandingOrderResponse4DataInitiationRecurringPaymentAmount recurringPaymentAmount = default(OBWriteDomesticStandingOrderResponse4DataInitiationRecurringPaymentAmount), OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount finalPaymentAmount = default(OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount), OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            Frequency = frequency;
            Reference = reference;
