...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticScheduledConsentResponse3DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledConsentResponse3DataInitiationCreditorAccount
        /// class.
        /// </summary>
        public OBWriteDomesticScheduledConsentResponse3DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticScheduledConsentResponse3DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
