...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticScheduledConsentResponse3DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledConsentResponse3DataInitiation class.
        /// </summary>
        public OBWriteDomesticScheduledConsentResponse3DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticScheduledConsentResponse3DataInitiation(string instructionIdentification, System.DateTimeOffset requestedExecutionDateTime, OBWriteDomesticScheduledConsentResponse3DataInitiationInstructedAmount instructedAmount, OBWriteDomesticScheduledConsentResponse3DataInitiationCreditorAccount creditorAccount, string endToEndIdentification = default(string), string localInstrument = default(string), OBWriteDomesticScheduledConsentResponse3DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticScheduledConsentResponse3DataInitiationDebtorAccount), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6), OBWriteDomesticScheduledConsentResponse3DataInitiationRemittanceInformation remittanceInformation = default(OBWriteDomesticScheduledConsentResponse3DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteDomesticScheduledConsentResponse3DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteDomesticScheduledConsentResponse3DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public OBWriteDomesticScheduledConsentResponse3DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteDomesticScheduledConsentResponse3DataInitiationRemittanceInformation RemittanceInformation { get; set; }
