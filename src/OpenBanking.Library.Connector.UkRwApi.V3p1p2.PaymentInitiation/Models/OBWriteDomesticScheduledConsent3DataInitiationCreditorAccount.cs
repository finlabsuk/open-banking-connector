...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticScheduledConsent3DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledConsent3DataInitiationCreditorAccount
        /// class.
        /// </summary>
        public OBWriteDomesticScheduledConsent3DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticScheduledConsent3DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
