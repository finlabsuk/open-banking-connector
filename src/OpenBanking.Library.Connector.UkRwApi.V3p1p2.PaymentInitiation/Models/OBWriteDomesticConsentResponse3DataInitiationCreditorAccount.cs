...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticConsentResponse3DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticConsentResponse3DataInitiationCreditorAccount class.
        /// </summary>
        public OBWriteDomesticConsentResponse3DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticConsentResponse3DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
