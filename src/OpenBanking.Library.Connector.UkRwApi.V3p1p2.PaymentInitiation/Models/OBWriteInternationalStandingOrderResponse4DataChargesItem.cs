...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// initiation.
    /// </summary>
    public partial class OBWriteInternationalStandingOrderResponse4DataChargesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalStandingOrderResponse4DataChargesItem class.
        /// </summary>
        public OBWriteInternationalStandingOrderResponse4DataChargesItem()
        {
            CustomInit();
        }
        ...
        /// 'Shared'</param>
        public OBWriteInternationalStandingOrderResponse4DataChargesItem(OBChargeBearerType1CodeEnum chargeBearer, string type, OBActiveOrHistoricCurrencyAndAmount amount)
        {
