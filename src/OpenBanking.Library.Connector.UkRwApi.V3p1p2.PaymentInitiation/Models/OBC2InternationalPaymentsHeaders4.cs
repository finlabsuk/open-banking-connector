...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2InternationalPaymentsHeaders4
    {
        /// <summary>
        /// Initializes a new instance of the OBC2InternationalPaymentsHeaders4
        /// class.
        /// </summary>
        public OBC2InternationalPaymentsHeaders4()
        {
            CustomInit();
        }
        ...
        public OBC2InternationalPaymentsHeaders4(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
