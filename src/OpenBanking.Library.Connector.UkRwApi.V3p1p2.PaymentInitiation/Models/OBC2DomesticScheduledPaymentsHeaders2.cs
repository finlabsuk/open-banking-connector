...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// <summary>
    /// Defines headers for Domestic Scheduled Payments operation.
    /// </summary>
    public partial class OBC2DomesticScheduledPaymentsHeaders2
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBC2DomesticScheduledPaymentsHeaders2 class.
        /// </summary>
        public OBC2DomesticScheduledPaymentsHeaders2()
        {
            CustomInit();
        }
        ...
        public OBC2DomesticScheduledPaymentsHeaders2(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
