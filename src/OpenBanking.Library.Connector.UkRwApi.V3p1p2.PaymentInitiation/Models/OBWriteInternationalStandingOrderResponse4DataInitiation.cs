...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrderResponse4DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalStandingOrderResponse4DataInitiation class.
        /// </summary>
        public OBWriteInternationalStandingOrderResponse4DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalStandingOrderResponse4DataInitiation(string frequency, System.DateTimeOffset firstPaymentDateTime, string currencyOfTransfer, OBWriteInternationalStandingOrderResponse4DataInitiationInstructedAmount instructedAmount, OBWriteInternationalStandingOrderResponse4DataInitiationCreditorAccount creditorAccount, string reference = default(string), string numberOfPayments = default(string), System.DateTimeOffset? finalPaymentDateTime = default(System.DateTimeOffset?), string purpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), OBWriteInternationalStandingOrderResponse4DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalStandingOrderResponse4DataInitiationDebtorAccount), OBWriteInternationalStandingOrderResponse4DataInitiationCreditor creditor = default(OBWriteInternationalStandingOrderResponse4DataInitiationCreditor), OBWriteInternationalStandingOrderResponse4DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalStandingOrderResponse4DataInitiationCreditorAgent), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            Frequency = frequency;
            Reference = reference;
        ...
        public OBWriteInternationalStandingOrderResponse4DataInitiationInstructedAmount InstructedAmount { get; set; }

        /// <summary>
        /// Gets or sets provides the details to identify the debtor account.
        /// </summary>
        [JsonProperty(PropertyName = "DebtorAccount")]
        public OBWriteInternationalStandingOrderResponse4DataInitiationDebtorAccount DebtorAccount { get; set; }

        /// <summary>
        /// Gets or sets party to which an amount of money is due.
        /// </summary>
        [JsonProperty(PropertyName = "Creditor")]
        public OBWriteInternationalStandingOrderResponse4DataInitiationCreditor Creditor { get; set; }
        ...
        public OBWriteInternationalStandingOrderResponse4DataInitiationCreditorAgent CreditorAgent { get; set; }
        ...
        public OBWriteInternationalStandingOrderResponse4DataInitiationCreditorAccount CreditorAccount { get; set; }
