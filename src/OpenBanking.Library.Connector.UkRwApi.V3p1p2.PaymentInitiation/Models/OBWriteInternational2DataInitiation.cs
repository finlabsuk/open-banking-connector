...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternational2DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternational2DataInitiation class.
        /// </summary>
        public OBWriteInternational2DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternational2DataInitiation(string instructionIdentification, string endToEndIdentification, string currencyOfTransfer, OBWriteInternational2DataInitiationInstructedAmount instructedAmount, OBWriteInternational2DataInitiationCreditorAccount creditorAccount, string localInstrument = default(string), OBWriteInternational2DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternational2DataInitiationInstructionPriorityEnum?), string purpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), OBWriteInternational2DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternational2DataInitiationExchangeRateInformation), OBWriteInternational2DataInitiationDebtorAccount debtorAccount = default(OBWriteInternational2DataInitiationDebtorAccount), OBWriteInternational2DataInitiationCreditor creditor = default(OBWriteInternational2DataInitiationCreditor), OBWriteInternational2DataInitiationCreditorAgent creditorAgent = default(OBWriteInternational2DataInitiationCreditorAgent), OBWriteInternational2DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternational2DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternational2DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
        ...
        public OBWriteInternational2DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteInternational2DataInitiationExchangeRateInformation ExchangeRateInformation { get; set; }
        ...
        public OBWriteInternational2DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public OBWriteInternational2DataInitiationCreditorAgent CreditorAgent { get; set; }
        ...
        public OBWriteInternational2DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteInternational2DataInitiationRemittanceInformation RemittanceInformation { get; set; }
