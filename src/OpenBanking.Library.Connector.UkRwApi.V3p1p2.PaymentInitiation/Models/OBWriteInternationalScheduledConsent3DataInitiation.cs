...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledConsent3DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduledConsent3DataInitiation class.
        /// </summary>
        public OBWriteInternationalScheduledConsent3DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalScheduledConsent3DataInitiation(string instructionIdentification, System.DateTimeOffset requestedExecutionDateTime, string currencyOfTransfer, OBWriteInternationalScheduledConsent3DataInitiationInstructedAmount instructedAmount, OBWriteInternationalScheduledConsent3DataInitiationCreditorAccount creditorAccount, string endToEndIdentification = default(string), string localInstrument = default(string), OBWriteInternationalScheduledConsent3DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalScheduledConsent3DataInitiationInstructionPriorityEnum?), string purpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), OBWriteInternationalScheduledConsent3DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalScheduledConsent3DataInitiationExchangeRateInformation), OBWriteInternationalScheduledConsent3DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalScheduledConsent3DataInitiationDebtorAccount), OBWriteInternationalScheduledConsent3DataInitiationCreditor creditor = default(OBWriteInternationalScheduledConsent3DataInitiationCreditor), OBWriteInternationalScheduledConsent3DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalScheduledConsent3DataInitiationCreditorAgent), OBWriteInternationalScheduledConsent3DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalScheduledConsent3DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalScheduledConsent3DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
        ...
        public OBWriteInternationalScheduledConsent3DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteInternationalScheduledConsent3DataInitiationExchangeRateInformation ExchangeRateInformation { get; set; }
        ...
        public OBWriteInternationalScheduledConsent3DataInitiationDebtorAccount DebtorAccount { get; set; }

        /// <summary>
        /// Gets or sets party to which an amount of money is due.
        /// </summary>
        [JsonProperty(PropertyName = "Creditor")]
        public OBWriteInternationalScheduledConsent3DataInitiationCreditor Creditor { get; set; }
        ...
        public OBWriteInternationalScheduledConsent3DataInitiationCreditorAgent CreditorAgent { get; set; }
        ...
        public OBWriteInternationalScheduledConsent3DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteInternationalScheduledConsent3DataInitiationRemittanceInformation RemittanceInformation { get; set; }
