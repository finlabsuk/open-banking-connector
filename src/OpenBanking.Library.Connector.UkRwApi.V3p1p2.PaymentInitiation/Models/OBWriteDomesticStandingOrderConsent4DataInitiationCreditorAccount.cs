...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderConsent4DataInitiationCreditorAccount
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteDomesticStandingOrderConsent4DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticStandingOrderConsent4DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
