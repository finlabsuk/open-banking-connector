...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledConsent3DataInitiationRemittanceInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduledConsent3DataInitiationRemittanceInformation
        /// class.
        /// </summary>
        public OBWriteInternationalScheduledConsent3DataInitiationRemittanceInformation()
        {
            CustomInit();
        }
        ...
        /// be mapped.</param>
        public OBWriteInternationalScheduledConsent3DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
