...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternational2DataInitiationExchangeRateInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternational2DataInitiationExchangeRateInformation class.
        /// </summary>
        public OBWriteInternational2DataInitiationExchangeRateInformation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternational2DataInitiationExchangeRateInformation(string unitCurrency, OBWriteInternational2DataInitiationExchangeRateInformationRateTypeEnum rateType, double? exchangeRate = default(double?), string contractIdentification = default(string))
        {
        ...
        public OBWriteInternational2DataInitiationExchangeRateInformationRateTypeEnum RateType { get; set; }
