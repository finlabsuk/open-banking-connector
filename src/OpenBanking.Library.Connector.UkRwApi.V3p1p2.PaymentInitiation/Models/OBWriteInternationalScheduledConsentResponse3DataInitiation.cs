...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledConsentResponse3DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduledConsentResponse3DataInitiation class.
        /// </summary>
        public OBWriteInternationalScheduledConsentResponse3DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalScheduledConsentResponse3DataInitiation(string instructionIdentification, System.DateTimeOffset requestedExecutionDateTime, string currencyOfTransfer, OBWriteInternationalScheduledConsentResponse3DataInitiationInstructedAmount instructedAmount, OBWriteInternationalScheduledConsentResponse3DataInitiationCreditorAccount creditorAccount, string endToEndIdentification = default(string), string localInstrument = default(string), OBWriteInternationalScheduledConsentResponse3DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalScheduledConsentResponse3DataInitiationInstructionPriorityEnum?), string purpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), OBWriteInternationalScheduledConsentResponse3DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalScheduledConsentResponse3DataInitiationExchangeRateInformation), OBWriteInternationalScheduledConsentResponse3DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalScheduledConsentResponse3DataInitiationDebtorAccount), OBWriteInternationalScheduledConsentResponse3DataInitiationCreditor creditor = default(OBWriteInternationalScheduledConsentResponse3DataInitiationCreditor), OBWriteInternationalScheduledConsentResponse3DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalScheduledConsentResponse3DataInitiationCreditorAgent), OBWriteInternationalScheduledConsentResponse3DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalScheduledConsentResponse3DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalScheduledConsentResponse3DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
        ...
        public OBWriteInternationalScheduledConsentResponse3DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteInternationalScheduledConsentResponse3DataInitiationExchangeRateInformation ExchangeRateInformation { get; set; }
        ...
        public OBWriteInternationalScheduledConsentResponse3DataInitiationDebtorAccount DebtorAccount { get; set; }

        /// <summary>
        /// Gets or sets party to which an amount of money is due.
        /// </summary>
        [JsonProperty(PropertyName = "Creditor")]
        public OBWriteInternationalScheduledConsentResponse3DataInitiationCreditor Creditor { get; set; }
        ...
        public OBWriteInternationalScheduledConsentResponse3DataInitiationCreditorAgent CreditorAgent { get; set; }
        ...
        public OBWriteInternationalScheduledConsentResponse3DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteInternationalScheduledConsentResponse3DataInitiationRemittanceInformation RemittanceInformation { get; set; }
