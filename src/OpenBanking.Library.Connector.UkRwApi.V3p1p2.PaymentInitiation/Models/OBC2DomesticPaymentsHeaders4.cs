...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2DomesticPaymentsHeaders4
    {
        /// <summary>
        /// Initializes a new instance of the OBC2DomesticPaymentsHeaders4
        /// class.
        /// </summary>
        public OBC2DomesticPaymentsHeaders4()
        {
            CustomInit();
        }
        ...
        public OBC2DomesticPaymentsHeaders4(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
