...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsent3DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalConsent3DataInitiation class.
        /// </summary>
        public OBWriteInternationalConsent3DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalConsent3DataInitiation(string instructionIdentification, string endToEndIdentification, string currencyOfTransfer, OBWriteInternationalConsent3DataInitiationInstructedAmount instructedAmount, OBWriteInternationalConsent3DataInitiationCreditorAccount creditorAccount, string localInstrument = default(string), OBWriteInternationalConsent3DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalConsent3DataInitiationInstructionPriorityEnum?), string purpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), OBWriteInternationalConsent3DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalConsent3DataInitiationExchangeRateInformation), OBWriteInternationalConsent3DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalConsent3DataInitiationDebtorAccount), OBWriteInternationalConsent3DataInitiationCreditor creditor = default(OBWriteInternationalConsent3DataInitiationCreditor), OBWriteInternationalConsent3DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalConsent3DataInitiationCreditorAgent), OBWriteInternationalConsent3DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalConsent3DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalConsent3DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
        ...
        public OBWriteInternationalConsent3DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteInternationalConsent3DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public OBWriteInternationalConsent3DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteInternationalConsent3DataInitiationRemittanceInformation RemittanceInformation { get; set; }
