...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount
        /// class.
        /// </summary>
        public OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
