...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalResponse3DataInitiationDebtorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalResponse3DataInitiationDebtorAccount class.
        /// </summary>
        public OBWriteInternationalResponse3DataInitiationDebtorAccount()
        {
            CustomInit();
        }
        ...
        /// the account.</param>
        public OBWriteInternationalResponse3DataInitiationDebtorAccount(string schemeName, string identification, string name = default(string), string secondaryIdentification = default(string))
        {
