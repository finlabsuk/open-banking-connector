...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsentResponse3DataSCASupportData
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalConsentResponse3DataSCASupportData class.
        /// </summary>
        public OBWriteInternationalConsentResponse3DataSCASupportData()
        {
            CustomInit();
        }
        ...
        /// occurrence.</param>
        public OBWriteInternationalConsentResponse3DataSCASupportData(OBWriteInternationalConsentResponse3DataSCASupportDataRequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(OBWriteInternationalConsentResponse3DataSCASupportDataRequestedSCAExemptionTypeEnum?), OBWriteInternationalConsentResponse3DataSCASupportDataAppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(OBWriteInternationalConsentResponse3DataSCASupportDataAppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        public OBWriteInternationalConsentResponse3DataSCASupportDataRequestedSCAExemptionTypeEnum? RequestedSCAExemptionType { get; set; }
        ...
        public OBWriteInternationalConsentResponse3DataSCASupportDataAppliedAuthenticationApproachEnum? AppliedAuthenticationApproach { get; set; }
