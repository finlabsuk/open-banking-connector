...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticScheduledResponse3DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledResponse3DataInitiation class.
        /// </summary>
        public OBWriteDomesticScheduledResponse3DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticScheduledResponse3DataInitiation(string instructionIdentification, System.DateTimeOffset requestedExecutionDateTime, OBWriteDomesticScheduledResponse3DataInitiationInstructedAmount instructedAmount, OBWriteDomesticScheduledResponse3DataInitiationCreditorAccount creditorAccount, string endToEndIdentification = default(string), string localInstrument = default(string), OBWriteDomesticScheduledResponse3DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticScheduledResponse3DataInitiationDebtorAccount), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6), OBWriteDomesticScheduledResponse3DataInitiationRemittanceInformation remittanceInformation = default(OBWriteDomesticScheduledResponse3DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteDomesticScheduledResponse3DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteDomesticScheduledResponse3DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public OBWriteDomesticScheduledResponse3DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteDomesticScheduledResponse3DataInitiationRemittanceInformation RemittanceInformation { get; set; }
