...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    public partial class OBWriteInternational2Data
    {
        /// <summary>
        /// Initializes a new instance of the OBWriteInternational2Data class.
        /// </summary>
        public OBWriteInternational2Data()
        {
            CustomInit();
        }
        ...
        public OBWriteInternational2Data(string consentId, OBWriteInternational2DataInitiation initiation)
        {
            ConsentId = consentId;
