...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticScheduledConsentResponse3DataSCASupportData
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledConsentResponse3DataSCASupportData class.
        /// </summary>
        public OBWriteDomesticScheduledConsentResponse3DataSCASupportData()
        {
            CustomInit();
        }
        ...
        /// occurrence.</param>
        public OBWriteDomesticScheduledConsentResponse3DataSCASupportData(OBWriteDomesticScheduledConsentResponse3DataSCASupportDataRequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(OBWriteDomesticScheduledConsentResponse3DataSCASupportDataRequestedSCAExemptionTypeEnum?), OBWriteDomesticScheduledConsentResponse3DataSCASupportDataAppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(OBWriteDomesticScheduledConsentResponse3DataSCASupportDataAppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        public OBWriteDomesticScheduledConsentResponse3DataSCASupportDataRequestedSCAExemptionTypeEnum? RequestedSCAExemptionType { get; set; }
        ...
        public OBWriteDomesticScheduledConsentResponse3DataSCASupportDataAppliedAuthenticationApproachEnum? AppliedAuthenticationApproach { get; set; }
