...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrderConsent4DataSCASupportData
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalStandingOrderConsent4DataSCASupportData class.
        /// </summary>
        public OBWriteInternationalStandingOrderConsent4DataSCASupportData()
        {
            CustomInit();
        }
        ...
        /// occurrence.</param>
        public OBWriteInternationalStandingOrderConsent4DataSCASupportData(OBWriteInternationalStandingOrderConsent4DataSCASupportDataRequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(OBWriteInternationalStandingOrderConsent4DataSCASupportDataRequestedSCAExemptionTypeEnum?), OBWriteInternationalStandingOrderConsent4DataSCASupportDataAppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(OBWriteInternationalStandingOrderConsent4DataSCASupportDataAppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        public OBWriteInternationalStandingOrderConsent4DataSCASupportDataRequestedSCAExemptionTypeEnum? RequestedSCAExemptionType { get; set; }
        ...
        public OBWriteInternationalStandingOrderConsent4DataSCASupportDataAppliedAuthenticationApproachEnum? AppliedAuthenticationApproach { get; set; }
