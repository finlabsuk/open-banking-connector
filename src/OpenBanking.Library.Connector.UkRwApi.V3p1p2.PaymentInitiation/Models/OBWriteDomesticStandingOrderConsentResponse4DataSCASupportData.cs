...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderConsentResponse4DataSCASupportData
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteDomesticStandingOrderConsentResponse4DataSCASupportData()
        {
            CustomInit();
        }
        ...
        /// occurrence.</param>
        public OBWriteDomesticStandingOrderConsentResponse4DataSCASupportData(OBWriteDomesticStandingOrderConsentResponse4DataSCASupportDataRequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(OBWriteDomesticStandingOrderConsentResponse4DataSCASupportDataRequestedSCAExemptionTypeEnum?), OBWriteDomesticStandingOrderConsentResponse4DataSCASupportDataAppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(OBWriteDomesticStandingOrderConsentResponse4DataSCASupportDataAppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        public OBWriteDomesticStandingOrderConsentResponse4DataSCASupportDataRequestedSCAExemptionTypeEnum? RequestedSCAExemptionType { get; set; }
        ...
        public OBWriteDomesticStandingOrderConsentResponse4DataSCASupportDataAppliedAuthenticationApproachEnum? AppliedAuthenticationApproach { get; set; }
