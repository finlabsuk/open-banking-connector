...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledConsentResponse3DataInitiationRemittanceInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduledConsentResponse3DataInitiationRemittanceInformation
        /// class.
        /// </summary>
        public OBWriteInternationalScheduledConsentResponse3DataInitiationRemittanceInformation()
        {
            CustomInit();
        }
        ...
        /// be mapped.</param>
        public OBWriteInternationalScheduledConsentResponse3DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
