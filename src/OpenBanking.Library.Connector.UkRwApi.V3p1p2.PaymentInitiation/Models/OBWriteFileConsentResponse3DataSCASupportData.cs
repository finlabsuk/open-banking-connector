...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteFileConsentResponse3DataSCASupportData
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteFileConsentResponse3DataSCASupportData class.
        /// </summary>
        public OBWriteFileConsentResponse3DataSCASupportData()
        {
            CustomInit();
        }
        ...
        /// occurrence.</param>
        public OBWriteFileConsentResponse3DataSCASupportData(OBWriteFileConsentResponse3DataSCASupportDataRequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(OBWriteFileConsentResponse3DataSCASupportDataRequestedSCAExemptionTypeEnum?), OBWriteFileConsentResponse3DataSCASupportDataAppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(OBWriteFileConsentResponse3DataSCASupportDataAppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        public OBWriteFileConsentResponse3DataSCASupportDataRequestedSCAExemptionTypeEnum? RequestedSCAExemptionType { get; set; }
        ...
        public OBWriteFileConsentResponse3DataSCASupportDataAppliedAuthenticationApproachEnum? AppliedAuthenticationApproach { get; set; }
