...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2FilePaymentsHeaders6
    {
        /// <summary>
        /// Initializes a new instance of the OBC2FilePaymentsHeaders6 class.
        /// </summary>
        public OBC2FilePaymentsHeaders6()
        {
            CustomInit();
        }
        ...
        public OBC2FilePaymentsHeaders6(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
