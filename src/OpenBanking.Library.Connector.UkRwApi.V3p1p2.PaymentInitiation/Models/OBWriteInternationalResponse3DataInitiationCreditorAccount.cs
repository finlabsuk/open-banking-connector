...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalResponse3DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalResponse3DataInitiationCreditorAccount class.
        /// </summary>
        public OBWriteInternationalResponse3DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalResponse3DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
