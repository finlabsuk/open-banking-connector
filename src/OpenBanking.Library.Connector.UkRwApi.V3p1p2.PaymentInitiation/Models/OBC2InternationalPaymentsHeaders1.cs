...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2InternationalPaymentsHeaders1
    {
        /// <summary>
        /// Initializes a new instance of the OBC2InternationalPaymentsHeaders1
        /// class.
        /// </summary>
        public OBC2InternationalPaymentsHeaders1()
        {
            CustomInit();
        }
        ...
        public OBC2InternationalPaymentsHeaders1(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
