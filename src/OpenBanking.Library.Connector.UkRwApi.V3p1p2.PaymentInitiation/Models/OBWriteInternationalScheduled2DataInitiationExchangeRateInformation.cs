...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduled2DataInitiationExchangeRateInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduled2DataInitiationExchangeRateInformation
        /// class.
        /// </summary>
        public OBWriteInternationalScheduled2DataInitiationExchangeRateInformation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalScheduled2DataInitiationExchangeRateInformation(string unitCurrency, OBWriteInternationalScheduled2DataInitiationExchangeRateInformationRateTypeEnum rateType, double? exchangeRate = default(double?), string contractIdentification = default(string))
        {
        ...
        public OBWriteInternationalScheduled2DataInitiationExchangeRateInformationRateTypeEnum RateType { get; set; }
