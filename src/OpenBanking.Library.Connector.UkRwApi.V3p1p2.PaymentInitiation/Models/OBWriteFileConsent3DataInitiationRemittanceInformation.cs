...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteFileConsent3DataInitiationRemittanceInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteFileConsent3DataInitiationRemittanceInformation class.
        /// </summary>
        ...
        /// be mapped.</param>
        public OBWriteFileConsent3DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
