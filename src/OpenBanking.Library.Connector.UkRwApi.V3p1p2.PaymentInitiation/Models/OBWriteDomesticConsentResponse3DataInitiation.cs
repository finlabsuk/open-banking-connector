...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticConsentResponse3DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticConsentResponse3DataInitiation class.
        /// </summary>
        public OBWriteDomesticConsentResponse3DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticConsentResponse3DataInitiation(string instructionIdentification, string endToEndIdentification, OBWriteDomesticConsentResponse3DataInitiationInstructedAmount instructedAmount, OBWriteDomesticConsentResponse3DataInitiationCreditorAccount creditorAccount, string localInstrument = default(string), OBWriteDomesticConsentResponse3DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticConsentResponse3DataInitiationDebtorAccount), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6), OBWriteDomesticConsentResponse3DataInitiationRemittanceInformation remittanceInformation = default(OBWriteDomesticConsentResponse3DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteDomesticConsentResponse3DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteDomesticConsentResponse3DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public OBWriteDomesticConsentResponse3DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteDomesticConsentResponse3DataInitiationRemittanceInformation RemittanceInformation { get; set; }
