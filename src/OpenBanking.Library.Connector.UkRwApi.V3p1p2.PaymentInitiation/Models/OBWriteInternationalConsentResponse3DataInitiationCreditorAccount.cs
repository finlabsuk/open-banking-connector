...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsentResponse3DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalConsentResponse3DataInitiationCreditorAccount
        /// class.
        /// </summary>
        public OBWriteInternationalConsentResponse3DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalConsentResponse3DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
