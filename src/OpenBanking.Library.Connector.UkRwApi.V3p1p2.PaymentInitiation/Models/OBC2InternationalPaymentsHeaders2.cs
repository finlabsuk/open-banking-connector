...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// <summary>
    /// Defines headers for International Payments operation.
    /// </summary>
    public partial class OBC2InternationalPaymentsHeaders2
    {
        /// <summary>
        /// Initializes a new instance of the OBC2InternationalPaymentsHeaders2
        /// class.
        /// </summary>
        public OBC2InternationalPaymentsHeaders2()
        {
            CustomInit();
        }
        ...
        public OBC2InternationalPaymentsHeaders2(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
