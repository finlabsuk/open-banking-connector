...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2DomesticStandingOrdersHeaders1
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBC2DomesticStandingOrdersHeaders1 class.
        /// </summary>
        public OBC2DomesticStandingOrdersHeaders1()
        {
            CustomInit();
        }
        ...
        public OBC2DomesticStandingOrdersHeaders1(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
