...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderConsentResponse4DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticStandingOrderConsentResponse4DataInitiationCreditorAccount
        /// class.
        /// </summary>
        public OBWriteDomesticStandingOrderConsentResponse4DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticStandingOrderConsentResponse4DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
