...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrderConsent4DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalStandingOrderConsent4DataInitiation class.
        /// </summary>
        ...
        public OBWriteInternationalStandingOrderConsent4DataInitiation(string frequency, System.DateTimeOffset firstPaymentDateTime, string currencyOfTransfer, OBWriteInternationalStandingOrderConsent4DataInitiationInstructedAmount instructedAmount, OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount creditorAccount, string reference = default(string), string numberOfPayments = default(string), System.DateTimeOffset? finalPaymentDateTime = default(System.DateTimeOffset?), string purpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), OBWriteInternationalStandingOrderConsent4DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalStandingOrderConsent4DataInitiationDebtorAccount), OBWriteInternationalStandingOrderConsent4DataInitiationCreditor creditor = default(OBWriteInternationalStandingOrderConsent4DataInitiationCreditor), OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAgent), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            Frequency = frequency;
            Reference = reference;
        ...
        public OBWriteInternationalStandingOrderConsent4DataInitiationInstructedAmount InstructedAmount { get; set; }

        /// <summary>
        /// Gets or sets provides the details to identify the debtor account.
        /// </summary>
        [JsonProperty(PropertyName = "DebtorAccount")]
        public OBWriteInternationalStandingOrderConsent4DataInitiationDebtorAccount DebtorAccount { get; set; }

        /// <summary>
        /// Gets or sets party to which an amount of money is due.
        /// </summary>
        [JsonProperty(PropertyName = "Creditor")]
        public OBWriteInternationalStandingOrderConsent4DataInitiationCreditor Creditor { get; set; }
