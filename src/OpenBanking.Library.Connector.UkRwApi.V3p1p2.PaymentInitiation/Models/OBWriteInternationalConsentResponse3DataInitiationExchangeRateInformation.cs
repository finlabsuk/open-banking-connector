...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsentResponse3DataInitiationExchangeRateInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalConsentResponse3DataInitiationExchangeRateInformation
        /// class.
        /// </summary>
        public OBWriteInternationalConsentResponse3DataInitiationExchangeRateInformation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalConsentResponse3DataInitiationExchangeRateInformation(string unitCurrency, OBWriteInternationalConsentResponse3DataInitiationExchangeRateInformationRateTypeEnum rateType, double? exchangeRate = default(double?), string contractIdentification = default(string))
        {
        ...
        public OBWriteInternationalConsentResponse3DataInitiationExchangeRateInformationRateTypeEnum RateType { get; set; }
