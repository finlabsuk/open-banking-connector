...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderConsentResponse4DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticStandingOrderConsentResponse4DataInitiation class.
        /// </summary>
        public OBWriteDomesticStandingOrderConsentResponse4DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticStandingOrderConsentResponse4DataInitiation(string frequency, System.DateTimeOffset firstPaymentDateTime, OBWriteDomesticStandingOrderConsentResponse4DataInitiationFirstPaymentAmount firstPaymentAmount, OBWriteDomesticStandingOrderConsentResponse4DataInitiationCreditorAccount creditorAccount, string reference = default(string), string numberOfPayments = default(string), System.DateTimeOffset? recurringPaymentDateTime = default(System.DateTimeOffset?), System.DateTimeOffset? finalPaymentDateTime = default(System.DateTimeOffset?), OBWriteDomesticStandingOrderConsentResponse4DataInitiationRecurringPaymentAmount recurringPaymentAmount = default(OBWriteDomesticStandingOrderConsentResponse4DataInitiationRecurringPaymentAmount), OBWriteDomesticStandingOrderConsentResponse4DataInitiationFinalPaymentAmount finalPaymentAmount = default(OBWriteDomesticStandingOrderConsentResponse4DataInitiationFinalPaymentAmount), OBWriteDomesticStandingOrderConsentResponse4DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticStandingOrderConsentResponse4DataInitiationDebtorAccount), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            Frequency = frequency;
            Reference = reference;
        ...
        public OBWriteDomesticStandingOrderConsentResponse4DataInitiationFirstPaymentAmount FirstPaymentAmount { get; set; }

        /// <summary>
        /// Gets or sets the amount of the recurring Standing Order
        /// </summary>
        [JsonProperty(PropertyName = "RecurringPaymentAmount")]
        public OBWriteDomesticStandingOrderConsentResponse4DataInitiationRecurringPaymentAmount RecurringPaymentAmount { get; set; }

        /// <summary>
        /// Gets or sets the amount of the final Standing Order
        /// </summary>
        [JsonProperty(PropertyName = "FinalPaymentAmount")]
        public OBWriteDomesticStandingOrderConsentResponse4DataInitiationFinalPaymentAmount FinalPaymentAmount { get; set; }

        /// <summary>
        /// Gets or sets provides the details to identify the debtor account.
        /// </summary>
        [JsonProperty(PropertyName = "DebtorAccount")]
        public OBWriteDomesticStandingOrderConsentResponse4DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public OBWriteDomesticStandingOrderConsentResponse4DataInitiationCreditorAccount CreditorAccount { get; set; }
