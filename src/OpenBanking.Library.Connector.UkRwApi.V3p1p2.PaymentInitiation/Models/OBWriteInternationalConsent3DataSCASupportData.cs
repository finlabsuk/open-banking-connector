...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsent3DataSCASupportData
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalConsent3DataSCASupportData class.
        /// </summary>
        public OBWriteInternationalConsent3DataSCASupportData()
        {
            CustomInit();
        }
        ...
        /// occurrence.</param>
        public OBWriteInternationalConsent3DataSCASupportData(OBWriteInternationalConsent3DataSCASupportDataRequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(OBWriteInternationalConsent3DataSCASupportDataRequestedSCAExemptionTypeEnum?), OBWriteInternationalConsent3DataSCASupportDataAppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(OBWriteInternationalConsent3DataSCASupportDataAppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        public OBWriteInternationalConsent3DataSCASupportDataRequestedSCAExemptionTypeEnum? RequestedSCAExemptionType { get; set; }
        ...
        public OBWriteInternationalConsent3DataSCASupportDataAppliedAuthenticationApproachEnum? AppliedAuthenticationApproach { get; set; }
