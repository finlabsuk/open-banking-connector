...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2PaymentDetailsHeaders5
    {
        /// <summary>
        /// Initializes a new instance of the OBC2PaymentDetailsHeaders5 class.
        /// </summary>
        public OBC2PaymentDetailsHeaders5()
        {
            CustomInit();
        }
        ...
        public OBC2PaymentDetailsHeaders5(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
