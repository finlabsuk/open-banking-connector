...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2PaymentDetailsHeaders2
    {
        /// <summary>
        /// Initializes a new instance of the OBC2PaymentDetailsHeaders2 class.
        /// </summary>
        public OBC2PaymentDetailsHeaders2()
        {
            CustomInit();
        }
        ...
        public OBC2PaymentDetailsHeaders2(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
