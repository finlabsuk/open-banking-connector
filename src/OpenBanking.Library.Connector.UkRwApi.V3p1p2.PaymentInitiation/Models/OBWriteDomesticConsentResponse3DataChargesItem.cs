...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// initiation.
    /// </summary>
    public partial class OBWriteDomesticConsentResponse3DataChargesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticConsentResponse3DataChargesItem class.
        /// </summary>
        public OBWriteDomesticConsentResponse3DataChargesItem()
        {
            CustomInit();
        }
        ...
        /// 'Shared'</param>
        public OBWriteDomesticConsentResponse3DataChargesItem(OBChargeBearerType1CodeEnum chargeBearer, string type, OBActiveOrHistoricCurrencyAndAmount amount)
        {
