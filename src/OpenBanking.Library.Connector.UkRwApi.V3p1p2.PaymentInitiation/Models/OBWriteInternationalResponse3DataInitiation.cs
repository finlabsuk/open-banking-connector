...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalResponse3DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalResponse3DataInitiation class.
        /// </summary>
        public OBWriteInternationalResponse3DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalResponse3DataInitiation(string instructionIdentification, string endToEndIdentification, string currencyOfTransfer, OBWriteInternationalResponse3DataInitiationInstructedAmount instructedAmount, OBWriteInternationalResponse3DataInitiationCreditorAccount creditorAccount, string localInstrument = default(string), OBWriteInternationalResponse3DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalResponse3DataInitiationInstructionPriorityEnum?), string purpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), OBWriteInternationalResponse3DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalResponse3DataInitiationExchangeRateInformation), OBWriteInternationalResponse3DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalResponse3DataInitiationDebtorAccount), OBWriteInternationalResponse3DataInitiationCreditor creditor = default(OBWriteInternationalResponse3DataInitiationCreditor), OBWriteInternationalResponse3DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalResponse3DataInitiationCreditorAgent), OBWriteInternationalResponse3DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalResponse3DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalResponse3DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
        ...
        public OBWriteInternationalResponse3DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteInternationalResponse3DataInitiationExchangeRateInformation ExchangeRateInformation { get; set; }
        ...
        public OBWriteInternationalResponse3DataInitiationDebtorAccount DebtorAccount { get; set; }

        /// <summary>
        /// Gets or sets party to which an amount of money is due.
        /// </summary>
        [JsonProperty(PropertyName = "Creditor")]
        public OBWriteInternationalResponse3DataInitiationCreditor Creditor { get; set; }
        ...
        public OBWriteInternationalResponse3DataInitiationCreditorAgent CreditorAgent { get; set; }
        ...
        public OBWriteInternationalResponse3DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteInternationalResponse3DataInitiationRemittanceInformation RemittanceInformation { get; set; }
