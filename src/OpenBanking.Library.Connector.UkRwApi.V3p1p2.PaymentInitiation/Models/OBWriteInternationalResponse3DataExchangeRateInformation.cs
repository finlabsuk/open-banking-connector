...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalResponse3DataExchangeRateInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalResponse3DataExchangeRateInformation class.
        /// </summary>
        public OBWriteInternationalResponse3DataExchangeRateInformation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalResponse3DataExchangeRateInformation(string unitCurrency, double exchangeRate, OBWriteInternationalResponse3DataExchangeRateInformationRateTypeEnum rateType, string contractIdentification = default(string), System.DateTimeOffset? expirationDateTime = default(System.DateTimeOffset?))
        {
        ...
        public OBWriteInternationalResponse3DataExchangeRateInformationRateTypeEnum RateType { get; set; }
