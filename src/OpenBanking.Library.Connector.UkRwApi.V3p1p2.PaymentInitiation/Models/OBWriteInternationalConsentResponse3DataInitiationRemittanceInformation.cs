...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p2.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsentResponse3DataInitiationRemittanceInformation
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteInternationalConsentResponse3DataInitiationRemittanceInformation()
        {
            CustomInit();
        }
        ...
        /// be mapped.</param>
        public OBWriteInternationalConsentResponse3DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
