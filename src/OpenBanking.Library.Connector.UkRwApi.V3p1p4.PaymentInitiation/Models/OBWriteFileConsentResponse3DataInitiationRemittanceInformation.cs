...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteFileConsentResponse3DataInitiationRemittanceInformation
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteFileConsentResponse3DataInitiationRemittanceInformation()
        {
            CustomInit();
        }
        ...
        /// be mapped.</param>
        public OBWriteFileConsentResponse3DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
