...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderConsentResponse5DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticStandingOrderConsentResponse5DataInitiation class.
        /// </summary>
        public OBWriteDomesticStandingOrderConsentResponse5DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticStandingOrderConsentResponse5DataInitiation(string frequency, System.DateTimeOffset firstPaymentDateTime, OBWriteDomesticStandingOrderConsentResponse5DataInitiationFirstPaymentAmount firstPaymentAmount, OBWriteDomesticStandingOrderConsentResponse5DataInitiationCreditorAccount creditorAccount, string reference = default(string), string numberOfPayments = default(string), System.DateTimeOffset? recurringPaymentDateTime = default(System.DateTimeOffset?), System.DateTimeOffset? finalPaymentDateTime = default(System.DateTimeOffset?), OBWriteDomesticStandingOrderConsentResponse5DataInitiationRecurringPaymentAmount recurringPaymentAmount = default(OBWriteDomesticStandingOrderConsentResponse5DataInitiationRecurringPaymentAmount), OBWriteDomesticStandingOrderConsentResponse5DataInitiationFinalPaymentAmount finalPaymentAmount = default(OBWriteDomesticStandingOrderConsentResponse5DataInitiationFinalPaymentAmount), OBWriteDomesticStandingOrderConsentResponse5DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticStandingOrderConsentResponse5DataInitiationDebtorAccount), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            Frequency = frequency;
            Reference = reference;
        ...
        public OBWriteDomesticStandingOrderConsentResponse5DataInitiationFirstPaymentAmount FirstPaymentAmount { get; set; }

        /// <summary>
        /// Gets or sets the amount of the recurring Standing Order
        /// </summary>
        [JsonProperty(PropertyName = "RecurringPaymentAmount")]
        public OBWriteDomesticStandingOrderConsentResponse5DataInitiationRecurringPaymentAmount RecurringPaymentAmount { get; set; }

        /// <summary>
        /// Gets or sets the amount of the final Standing Order
        /// </summary>
        [JsonProperty(PropertyName = "FinalPaymentAmount")]
        public OBWriteDomesticStandingOrderConsentResponse5DataInitiationFinalPaymentAmount FinalPaymentAmount { get; set; }

        /// <summary>
        /// Gets or sets provides the details to identify the debtor account.
        /// </summary>
        [JsonProperty(PropertyName = "DebtorAccount")]
        public OBWriteDomesticStandingOrderConsentResponse5DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public OBWriteDomesticStandingOrderConsentResponse5DataInitiationCreditorAccount CreditorAccount { get; set; }
