...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2PaymentDetailsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OBC2PaymentDetailsHeaders class.
        /// </summary>
        public OBC2PaymentDetailsHeaders()
        {
            CustomInit();
        }
        ...
        public OBC2PaymentDetailsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
