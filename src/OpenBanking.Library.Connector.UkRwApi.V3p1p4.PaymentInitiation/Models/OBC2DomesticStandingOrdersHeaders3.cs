...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2DomesticStandingOrdersHeaders3
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBC2DomesticStandingOrdersHeaders3 class.
        /// </summary>
        public OBC2DomesticStandingOrdersHeaders3()
        {
            CustomInit();
        }
        ...
        public OBC2DomesticStandingOrdersHeaders3(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
