...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticResponse4DataRefundAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticResponse4DataRefundAccount class.
        /// </summary>
        public OBWriteDomesticResponse4DataRefundAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticResponse4DataRefundAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
