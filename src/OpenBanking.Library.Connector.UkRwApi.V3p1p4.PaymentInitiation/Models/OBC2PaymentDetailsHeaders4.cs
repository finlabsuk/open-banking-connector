...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2PaymentDetailsHeaders4
    {
        /// <summary>
        /// Initializes a new instance of the OBC2PaymentDetailsHeaders4 class.
        /// </summary>
        public OBC2PaymentDetailsHeaders4()
        {
            CustomInit();
        }
        ...
        public OBC2PaymentDetailsHeaders4(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
