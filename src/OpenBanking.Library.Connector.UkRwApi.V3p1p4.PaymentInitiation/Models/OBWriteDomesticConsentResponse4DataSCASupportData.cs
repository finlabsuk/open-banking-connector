...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticConsentResponse4DataSCASupportData
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticConsentResponse4DataSCASupportData class.
        /// </summary>
        public OBWriteDomesticConsentResponse4DataSCASupportData()
        {
            CustomInit();
        }
        ...
        /// occurrence.</param>
        public OBWriteDomesticConsentResponse4DataSCASupportData(OBWriteDomesticConsentResponse4DataSCASupportDataRequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(OBWriteDomesticConsentResponse4DataSCASupportDataRequestedSCAExemptionTypeEnum?), OBWriteDomesticConsentResponse4DataSCASupportDataAppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(OBWriteDomesticConsentResponse4DataSCASupportDataAppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        public OBWriteDomesticConsentResponse4DataSCASupportDataRequestedSCAExemptionTypeEnum? RequestedSCAExemptionType { get; set; }
        ...
        public OBWriteDomesticConsentResponse4DataSCASupportDataAppliedAuthenticationApproachEnum? AppliedAuthenticationApproach { get; set; }
