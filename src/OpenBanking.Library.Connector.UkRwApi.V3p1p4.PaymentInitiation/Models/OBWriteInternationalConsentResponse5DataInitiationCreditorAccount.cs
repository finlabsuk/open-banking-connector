...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsentResponse5DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalConsentResponse5DataInitiationCreditorAccount
        /// class.
        /// </summary>
        public OBWriteInternationalConsentResponse5DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalConsentResponse5DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
