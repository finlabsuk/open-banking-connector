...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    public partial class OBWriteDomesticScheduledConsentResponse4Data
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledConsentResponse4Data class.
        /// </summary>
        public OBWriteDomesticScheduledConsentResponse4Data()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticScheduledConsentResponse4Data(string consentId, System.DateTimeOffset creationDateTime, OBWriteDomesticScheduledConsentResponse4DataStatusEnum status, System.DateTimeOffset statusUpdateDateTime, OBWriteDomesticScheduledConsentResponse4DataInitiation initiation, OBWriteDomesticScheduledConsentResponse4DataReadRefundAccountEnum? readRefundAccount = default(OBWriteDomesticScheduledConsentResponse4DataReadRefundAccountEnum?), System.DateTimeOffset? cutOffDateTime = default(System.DateTimeOffset?), System.DateTimeOffset? expectedExecutionDateTime = default(System.DateTimeOffset?), System.DateTimeOffset? expectedSettlementDateTime = default(System.DateTimeOffset?), IList<OBWriteDomesticScheduledConsentResponse4DataChargesItem> charges = default(IList<OBWriteDomesticScheduledConsentResponse4DataChargesItem>), OBWriteDomesticScheduledConsentResponse4DataAuthorisation authorisation = default(OBWriteDomesticScheduledConsentResponse4DataAuthorisation), OBWriteDomesticScheduledConsentResponse4DataSCASupportData sCASupportData = default(OBWriteDomesticScheduledConsentResponse4DataSCASupportData))
        {
            ConsentId = consentId;
        ...
        /// <summary>
        /// Static constructor for OBWriteDomesticScheduledConsentResponse4Data
        /// class.
        /// </summary>
        static OBWriteDomesticScheduledConsentResponse4Data()
        {
            Permission = "Create";
        }
        ...
        public OBWriteDomesticScheduledConsentResponse4DataStatusEnum Status { get; set; }
        ...
        public OBWriteDomesticScheduledConsentResponse4DataReadRefundAccountEnum? ReadRefundAccount { get; set; }
        ...
        public IList<OBWriteDomesticScheduledConsentResponse4DataChargesItem> Charges { get; set; }
        ...
        public OBWriteDomesticScheduledConsentResponse4DataInitiation Initiation { get; set; }

        /// <summary>
        /// Gets or sets the authorisation type request from the TPP.
        /// </summary>
        [JsonProperty(PropertyName = "Authorisation")]
        public OBWriteDomesticScheduledConsentResponse4DataAuthorisation Authorisation { get; set; }
        ...
        public OBWriteDomesticScheduledConsentResponse4DataSCASupportData SCASupportData { get; set; }
