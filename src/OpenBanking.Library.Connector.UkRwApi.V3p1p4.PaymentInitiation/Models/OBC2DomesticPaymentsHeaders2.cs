...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2DomesticPaymentsHeaders2
    {
        /// <summary>
        /// Initializes a new instance of the OBC2DomesticPaymentsHeaders2
        /// class.
        /// </summary>
        public OBC2DomesticPaymentsHeaders2()
        {
            CustomInit();
        }
        ...
        public OBC2DomesticPaymentsHeaders2(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
