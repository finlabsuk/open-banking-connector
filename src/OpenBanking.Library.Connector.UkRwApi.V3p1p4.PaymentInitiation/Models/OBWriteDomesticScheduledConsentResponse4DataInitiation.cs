...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// creditor for a single scheduled domestic payment.
    /// </summary>
    public partial class OBWriteDomesticScheduledConsentResponse4DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledConsentResponse4DataInitiation class.
        /// </summary>
        public OBWriteDomesticScheduledConsentResponse4DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticScheduledConsentResponse4DataInitiation(string instructionIdentification, System.DateTimeOffset requestedExecutionDateTime, OBWriteDomesticScheduledConsentResponse4DataInitiationInstructedAmount instructedAmount, OBWriteDomesticScheduledConsentResponse4DataInitiationCreditorAccount creditorAccount, string endToEndIdentification = default(string), string localInstrument = default(string), OBWriteDomesticScheduledConsentResponse4DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticScheduledConsentResponse4DataInitiationDebtorAccount), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6), OBWriteDomesticScheduledConsentResponse4DataInitiationRemittanceInformation remittanceInformation = default(OBWriteDomesticScheduledConsentResponse4DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteDomesticScheduledConsentResponse4DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteDomesticScheduledConsentResponse4DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public OBWriteDomesticScheduledConsentResponse4DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteDomesticScheduledConsentResponse4DataInitiationRemittanceInformation RemittanceInformation { get; set; }
