...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrderResponse6DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalStandingOrderResponse6DataInitiation class.
        /// </summary>
        public OBWriteInternationalStandingOrderResponse6DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalStandingOrderResponse6DataInitiation(string frequency, System.DateTimeOffset firstPaymentDateTime, string currencyOfTransfer, OBWriteInternationalStandingOrderResponse6DataInitiationInstructedAmount instructedAmount, OBWriteInternationalStandingOrderResponse6DataInitiationCreditorAccount creditorAccount, string reference = default(string), string numberOfPayments = default(string), System.DateTimeOffset? finalPaymentDateTime = default(System.DateTimeOffset?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalStandingOrderResponse6DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalStandingOrderResponse6DataInitiationDebtorAccount), OBWriteInternationalStandingOrderResponse6DataInitiationCreditor creditor = default(OBWriteInternationalStandingOrderResponse6DataInitiationCreditor), OBWriteInternationalStandingOrderResponse6DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalStandingOrderResponse6DataInitiationCreditorAgent), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            Frequency = frequency;
            Reference = reference;
        ...
        public OBWriteInternationalStandingOrderResponse6DataInitiationInstructedAmount InstructedAmount { get; set; }

        /// <summary>
        /// Gets or sets provides the details to identify the debtor account.
        /// </summary>
        [JsonProperty(PropertyName = "DebtorAccount")]
        public OBWriteInternationalStandingOrderResponse6DataInitiationDebtorAccount DebtorAccount { get; set; }

        /// <summary>
        /// Gets or sets party to which an amount of money is due.
        /// </summary>
        [JsonProperty(PropertyName = "Creditor")]
        public OBWriteInternationalStandingOrderResponse6DataInitiationCreditor Creditor { get; set; }
        ...
        public OBWriteInternationalStandingOrderResponse6DataInitiationCreditorAgent CreditorAgent { get; set; }
        ...
        public OBWriteInternationalStandingOrderResponse6DataInitiationCreditorAccount CreditorAccount { get; set; }
