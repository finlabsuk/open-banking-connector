...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2InternationalStandingOrdersHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBC2InternationalStandingOrdersHeaders class.
        /// </summary>
        public OBC2InternationalStandingOrdersHeaders()
        {
            CustomInit();
        }
        ...
        public OBC2InternationalStandingOrdersHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
