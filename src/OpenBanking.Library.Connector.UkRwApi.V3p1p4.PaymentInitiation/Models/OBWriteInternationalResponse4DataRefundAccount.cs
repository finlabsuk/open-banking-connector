...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalResponse4DataRefundAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalResponse4DataRefundAccount class.
        /// </summary>
        public OBWriteInternationalResponse4DataRefundAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalResponse4DataRefundAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
