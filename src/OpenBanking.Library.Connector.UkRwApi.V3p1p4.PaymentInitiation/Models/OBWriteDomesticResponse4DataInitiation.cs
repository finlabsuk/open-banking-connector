...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticResponse4DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticResponse4DataInitiation class.
        /// </summary>
        public OBWriteDomesticResponse4DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticResponse4DataInitiation(string instructionIdentification, string endToEndIdentification, OBWriteDomesticResponse4DataInitiationInstructedAmount instructedAmount, OBWriteDomesticResponse4DataInitiationCreditorAccount creditorAccount, string localInstrument = default(string), OBWriteDomesticResponse4DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticResponse4DataInitiationDebtorAccount), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6), OBWriteDomesticResponse4DataInitiationRemittanceInformation remittanceInformation = default(OBWriteDomesticResponse4DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteDomesticResponse4DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteDomesticResponse4DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public OBWriteDomesticResponse4DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteDomesticResponse4DataInitiationRemittanceInformation RemittanceInformation { get; set; }
