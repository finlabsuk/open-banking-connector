...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2InternationalScheduledPaymentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBC2InternationalScheduledPaymentsHeaders class.
        /// </summary>
        public OBC2InternationalScheduledPaymentsHeaders()
        {
            CustomInit();
        }
        ...
        public OBC2InternationalScheduledPaymentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
