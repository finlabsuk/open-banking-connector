...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduled3DataInitiationRemittanceInformation
    {
        /// <summary>
        ...
        /// be mapped.</param>
        public OBWriteInternationalScheduled3DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
