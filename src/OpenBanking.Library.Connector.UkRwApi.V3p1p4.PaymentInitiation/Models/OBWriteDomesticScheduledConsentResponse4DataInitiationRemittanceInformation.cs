...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticScheduledConsentResponse4DataInitiationRemittanceInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledConsentResponse4DataInitiationRemittanceInformation
        /// class.
        /// </summary>
        public OBWriteDomesticScheduledConsentResponse4DataInitiationRemittanceInformation()
        {
            CustomInit();
        }
        ...
        /// be mapped.</param>
        public OBWriteDomesticScheduledConsentResponse4DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
