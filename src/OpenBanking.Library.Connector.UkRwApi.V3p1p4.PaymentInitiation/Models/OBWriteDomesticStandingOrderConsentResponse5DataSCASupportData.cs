...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderConsentResponse5DataSCASupportData
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteDomesticStandingOrderConsentResponse5DataSCASupportData()
        {
            CustomInit();
        }
        ...
        /// occurrence.</param>
        public OBWriteDomesticStandingOrderConsentResponse5DataSCASupportData(OBWriteDomesticStandingOrderConsentResponse5DataSCASupportDataRequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(OBWriteDomesticStandingOrderConsentResponse5DataSCASupportDataRequestedSCAExemptionTypeEnum?), OBWriteDomesticStandingOrderConsentResponse5DataSCASupportDataAppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(OBWriteDomesticStandingOrderConsentResponse5DataSCASupportDataAppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        public OBWriteDomesticStandingOrderConsentResponse5DataSCASupportDataRequestedSCAExemptionTypeEnum? RequestedSCAExemptionType { get; set; }
        ...
        public OBWriteDomesticStandingOrderConsentResponse5DataSCASupportDataAppliedAuthenticationApproachEnum? AppliedAuthenticationApproach { get; set; }
