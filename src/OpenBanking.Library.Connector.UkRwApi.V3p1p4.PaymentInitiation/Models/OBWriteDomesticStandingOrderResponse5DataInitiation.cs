...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderResponse5DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticStandingOrderResponse5DataInitiation class.
        /// </summary>
        public OBWriteDomesticStandingOrderResponse5DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticStandingOrderResponse5DataInitiationFirstPaymentAmount FirstPaymentAmount { get; set; }

        /// <summary>
        /// Gets or sets the amount of the recurring Standing Order
        /// </summary>
        [JsonProperty(PropertyName = "RecurringPaymentAmount")]
        public OBWriteDomesticStandingOrderResponse5DataInitiationRecurringPaymentAmount RecurringPaymentAmount { get; set; }

        /// <summary>
        /// Gets or sets the amount of the final Standing Order
        /// </summary>
        [JsonProperty(PropertyName = "FinalPaymentAmount")]
        public OBWriteDomesticStandingOrderResponse5DataInitiationFinalPaymentAmount FinalPaymentAmount { get; set; }

        /// <summary>
        /// Gets or sets provides the details to identify the debtor account.
        /// </summary>
        [JsonProperty(PropertyName = "DebtorAccount")]
        public OBWriteDomesticStandingOrderResponse5DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public OBWriteDomesticStandingOrderResponse5DataInitiationCreditorAccount CreditorAccount { get; set; }
