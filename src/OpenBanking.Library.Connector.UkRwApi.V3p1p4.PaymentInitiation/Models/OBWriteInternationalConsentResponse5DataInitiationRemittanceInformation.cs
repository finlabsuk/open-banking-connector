...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsentResponse5DataInitiationRemittanceInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalConsentResponse5DataInitiationRemittanceInformation
        /// class.
        /// </summary>
        public OBWriteInternationalConsentResponse5DataInitiationRemittanceInformation()
        {
            CustomInit();
        }
        ...
        /// be mapped.</param>
        public OBWriteInternationalConsentResponse5DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
