...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrderConsentResponse6DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalStandingOrderConsentResponse6DataInitiationCreditorAccount
        /// class.
        /// </summary>
        public OBWriteInternationalStandingOrderConsentResponse6DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalStandingOrderConsentResponse6DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
