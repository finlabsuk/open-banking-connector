...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2FilePaymentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OBC2FilePaymentsHeaders class.
        /// </summary>
        public OBC2FilePaymentsHeaders()
        {
            CustomInit();
        }
        ...
        public OBC2FilePaymentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
