...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrderConsent6DataSCASupportData
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalStandingOrderConsent6DataSCASupportData class.
        /// </summary>
        public OBWriteInternationalStandingOrderConsent6DataSCASupportData()
        {
            CustomInit();
        }
        ...
        /// occurrence.</param>
        public OBWriteInternationalStandingOrderConsent6DataSCASupportData(OBWriteInternationalStandingOrderConsent6DataSCASupportDataRequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(OBWriteInternationalStandingOrderConsent6DataSCASupportDataRequestedSCAExemptionTypeEnum?), OBWriteInternationalStandingOrderConsent6DataSCASupportDataAppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(OBWriteInternationalStandingOrderConsent6DataSCASupportDataAppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        public OBWriteInternationalStandingOrderConsent6DataSCASupportDataRequestedSCAExemptionTypeEnum? RequestedSCAExemptionType { get; set; }
        ...
        public OBWriteInternationalStandingOrderConsent6DataSCASupportDataAppliedAuthenticationApproachEnum? AppliedAuthenticationApproach { get; set; }
