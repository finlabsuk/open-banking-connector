...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderResponse5DataRefundAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticStandingOrderResponse5DataRefundAccount class.
        /// </summary>
        public OBWriteDomesticStandingOrderResponse5DataRefundAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticStandingOrderResponse5DataRefundAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
