...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// initiation.
    /// </summary>
    public partial class OBWriteFileResponse2DataChargesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteFileResponse2DataChargesItem class.
        /// </summary>
        public OBWriteFileResponse2DataChargesItem()
        {
            CustomInit();
        }
        ...
        /// 'Shared'</param>
        public OBWriteFileResponse2DataChargesItem(OBChargeBearerType1CodeEnum chargeBearer, string type, OBActiveOrHistoricCurrencyAndAmount amount)
        {
