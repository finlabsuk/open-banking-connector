...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderConsent5DataInitiationDebtorAccount
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteDomesticStandingOrderConsent5DataInitiationDebtorAccount()
        {
            CustomInit();
        }
        ...
        /// the account.</param>
        public OBWriteDomesticStandingOrderConsent5DataInitiationDebtorAccount(string schemeName, string identification, string name = default(string), string secondaryIdentification = default(string))
        {
