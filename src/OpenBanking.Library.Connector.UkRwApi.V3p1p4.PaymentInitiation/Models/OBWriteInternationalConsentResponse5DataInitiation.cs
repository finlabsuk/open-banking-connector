...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsentResponse5DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalConsentResponse5DataInitiation class.
        /// </summary>
        public OBWriteInternationalConsentResponse5DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalConsentResponse5DataInitiation(string instructionIdentification, string endToEndIdentification, string currencyOfTransfer, OBWriteInternationalConsentResponse5DataInitiationInstructedAmount instructedAmount, OBWriteInternationalConsentResponse5DataInitiationCreditorAccount creditorAccount, string localInstrument = default(string), OBWriteInternationalConsentResponse5DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalConsentResponse5DataInitiationInstructionPriorityEnum?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalConsentResponse5DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalConsentResponse5DataInitiationExchangeRateInformation), OBWriteInternationalConsentResponse5DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalConsentResponse5DataInitiationDebtorAccount), OBWriteInternationalConsentResponse5DataInitiationCreditor creditor = default(OBWriteInternationalConsentResponse5DataInitiationCreditor), OBWriteInternationalConsentResponse5DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalConsentResponse5DataInitiationCreditorAgent), OBWriteInternationalConsentResponse5DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalConsentResponse5DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalConsentResponse5DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
        ...
        public OBWriteInternationalConsentResponse5DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteInternationalConsentResponse5DataInitiationExchangeRateInformation ExchangeRateInformation { get; set; }
        ...
        public OBWriteInternationalConsentResponse5DataInitiationDebtorAccount DebtorAccount { get; set; }

        /// <summary>
        /// Gets or sets party to which an amount of money is due.
        /// </summary>
        [JsonProperty(PropertyName = "Creditor")]
        public OBWriteInternationalConsentResponse5DataInitiationCreditor Creditor { get; set; }
        ...
        public OBWriteInternationalConsentResponse5DataInitiationCreditorAgent CreditorAgent { get; set; }
        ...
        public OBWriteInternationalConsentResponse5DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteInternationalConsentResponse5DataInitiationRemittanceInformation RemittanceInformation { get; set; }
