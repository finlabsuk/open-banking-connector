...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2DomesticScheduledPaymentsHeaders1
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBC2DomesticScheduledPaymentsHeaders1 class.
        /// </summary>
        public OBC2DomesticScheduledPaymentsHeaders1()
        {
            CustomInit();
        }
        ...
        public OBC2DomesticScheduledPaymentsHeaders1(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
