...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticScheduledResponse4DataRefundAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledResponse4DataRefundAccount class.
        /// </summary>
        public OBWriteDomesticScheduledResponse4DataRefundAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticScheduledResponse4DataRefundAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
