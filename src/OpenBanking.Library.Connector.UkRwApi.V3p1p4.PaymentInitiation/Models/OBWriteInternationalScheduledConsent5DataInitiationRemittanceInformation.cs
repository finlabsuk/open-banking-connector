...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledConsent5DataInitiationRemittanceInformation
    {
        /// <summary>
        ...
        /// be mapped.</param>
        public OBWriteInternationalScheduledConsent5DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
