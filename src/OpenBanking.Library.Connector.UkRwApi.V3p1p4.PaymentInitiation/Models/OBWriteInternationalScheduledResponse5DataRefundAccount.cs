...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledResponse5DataRefundAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduledResponse5DataRefundAccount class.
        /// </summary>
        public OBWriteInternationalScheduledResponse5DataRefundAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalScheduledResponse5DataRefundAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
