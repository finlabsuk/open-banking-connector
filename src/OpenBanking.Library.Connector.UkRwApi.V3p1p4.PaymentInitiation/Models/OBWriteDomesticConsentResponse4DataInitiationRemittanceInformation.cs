...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticConsentResponse4DataInitiationRemittanceInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticConsentResponse4DataInitiationRemittanceInformation
        /// class.
        /// </summary>
        public OBWriteDomesticConsentResponse4DataInitiationRemittanceInformation()
        {
            CustomInit();
        }
        ...
        /// be mapped.</param>
        public OBWriteDomesticConsentResponse4DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
