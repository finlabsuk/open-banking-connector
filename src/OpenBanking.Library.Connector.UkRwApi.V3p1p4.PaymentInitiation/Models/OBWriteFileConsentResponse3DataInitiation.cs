...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteFileConsentResponse3DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteFileConsentResponse3DataInitiation class.
        /// </summary>
        public OBWriteFileConsentResponse3DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteFileConsentResponse3DataInitiation(string fileType, string fileHash, string fileReference = default(string), string numberOfTransactions = default(string), double? controlSum = default(double?), System.DateTimeOffset? requestedExecutionDateTime = default(System.DateTimeOffset?), string localInstrument = default(string), OBWriteFileConsentResponse3DataInitiationDebtorAccount debtorAccount = default(OBWriteFileConsentResponse3DataInitiationDebtorAccount), OBWriteFileConsentResponse3DataInitiationRemittanceInformation remittanceInformation = default(OBWriteFileConsentResponse3DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            FileType = fileType;
            FileHash = fileHash;
        ...
        public OBWriteFileConsentResponse3DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public OBWriteFileConsentResponse3DataInitiationRemittanceInformation RemittanceInformation { get; set; }
