...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteFileConsent3DataSCASupportData
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteFileConsent3DataSCASupportData class.
        /// </summary>
        public OBWriteFileConsent3DataSCASupportData()
        {
            CustomInit();
        }
        ...
        /// occurrence.</param>
        public OBWriteFileConsent3DataSCASupportData(OBWriteFileConsent3DataSCASupportDataRequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(OBWriteFileConsent3DataSCASupportDataRequestedSCAExemptionTypeEnum?), OBWriteFileConsent3DataSCASupportDataAppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(OBWriteFileConsent3DataSCASupportDataAppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        public OBWriteFileConsent3DataSCASupportDataRequestedSCAExemptionTypeEnum? RequestedSCAExemptionType { get; set; }
        ...
        public OBWriteFileConsent3DataSCASupportDataAppliedAuthenticationApproachEnum? AppliedAuthenticationApproach { get; set; }
