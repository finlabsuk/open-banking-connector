...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2FilePaymentsHeaders5
    {
        /// <summary>
        /// Initializes a new instance of the OBC2FilePaymentsHeaders5 class.
        /// </summary>
        public OBC2FilePaymentsHeaders5()
        {
            CustomInit();
        }
        ...
        public OBC2FilePaymentsHeaders5(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
