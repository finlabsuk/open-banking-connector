...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticScheduled2DataInitiationRemittanceInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduled2DataInitiationRemittanceInformation class.
        /// </summary>
        ...
        /// be mapped.</param>
        public OBWriteDomesticScheduled2DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
