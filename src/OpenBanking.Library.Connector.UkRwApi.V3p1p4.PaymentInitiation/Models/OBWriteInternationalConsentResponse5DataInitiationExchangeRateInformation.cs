...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsentResponse5DataInitiationExchangeRateInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalConsentResponse5DataInitiationExchangeRateInformation
        /// class.
        /// </summary>
        public OBWriteInternationalConsentResponse5DataInitiationExchangeRateInformation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalConsentResponse5DataInitiationExchangeRateInformation(string unitCurrency, OBWriteInternationalConsentResponse5DataInitiationExchangeRateInformationRateTypeEnum rateType, double? exchangeRate = default(double?), string contractIdentification = default(string))
        {
        ...
        public OBWriteInternationalConsentResponse5DataInitiationExchangeRateInformationRateTypeEnum RateType { get; set; }
