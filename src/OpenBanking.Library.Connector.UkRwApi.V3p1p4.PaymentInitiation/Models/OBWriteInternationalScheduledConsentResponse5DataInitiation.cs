...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledConsentResponse5DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduledConsentResponse5DataInitiation class.
        /// </summary>
        public OBWriteInternationalScheduledConsentResponse5DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalScheduledConsentResponse5DataInitiation(string instructionIdentification, System.DateTimeOffset requestedExecutionDateTime, string currencyOfTransfer, OBWriteInternationalScheduledConsentResponse5DataInitiationInstructedAmount instructedAmount, OBWriteInternationalScheduledConsentResponse5DataInitiationCreditorAccount creditorAccount, string endToEndIdentification = default(string), string localInstrument = default(string), OBWriteInternationalScheduledConsentResponse5DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalScheduledConsentResponse5DataInitiationInstructionPriorityEnum?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalScheduledConsentResponse5DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalScheduledConsentResponse5DataInitiationExchangeRateInformation), OBWriteInternationalScheduledConsentResponse5DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalScheduledConsentResponse5DataInitiationDebtorAccount), OBWriteInternationalScheduledConsentResponse5DataInitiationCreditor creditor = default(OBWriteInternationalScheduledConsentResponse5DataInitiationCreditor), OBWriteInternationalScheduledConsentResponse5DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalScheduledConsentResponse5DataInitiationCreditorAgent), OBWriteInternationalScheduledConsentResponse5DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalScheduledConsentResponse5DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalScheduledConsentResponse5DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
        ...
        public OBWriteInternationalScheduledConsentResponse5DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteInternationalScheduledConsentResponse5DataInitiationExchangeRateInformation ExchangeRateInformation { get; set; }
        ...
        public OBWriteInternationalScheduledConsentResponse5DataInitiationDebtorAccount DebtorAccount { get; set; }

        /// <summary>
        /// Gets or sets party to which an amount of money is due.
        /// </summary>
        [JsonProperty(PropertyName = "Creditor")]
        public OBWriteInternationalScheduledConsentResponse5DataInitiationCreditor Creditor { get; set; }
        ...
        public OBWriteInternationalScheduledConsentResponse5DataInitiationCreditorAgent CreditorAgent { get; set; }
        ...
        public OBWriteInternationalScheduledConsentResponse5DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteInternationalScheduledConsentResponse5DataInitiationRemittanceInformation RemittanceInformation { get; set; }
