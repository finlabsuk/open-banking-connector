...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p4.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticConsentResponse4DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticConsentResponse4DataInitiation class.
        /// </summary>
        public OBWriteDomesticConsentResponse4DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticConsentResponse4DataInitiation(string instructionIdentification, string endToEndIdentification, OBWriteDomesticConsentResponse4DataInitiationInstructedAmount instructedAmount, OBWriteDomesticConsentResponse4DataInitiationCreditorAccount creditorAccount, string localInstrument = default(string), OBWriteDomesticConsentResponse4DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticConsentResponse4DataInitiationDebtorAccount), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6), OBWriteDomesticConsentResponse4DataInitiationRemittanceInformation remittanceInformation = default(OBWriteDomesticConsentResponse4DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteDomesticConsentResponse4DataInitiationInstructedAmount InstructedAmount { get; set; }
        ...
        public OBWriteDomesticConsentResponse4DataInitiationDebtorAccount DebtorAccount { get; set; }
        ...
        public OBWriteDomesticConsentResponse4DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        public OBWriteDomesticConsentResponse4DataInitiationRemittanceInformation RemittanceInformation { get; set; }
