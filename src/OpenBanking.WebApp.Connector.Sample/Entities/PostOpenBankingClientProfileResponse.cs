...
namespace FinnovationLabs.OpenBanking.WebApp.Connector.Sample.Entities
{
    ...
    {
        public PostOpenBankingClientProfileResponse(OpenBankingClientProfileResponse data, MessagesResponse messages)
        {
            Data = data;
            Messages = messages;
        }
        ...
        [JsonProperty("data")]
        public OpenBankingClientProfileResponse Data { get; set; }
