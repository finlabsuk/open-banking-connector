...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternational3DataInitiationExchangeRateInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternational3DataInitiationExchangeRateInformation class.
        /// </summary>
        ...
        public OBWriteInternational3DataInitiationExchangeRateInformation(string unitCurrency, OBWriteInternational3DataInitiationExchangeRateInformationRateTypeEnum rateType, double? exchangeRate = default(double?), string contractIdentification = default(string))
        {
        ...
        public OBWriteInternational3DataInitiationExchangeRateInformationRateTypeEnum RateType { get; set; }
