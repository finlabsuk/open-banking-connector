...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDomesticScheduledPaymentConsentsConsentId
    /// operation.
    /// </summary>
    public partial class GetDomesticScheduledPaymentConsentsConsentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetDomesticScheduledPaymentConsentsConsentIdHeaders class.
        /// </summary>
        public GetDomesticScheduledPaymentConsentsConsentIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetDomesticScheduledPaymentConsentsConsentIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
