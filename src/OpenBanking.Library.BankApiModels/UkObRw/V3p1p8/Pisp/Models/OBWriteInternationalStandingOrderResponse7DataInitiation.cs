...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrderResponse7DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalStandingOrderResponse7DataInitiation class.
        /// </summary>
        ...
        public OBWriteInternationalStandingOrderResponse7DataInitiation(string frequency, System.DateTimeOffset firstPaymentDateTime, string currencyOfTransfer, OBWriteInternationalStandingOrderResponse7DataInitiationInstructedAmount instructedAmount, OBWriteInternationalStandingOrderResponse7DataInitiationCreditorAccount creditorAccount, string reference = default(string), string numberOfPayments = default(string), System.DateTimeOffset? finalPaymentDateTime = default(System.DateTimeOffset?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalStandingOrderResponse7DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalStandingOrderResponse7DataInitiationDebtorAccount), OBWriteInternationalStandingOrderResponse7DataInitiationCreditor creditor = default(OBWriteInternationalStandingOrderResponse7DataInitiationCreditor), OBWriteInternationalStandingOrderResponse7DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalStandingOrderResponse7DataInitiationCreditorAgent), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            Frequency = frequency;
            Reference = reference;
