...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduled3DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduled3DataInitiation class.
        /// </summary>
        ...
        public OBWriteInternationalScheduled3DataInitiation(string instructionIdentification, System.DateTimeOffset requestedExecutionDateTime, string currencyOfTransfer, OBWriteInternationalScheduled3DataInitiationInstructedAmount instructedAmount, OBWriteInternationalScheduled3DataInitiationCreditorAccount creditorAccount, string endToEndIdentification = default(string), string localInstrument = default(string), OBWriteInternationalScheduled3DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalScheduled3DataInitiationInstructionPriorityEnum?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalScheduled3DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalScheduled3DataInitiationExchangeRateInformation), OBWriteInternationalScheduled3DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalScheduled3DataInitiationDebtorAccount), OBWriteInternationalScheduled3DataInitiationCreditor creditor = default(OBWriteInternationalScheduled3DataInitiationCreditor), OBWriteInternationalScheduled3DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalScheduled3DataInitiationCreditorAgent), OBWriteInternationalScheduled3DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalScheduled3DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalScheduled3DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
