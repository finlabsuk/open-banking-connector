...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for
    /// GetInternationalPaymentsInternationalPaymentIdPaymentDetails operation.
    /// </summary>
    public partial class GetInternationalPaymentsInternationalPaymentIdPaymentDetailsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetInternationalPaymentsInternationalPaymentIdPaymentDetailsHeaders
        /// class.
        /// </summary>
        public GetInternationalPaymentsInternationalPaymentIdPaymentDetailsHeaders()
        {
            CustomInit();
        }
        ...
        public GetInternationalPaymentsInternationalPaymentIdPaymentDetailsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
