...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// operation.
    /// </summary>
    public partial class GetInternationalStandingOrdersInternationalStandingOrderPaymentIdPaymentDetailsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetInternationalStandingOrdersInternationalStandingOrderPaymentIdPaymentDetailsHeaders
        /// class.
        /// </summary>
        public GetInternationalStandingOrdersInternationalStandingOrderPaymentIdPaymentDetailsHeaders()
        {
            CustomInit();
        }
        ...
        public GetInternationalStandingOrdersInternationalStandingOrderPaymentIdPaymentDetailsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
