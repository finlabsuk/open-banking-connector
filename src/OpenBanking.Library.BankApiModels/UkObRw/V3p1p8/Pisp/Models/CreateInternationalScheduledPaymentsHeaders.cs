...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateInternationalScheduledPayments operation.
    /// </summary>
    public partial class CreateInternationalScheduledPaymentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateInternationalScheduledPaymentsHeaders class.
        /// </summary>
        public CreateInternationalScheduledPaymentsHeaders()
        {
            CustomInit();
        }
        ...
        public CreateInternationalScheduledPaymentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
