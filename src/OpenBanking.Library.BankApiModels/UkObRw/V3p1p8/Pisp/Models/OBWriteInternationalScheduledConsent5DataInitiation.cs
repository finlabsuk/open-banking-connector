...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledConsent5DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduledConsent5DataInitiation class.
        /// </summary>
        ...
        public OBWriteInternationalScheduledConsent5DataInitiation(string instructionIdentification, System.DateTimeOffset requestedExecutionDateTime, string currencyOfTransfer, OBWriteInternationalScheduledConsent5DataInitiationInstructedAmount instructedAmount, OBWriteInternationalScheduledConsent5DataInitiationCreditorAccount creditorAccount, string endToEndIdentification = default(string), string localInstrument = default(string), OBWriteInternationalScheduledConsent5DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalScheduledConsent5DataInitiationInstructionPriorityEnum?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalScheduledConsent5DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalScheduledConsent5DataInitiationExchangeRateInformation), OBWriteInternationalScheduledConsent5DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalScheduledConsent5DataInitiationDebtorAccount), OBWriteInternationalScheduledConsent5DataInitiationCreditor creditor = default(OBWriteInternationalScheduledConsent5DataInitiationCreditor), OBWriteInternationalScheduledConsent5DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalScheduledConsent5DataInitiationCreditorAgent), OBWriteInternationalScheduledConsent5DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalScheduledConsent5DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalScheduledConsent5DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
