...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    public partial class OBWriteDomesticResponse5Data
    {
        ...
        public virtual void Validate()
        {
            ...
            if (DomesticPaymentId != null)
            {
                if (DomesticPaymentId.Length > 40)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "DomesticPaymentId", 40);
                }
                if (DomesticPaymentId.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "DomesticPaymentId", 1);
                }
            }
            if (ConsentId != null)
            {
