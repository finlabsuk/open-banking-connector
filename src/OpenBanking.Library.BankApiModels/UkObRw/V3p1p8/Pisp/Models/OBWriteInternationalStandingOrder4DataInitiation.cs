...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrder4DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalStandingOrder4DataInitiation class.
        /// </summary>
        ...
        public OBWriteInternationalStandingOrder4DataInitiation(string frequency, System.DateTimeOffset firstPaymentDateTime, string currencyOfTransfer, OBWriteInternationalStandingOrder4DataInitiationInstructedAmount instructedAmount, OBWriteInternationalStandingOrder4DataInitiationCreditorAccount creditorAccount, string reference = default(string), string numberOfPayments = default(string), System.DateTimeOffset? finalPaymentDateTime = default(System.DateTimeOffset?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalStandingOrder4DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalStandingOrder4DataInitiationDebtorAccount), OBWriteInternationalStandingOrder4DataInitiationCreditor creditor = default(OBWriteInternationalStandingOrder4DataInitiationCreditor), OBWriteInternationalStandingOrder4DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalStandingOrder4DataInitiationCreditorAgent), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            Frequency = frequency;
            Reference = reference;
