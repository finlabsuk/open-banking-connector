...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateFilePaymentConsentsConsentIdFile operation.
    /// </summary>
    public partial class CreateFilePaymentConsentsConsentIdFileHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateFilePaymentConsentsConsentIdFileHeaders class.
        /// </summary>
        public CreateFilePaymentConsentsConsentIdFileHeaders()
        {
            CustomInit();
        }
        ...
        public CreateFilePaymentConsentsConsentIdFileHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
