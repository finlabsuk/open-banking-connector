...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticScheduledConsentResponse5DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledConsentResponse5DataInitiation class.
        /// </summary>
        public OBWriteDomesticScheduledConsentResponse5DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticScheduledConsentResponse5DataInitiation(string instructionIdentification, System.DateTimeOffset requestedExecutionDateTime, OBWriteDomesticScheduledConsentResponse5DataInitiationInstructedAmount instructedAmount, OBWriteDomesticScheduledConsentResponse5DataInitiationCreditorAccount creditorAccount, string endToEndIdentification = default(string), string localInstrument = default(string), OBWriteDomesticScheduledConsentResponse5DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticScheduledConsentResponse5DataInitiationDebtorAccount), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6), OBWriteDomesticScheduledConsentResponse5DataInitiationRemittanceInformation remittanceInformation = default(OBWriteDomesticScheduledConsentResponse5DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public virtual void Validate()
        {
            ...
            {
                CreditorPostalAddress.Validate();
            }
