...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsent5DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalConsent5DataInitiation class.
        /// </summary>
        ...
        public OBWriteInternationalConsent5DataInitiation(string instructionIdentification, string endToEndIdentification, string currencyOfTransfer, OBWriteInternationalConsent5DataInitiationInstructedAmount instructedAmount, OBWriteInternationalConsent5DataInitiationCreditorAccount creditorAccount, string localInstrument = default(string), OBWriteInternationalConsent5DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalConsent5DataInitiationInstructionPriorityEnum?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalConsent5DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalConsent5DataInitiationExchangeRateInformation), OBWriteInternationalConsent5DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalConsent5DataInitiationDebtorAccount), OBWriteInternationalConsent5DataInitiationCreditor creditor = default(OBWriteInternationalConsent5DataInitiationCreditor), OBWriteInternationalConsent5DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalConsent5DataInitiationCreditorAgent), OBWriteInternationalConsent5DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalConsent5DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalConsent5DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
