...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticResponse5DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticResponse5DataInitiation class.
        /// </summary>
        public OBWriteDomesticResponse5DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticResponse5DataInitiation(string instructionIdentification, string endToEndIdentification, OBWriteDomesticResponse5DataInitiationInstructedAmount instructedAmount, OBWriteDomesticResponse5DataInitiationCreditorAccount creditorAccount, string localInstrument = default(string), OBWriteDomesticResponse5DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticResponse5DataInitiationDebtorAccount), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6), OBWriteDomesticResponse5DataInitiationRemittanceInformation remittanceInformation = default(OBWriteDomesticResponse5DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
