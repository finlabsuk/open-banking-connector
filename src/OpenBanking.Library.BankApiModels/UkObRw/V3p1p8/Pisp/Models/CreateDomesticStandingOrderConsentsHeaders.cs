...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateDomesticStandingOrderConsents operation.
    /// </summary>
    public partial class CreateDomesticStandingOrderConsentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateDomesticStandingOrderConsentsHeaders class.
        /// </summary>
        public CreateDomesticStandingOrderConsentsHeaders()
        {
            CustomInit();
        }
        ...
        public CreateDomesticStandingOrderConsentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
