...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for
    /// GetDomesticScheduledPaymentsDomesticScheduledPaymentId operation.
    /// </summary>
    public partial class GetDomesticScheduledPaymentsDomesticScheduledPaymentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetDomesticScheduledPaymentsDomesticScheduledPaymentIdHeaders
        /// class.
        /// </summary>
        public GetDomesticScheduledPaymentsDomesticScheduledPaymentIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetDomesticScheduledPaymentsDomesticScheduledPaymentIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
