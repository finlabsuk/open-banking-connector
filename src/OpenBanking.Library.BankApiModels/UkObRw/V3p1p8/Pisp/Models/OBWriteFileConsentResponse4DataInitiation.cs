...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteFileConsentResponse4DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteFileConsentResponse4DataInitiation class.
        /// </summary>
        public OBWriteFileConsentResponse4DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteFileConsentResponse4DataInitiation(string fileType, string fileHash, string fileReference = default(string), string numberOfTransactions = default(string), double? controlSum = default(double?), System.DateTimeOffset? requestedExecutionDateTime = default(System.DateTimeOffset?), string localInstrument = default(string), OBWriteFileConsentResponse4DataInitiationDebtorAccount debtorAccount = default(OBWriteFileConsentResponse4DataInitiationDebtorAccount), OBWriteFileConsentResponse4DataInitiationRemittanceInformation remittanceInformation = default(OBWriteFileConsentResponse4DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            FileType = fileType;
            FileHash = fileHash;
        ...
        public virtual void Validate()
        {
            ...
            if (FileHash != null)
            {
                if (FileHash.Length > 44)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "FileHash", 44);
                }
                if (FileHash.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "FileHash", 1);
                }
            }
            if (FileReference != null)
            {
                if (FileReference.Length > 40)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "FileReference", 40);
                }
                if (FileReference.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "FileReference", 1);
                }
            }
            if (NumberOfTransactions != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(NumberOfTransactions, "[0-9]{1,15}"))
                {
                    throw new ValidationException(ValidationRules.Pattern, "NumberOfTransactions", "[0-9]{1,15}");
                }
            }
