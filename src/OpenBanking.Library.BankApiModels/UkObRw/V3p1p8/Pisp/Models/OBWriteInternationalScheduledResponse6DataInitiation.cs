...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledResponse6DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduledResponse6DataInitiation class.
        /// </summary>
        public OBWriteInternationalScheduledResponse6DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalScheduledResponse6DataInitiation(string instructionIdentification, System.DateTimeOffset requestedExecutionDateTime, string currencyOfTransfer, OBWriteInternationalScheduledResponse6DataInitiationInstructedAmount instructedAmount, OBWriteInternationalScheduledResponse6DataInitiationCreditorAccount creditorAccount, string endToEndIdentification = default(string), string localInstrument = default(string), OBWriteInternationalScheduledResponse6DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalScheduledResponse6DataInitiationInstructionPriorityEnum?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalScheduledResponse6DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalScheduledResponse6DataInitiationExchangeRateInformation), OBWriteInternationalScheduledResponse6DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalScheduledResponse6DataInitiationDebtorAccount), OBWriteInternationalScheduledResponse6DataInitiationCreditor creditor = default(OBWriteInternationalScheduledResponse6DataInitiationCreditor), OBWriteInternationalScheduledResponse6DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalScheduledResponse6DataInitiationCreditorAgent), OBWriteInternationalScheduledResponse6DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalScheduledResponse6DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalScheduledResponse6DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
