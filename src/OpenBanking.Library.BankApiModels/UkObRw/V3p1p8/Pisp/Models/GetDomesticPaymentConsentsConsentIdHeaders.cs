...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDomesticPaymentConsentsConsentId operation.
    /// </summary>
    public partial class GetDomesticPaymentConsentsConsentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetDomesticPaymentConsentsConsentIdHeaders class.
        /// </summary>
        public GetDomesticPaymentConsentsConsentIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetDomesticPaymentConsentsConsentIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
