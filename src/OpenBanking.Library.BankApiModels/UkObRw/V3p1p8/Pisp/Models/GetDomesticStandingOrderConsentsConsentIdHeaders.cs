...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDomesticStandingOrderConsentsConsentId
    /// operation.
    /// </summary>
    public partial class GetDomesticStandingOrderConsentsConsentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetDomesticStandingOrderConsentsConsentIdHeaders class.
        /// </summary>
        public GetDomesticStandingOrderConsentsConsentIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetDomesticStandingOrderConsentsConsentIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
