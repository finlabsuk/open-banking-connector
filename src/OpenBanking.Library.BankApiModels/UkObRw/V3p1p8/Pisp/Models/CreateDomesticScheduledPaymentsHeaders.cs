...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateDomesticScheduledPayments operation.
    /// </summary>
    public partial class CreateDomesticScheduledPaymentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateDomesticScheduledPaymentsHeaders class.
        /// </summary>
        public CreateDomesticScheduledPaymentsHeaders()
        {
            CustomInit();
        }
        ...
        public CreateDomesticScheduledPaymentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
