...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalResponse5DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalResponse5DataInitiation class.
        /// </summary>
        public OBWriteInternationalResponse5DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalResponse5DataInitiation(string instructionIdentification, string endToEndIdentification, string currencyOfTransfer, OBWriteInternationalResponse5DataInitiationInstructedAmount instructedAmount, OBWriteInternationalResponse5DataInitiationCreditorAccount creditorAccount, string localInstrument = default(string), OBWriteInternationalResponse5DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalResponse5DataInitiationInstructionPriorityEnum?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalResponse5DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalResponse5DataInitiationExchangeRateInformation), OBWriteInternationalResponse5DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalResponse5DataInitiationDebtorAccount), OBWriteInternationalResponse5DataInitiationCreditor creditor = default(OBWriteInternationalResponse5DataInitiationCreditor), OBWriteInternationalResponse5DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalResponse5DataInitiationCreditorAgent), OBWriteInternationalResponse5DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalResponse5DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalResponse5DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
