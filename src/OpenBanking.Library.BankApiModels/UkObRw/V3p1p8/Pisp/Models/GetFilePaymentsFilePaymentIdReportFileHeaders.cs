...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetFilePaymentsFilePaymentIdReportFile operation.
    /// </summary>
    public partial class GetFilePaymentsFilePaymentIdReportFileHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetFilePaymentsFilePaymentIdReportFileHeaders class.
        /// </summary>
        public GetFilePaymentsFilePaymentIdReportFileHeaders()
        {
            CustomInit();
        }
        ...
        public GetFilePaymentsFilePaymentIdReportFileHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
