...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// operation.
    /// </summary>
    public partial class GetInternationalScheduledPaymentsInternationalScheduledPaymentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetInternationalScheduledPaymentsInternationalScheduledPaymentIdHeaders
        /// class.
        /// </summary>
        public GetInternationalScheduledPaymentsInternationalScheduledPaymentIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetInternationalScheduledPaymentsInternationalScheduledPaymentIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
