...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteFileResponse3DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteFileResponse3DataInitiation class.
        /// </summary>
        ...
        public OBWriteFileResponse3DataInitiation(string fileType, string fileHash, string fileReference = default(string), string numberOfTransactions = default(string), double? controlSum = default(double?), System.DateTimeOffset? requestedExecutionDateTime = default(System.DateTimeOffset?), string localInstrument = default(string), OBWriteFileResponse3DataInitiationDebtorAccount debtorAccount = default(OBWriteFileResponse3DataInitiationDebtorAccount), OBWriteFileResponse3DataInitiationRemittanceInformation remittanceInformation = default(OBWriteFileResponse3DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            FileType = fileType;
            FileHash = fileHash;
