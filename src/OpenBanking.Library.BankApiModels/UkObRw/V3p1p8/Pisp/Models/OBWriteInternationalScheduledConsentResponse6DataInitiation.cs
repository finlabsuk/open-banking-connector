...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledConsentResponse6DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduledConsentResponse6DataInitiation class.
        /// </summary>
        ...
        public OBWriteInternationalScheduledConsentResponse6DataInitiation(string instructionIdentification, System.DateTimeOffset requestedExecutionDateTime, string currencyOfTransfer, OBWriteInternationalScheduledConsentResponse6DataInitiationInstructedAmount instructedAmount, OBWriteInternationalScheduledConsentResponse6DataInitiationCreditorAccount creditorAccount, string endToEndIdentification = default(string), string localInstrument = default(string), OBWriteInternationalScheduledConsentResponse6DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalScheduledConsentResponse6DataInitiationInstructionPriorityEnum?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalScheduledConsentResponse6DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalScheduledConsentResponse6DataInitiationExchangeRateInformation), OBWriteInternationalScheduledConsentResponse6DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalScheduledConsentResponse6DataInitiationDebtorAccount), OBWriteInternationalScheduledConsentResponse6DataInitiationCreditor creditor = default(OBWriteInternationalScheduledConsentResponse6DataInitiationCreditor), OBWriteInternationalScheduledConsentResponse6DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalScheduledConsentResponse6DataInitiationCreditorAgent), OBWriteInternationalScheduledConsentResponse6DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalScheduledConsentResponse6DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalScheduledConsentResponse6DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            if (InstructionIdentification != null)
            {
                ...
                if (InstructionIdentification.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "InstructionIdentification", 1);
                }
            }
            if (EndToEndIdentification != null)
            {
                ...
                if (EndToEndIdentification.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "EndToEndIdentification", 1);
                }
            }
            if (Purpose != null)
            {
                if (Purpose.Length > 4)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "Purpose", 4);
                }
                if (Purpose.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "Purpose", 1);
                }
            }
            if (ExtendedPurpose != null)
            {
                if (ExtendedPurpose.Length > 140)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "ExtendedPurpose", 140);
                }
                if (ExtendedPurpose.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "ExtendedPurpose", 1);
                }
            }
            if (CurrencyOfTransfer != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(CurrencyOfTransfer, "^[A-Z]{3,3}$"))
                {
                    throw new ValidationException(ValidationRules.Pattern, "CurrencyOfTransfer", "^[A-Z]{3,3}$");
                }
            }
            if (DestinationCountryCode != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(DestinationCountryCode, "[A-Z]{2,2}"))
                {
                    throw new ValidationException(ValidationRules.Pattern, "DestinationCountryCode", "[A-Z]{2,2}");
                }
            }
            if (InstructedAmount != null)
            {
