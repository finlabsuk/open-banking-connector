...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetInternationalPaymentConsentsConsentId operation.
    /// </summary>
    public partial class GetInternationalPaymentConsentsConsentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetInternationalPaymentConsentsConsentIdHeaders class.
        /// </summary>
        public GetInternationalPaymentConsentsConsentIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetInternationalPaymentConsentsConsentIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
