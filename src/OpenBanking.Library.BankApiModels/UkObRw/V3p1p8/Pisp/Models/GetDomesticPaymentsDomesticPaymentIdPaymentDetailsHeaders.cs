...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDomesticPaymentsDomesticPaymentIdPaymentDetails
    /// operation.
    /// </summary>
    public partial class GetDomesticPaymentsDomesticPaymentIdPaymentDetailsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetDomesticPaymentsDomesticPaymentIdPaymentDetailsHeaders class.
        /// </summary>
        public GetDomesticPaymentsDomesticPaymentIdPaymentDetailsHeaders()
        {
            CustomInit();
        }
        ...
        public GetDomesticPaymentsDomesticPaymentIdPaymentDetailsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
