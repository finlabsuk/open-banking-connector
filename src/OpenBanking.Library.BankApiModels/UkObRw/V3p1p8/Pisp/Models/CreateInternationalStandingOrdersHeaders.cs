...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateInternationalStandingOrders operation.
    /// </summary>
    public partial class CreateInternationalStandingOrdersHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateInternationalStandingOrdersHeaders class.
        /// </summary>
        public CreateInternationalStandingOrdersHeaders()
        {
            CustomInit();
        }
        ...
        public CreateInternationalStandingOrdersHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
