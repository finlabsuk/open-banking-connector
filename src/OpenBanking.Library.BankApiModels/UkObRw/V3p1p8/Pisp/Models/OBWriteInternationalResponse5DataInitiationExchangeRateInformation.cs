...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalResponse5DataInitiationExchangeRateInformation
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteInternationalResponse5DataInitiationExchangeRateInformation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalResponse5DataInitiationExchangeRateInformation(string unitCurrency, OBWriteInternationalResponse5DataInitiationExchangeRateInformationRateTypeEnum rateType, double? exchangeRate = default(double?), string contractIdentification = default(string))
        {
        ...
        public OBWriteInternationalResponse5DataInitiationExchangeRateInformationRateTypeEnum RateType { get; set; }
