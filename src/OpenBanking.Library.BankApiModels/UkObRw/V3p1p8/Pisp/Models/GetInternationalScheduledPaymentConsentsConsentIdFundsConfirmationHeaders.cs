...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// operation.
    /// </summary>
    public partial class GetInternationalScheduledPaymentConsentsConsentIdFundsConfirmationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetInternationalScheduledPaymentConsentsConsentIdFundsConfirmationHeaders
        /// class.
        /// </summary>
        public GetInternationalScheduledPaymentConsentsConsentIdFundsConfirmationHeaders()
        {
            CustomInit();
        }
        ...
        public GetInternationalScheduledPaymentConsentsConsentIdFundsConfirmationHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
