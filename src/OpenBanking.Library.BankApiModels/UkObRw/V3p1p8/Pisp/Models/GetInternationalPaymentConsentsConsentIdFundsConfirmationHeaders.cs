...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for
    /// GetInternationalPaymentConsentsConsentIdFundsConfirmation operation.
    /// </summary>
    public partial class GetInternationalPaymentConsentsConsentIdFundsConfirmationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetInternationalPaymentConsentsConsentIdFundsConfirmationHeaders
        /// class.
        /// </summary>
        public GetInternationalPaymentConsentsConsentIdFundsConfirmationHeaders()
        {
            CustomInit();
        }
        ...
        public GetInternationalPaymentConsentsConsentIdFundsConfirmationHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
