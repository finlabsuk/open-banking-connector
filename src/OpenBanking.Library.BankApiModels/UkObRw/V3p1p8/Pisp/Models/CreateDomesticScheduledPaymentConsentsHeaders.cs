...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateDomesticScheduledPaymentConsents operation.
    /// </summary>
    public partial class CreateDomesticScheduledPaymentConsentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateDomesticScheduledPaymentConsentsHeaders class.
        /// </summary>
        public CreateDomesticScheduledPaymentConsentsHeaders()
        {
            CustomInit();
        }
        ...
        public CreateDomesticScheduledPaymentConsentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
