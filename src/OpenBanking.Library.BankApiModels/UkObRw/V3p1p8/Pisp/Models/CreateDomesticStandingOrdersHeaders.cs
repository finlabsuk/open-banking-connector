...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateDomesticStandingOrders operation.
    /// </summary>
    public partial class CreateDomesticStandingOrdersHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateDomesticStandingOrdersHeaders class.
        /// </summary>
        public CreateDomesticStandingOrdersHeaders()
        {
            CustomInit();
        }
        ...
        public CreateDomesticStandingOrdersHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
