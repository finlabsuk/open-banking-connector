...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateDomesticPaymentConsents operation.
    /// </summary>
    public partial class CreateDomesticPaymentConsentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateDomesticPaymentConsentsHeaders class.
        /// </summary>
        public CreateDomesticPaymentConsentsHeaders()
        {
            CustomInit();
        }
        ...
        public CreateDomesticPaymentConsentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
