...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// operation.
    /// </summary>
    public partial class GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsHeaders
        /// class.
        /// </summary>
        public GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsHeaders()
        {
            CustomInit();
        }
        ...
        public GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
