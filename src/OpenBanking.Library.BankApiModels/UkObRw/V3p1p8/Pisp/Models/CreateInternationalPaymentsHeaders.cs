...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateInternationalPayments operation.
    /// </summary>
    public partial class CreateInternationalPaymentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateInternationalPaymentsHeaders class.
        /// </summary>
        public CreateInternationalPaymentsHeaders()
        {
            CustomInit();
        }
        ...
        public CreateInternationalPaymentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
