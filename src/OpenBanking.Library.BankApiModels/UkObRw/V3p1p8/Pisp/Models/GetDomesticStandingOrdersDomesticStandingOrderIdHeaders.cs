...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDomesticStandingOrdersDomesticStandingOrderId
    /// operation.
    /// </summary>
    public partial class GetDomesticStandingOrdersDomesticStandingOrderIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetDomesticStandingOrdersDomesticStandingOrderIdHeaders class.
        /// </summary>
        public GetDomesticStandingOrdersDomesticStandingOrderIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetDomesticStandingOrdersDomesticStandingOrderIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
