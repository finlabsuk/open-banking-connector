...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateFilePayments operation.
    /// </summary>
    public partial class CreateFilePaymentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateFilePaymentsHeaders class.
        /// </summary>
        public CreateFilePaymentsHeaders()
        {
            CustomInit();
        }
        ...
        public CreateFilePaymentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
