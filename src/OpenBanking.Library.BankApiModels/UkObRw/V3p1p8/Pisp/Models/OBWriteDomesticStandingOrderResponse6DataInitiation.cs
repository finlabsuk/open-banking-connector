...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderResponse6DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticStandingOrderResponse6DataInitiation class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrderResponse6DataInitiation(string frequency, System.DateTimeOffset firstPaymentDateTime, OBWriteDomesticStandingOrderResponse6DataInitiationFirstPaymentAmount firstPaymentAmount, OBWriteDomesticStandingOrderResponse6DataInitiationCreditorAccount creditorAccount, string reference = default(string), string numberOfPayments = default(string), System.DateTimeOffset? recurringPaymentDateTime = default(System.DateTimeOffset?), System.DateTimeOffset? finalPaymentDateTime = default(System.DateTimeOffset?), OBWriteDomesticStandingOrderResponse6DataInitiationRecurringPaymentAmount recurringPaymentAmount = default(OBWriteDomesticStandingOrderResponse6DataInitiationRecurringPaymentAmount), OBWriteDomesticStandingOrderResponse6DataInitiationFinalPaymentAmount finalPaymentAmount = default(OBWriteDomesticStandingOrderResponse6DataInitiationFinalPaymentAmount), OBWriteDomesticStandingOrderResponse6DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticStandingOrderResponse6DataInitiationDebtorAccount), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            Frequency = frequency;
            Reference = reference;
