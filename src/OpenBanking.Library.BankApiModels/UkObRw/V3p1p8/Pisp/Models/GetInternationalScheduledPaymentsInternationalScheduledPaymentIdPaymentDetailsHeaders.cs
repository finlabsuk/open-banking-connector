...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// operation.
    /// </summary>
    public partial class GetInternationalScheduledPaymentsInternationalScheduledPaymentIdPaymentDetailsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetInternationalScheduledPaymentsInternationalScheduledPaymentIdPaymentDetailsHeaders
        /// class.
        /// </summary>
        public GetInternationalScheduledPaymentsInternationalScheduledPaymentIdPaymentDetailsHeaders()
        {
            CustomInit();
        }
        ...
        public GetInternationalScheduledPaymentsInternationalScheduledPaymentIdPaymentDetailsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
