...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for
    /// GetDomesticPaymentConsentsConsentIdFundsConfirmation operation.
    /// </summary>
    public partial class GetDomesticPaymentConsentsConsentIdFundsConfirmationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetDomesticPaymentConsentsConsentIdFundsConfirmationHeaders class.
        /// </summary>
        public GetDomesticPaymentConsentsConsentIdFundsConfirmationHeaders()
        {
            CustomInit();
        }
        ...
        public GetDomesticPaymentConsentsConsentIdFundsConfirmationHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
