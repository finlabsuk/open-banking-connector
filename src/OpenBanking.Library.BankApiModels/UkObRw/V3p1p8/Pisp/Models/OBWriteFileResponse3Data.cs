...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    public partial class OBWriteFileResponse3Data
    {
        ...
        public virtual void Validate()
        {
            ...
            if (FilePaymentId != null)
            {
                if (FilePaymentId.Length > 40)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "FilePaymentId", 40);
                }
                if (FilePaymentId.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "FilePaymentId", 1);
                }
            }
            if (ConsentId != null)
            {
