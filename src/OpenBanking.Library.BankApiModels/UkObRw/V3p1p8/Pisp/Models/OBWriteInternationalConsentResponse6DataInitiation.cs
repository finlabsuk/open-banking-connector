...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsentResponse6DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalConsentResponse6DataInitiation class.
        /// </summary>
        public OBWriteInternationalConsentResponse6DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalConsentResponse6DataInitiation(string instructionIdentification, string endToEndIdentification, string currencyOfTransfer, OBWriteInternationalConsentResponse6DataInitiationInstructedAmount instructedAmount, OBWriteInternationalConsentResponse6DataInitiationCreditorAccount creditorAccount, string localInstrument = default(string), OBWriteInternationalConsentResponse6DataInitiationInstructionPriorityEnum? instructionPriority = default(OBWriteInternationalConsentResponse6DataInitiationInstructionPriorityEnum?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalConsentResponse6DataInitiationExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalConsentResponse6DataInitiationExchangeRateInformation), OBWriteInternationalConsentResponse6DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalConsentResponse6DataInitiationDebtorAccount), OBWriteInternationalConsentResponse6DataInitiationCreditor creditor = default(OBWriteInternationalConsentResponse6DataInitiationCreditor), OBWriteInternationalConsentResponse6DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalConsentResponse6DataInitiationCreditorAgent), OBWriteInternationalConsentResponse6DataInitiationRemittanceInformation remittanceInformation = default(OBWriteInternationalConsentResponse6DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
        ...
        public OBWriteInternationalConsentResponse6DataInitiationInstructionPriorityEnum? InstructionPriority { get; set; }
