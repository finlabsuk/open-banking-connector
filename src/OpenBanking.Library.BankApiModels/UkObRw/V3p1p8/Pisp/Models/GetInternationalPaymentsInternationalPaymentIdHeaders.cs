...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetInternationalPaymentsInternationalPaymentId
    /// operation.
    /// </summary>
    public partial class GetInternationalPaymentsInternationalPaymentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetInternationalPaymentsInternationalPaymentIdHeaders class.
        /// </summary>
        public GetInternationalPaymentsInternationalPaymentIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetInternationalPaymentsInternationalPaymentIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
