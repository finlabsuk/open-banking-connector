    ...
    public partial class OBWritePaymentDetailsResponse1DataPaymentStatusItemStatusDetail
    {
        ...
        public virtual void Validate()
        {
            ...
            if (Status != null)
            {
                ...
                if (Status.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "Status", 1);
                }
            }
            if (StatusReasonDescription != null)
            {
                if (StatusReasonDescription.Length > 256)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "StatusReasonDescription", 256);
                }
                if (StatusReasonDescription.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "StatusReasonDescription", 1);
                }
            }
        }
    }
