...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    public partial class OBWriteInternationalConsent5Data
    {
        ...
        /// TPP.</param>
        public OBWriteInternationalConsent5Data(OBWriteInternationalConsent5DataInitiation initiation, OBWriteInternationalConsent5DataReadRefundAccountEnum? readRefundAccount = default(OBWriteInternationalConsent5DataReadRefundAccountEnum?), OBWriteInternationalConsent5DataAuthorisation authorisation = default(OBWriteInternationalConsent5DataAuthorisation), OBSCASupportData1 sCASupportData = default(OBSCASupportData1))
        {
