...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticScheduledConsent4DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledConsent4DataInitiation class.
        /// </summary>
        ...
        public OBWriteDomesticScheduledConsent4DataInitiation(string instructionIdentification, System.DateTimeOffset requestedExecutionDateTime, OBWriteDomesticScheduledConsent4DataInitiationInstructedAmount instructedAmount, OBWriteDomesticScheduledConsent4DataInitiationCreditorAccount creditorAccount, string endToEndIdentification = default(string), string localInstrument = default(string), OBWriteDomesticScheduledConsent4DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticScheduledConsent4DataInitiationDebtorAccount), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6), OBWriteDomesticScheduledConsent4DataInitiationRemittanceInformation remittanceInformation = default(OBWriteDomesticScheduledConsent4DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
