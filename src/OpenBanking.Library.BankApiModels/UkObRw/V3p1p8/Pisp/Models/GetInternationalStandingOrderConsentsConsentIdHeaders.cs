...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetInternationalStandingOrderConsentsConsentId
    /// operation.
    /// </summary>
    public partial class GetInternationalStandingOrderConsentsConsentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetInternationalStandingOrderConsentsConsentIdHeaders class.
        /// </summary>
        public GetInternationalStandingOrderConsentsConsentIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetInternationalStandingOrderConsentsConsentIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
