...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsentResponse6DataInitiationExchangeRateInformation
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteInternationalConsentResponse6DataInitiationExchangeRateInformation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalConsentResponse6DataInitiationExchangeRateInformation(string unitCurrency, OBWriteInternationalConsentResponse6DataInitiationExchangeRateInformationRateTypeEnum rateType, double? exchangeRate = default(double?), string contractIdentification = default(string))
        {
        ...
        public OBWriteInternationalConsentResponse6DataInitiationExchangeRateInformationRateTypeEnum RateType { get; set; }
