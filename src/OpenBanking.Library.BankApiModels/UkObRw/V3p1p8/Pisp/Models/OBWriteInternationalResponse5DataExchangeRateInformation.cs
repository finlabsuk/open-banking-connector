...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalResponse5DataExchangeRateInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalResponse5DataExchangeRateInformation class.
        /// </summary>
        public OBWriteInternationalResponse5DataExchangeRateInformation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalResponse5DataExchangeRateInformation(string unitCurrency, double exchangeRate, OBWriteInternationalResponse5DataExchangeRateInformationRateTypeEnum rateType, string contractIdentification = default(string), System.DateTimeOffset? expirationDateTime = default(System.DateTimeOffset?))
        {
        ...
        public OBWriteInternationalResponse5DataExchangeRateInformationRateTypeEnum RateType { get; set; }
