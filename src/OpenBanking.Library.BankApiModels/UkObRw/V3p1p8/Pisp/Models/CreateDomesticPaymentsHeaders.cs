...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateDomesticPayments operation.
    /// </summary>
    public partial class CreateDomesticPaymentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateDomesticPaymentsHeaders
        /// class.
        /// </summary>
        public CreateDomesticPaymentsHeaders()
        {
            CustomInit();
        }
        ...
        public CreateDomesticPaymentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
