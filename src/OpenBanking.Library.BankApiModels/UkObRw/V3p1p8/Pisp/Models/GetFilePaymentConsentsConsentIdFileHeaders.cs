...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetFilePaymentConsentsConsentIdFile operation.
    /// </summary>
    public partial class GetFilePaymentConsentsConsentIdFileHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetFilePaymentConsentsConsentIdFileHeaders class.
        /// </summary>
        public GetFilePaymentConsentsConsentIdFileHeaders()
        {
            CustomInit();
        }
        ...
        public GetFilePaymentConsentsConsentIdFileHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
