...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsent5DataInitiationExchangeRateInformation
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteInternationalConsent5DataInitiationExchangeRateInformation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalConsent5DataInitiationExchangeRateInformation(string unitCurrency, OBWriteInternationalConsent5DataInitiationExchangeRateInformationRateTypeEnum rateType, double? exchangeRate = default(double?), string contractIdentification = default(string))
        {
        ...
        public OBWriteInternationalConsent5DataInitiationExchangeRateInformationRateTypeEnum RateType { get; set; }
