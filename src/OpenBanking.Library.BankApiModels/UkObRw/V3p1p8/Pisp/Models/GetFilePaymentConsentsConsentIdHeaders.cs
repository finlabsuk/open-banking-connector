...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetFilePaymentConsentsConsentId operation.
    /// </summary>
    public partial class GetFilePaymentConsentsConsentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetFilePaymentConsentsConsentIdHeaders class.
        /// </summary>
        public GetFilePaymentConsentsConsentIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetFilePaymentConsentsConsentIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
