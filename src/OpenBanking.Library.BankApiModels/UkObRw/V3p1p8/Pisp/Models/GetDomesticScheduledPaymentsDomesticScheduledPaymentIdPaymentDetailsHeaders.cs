...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// operation.
    /// </summary>
    public partial class GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsHeaders
        /// class.
        /// </summary>
        public GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsHeaders()
        {
            CustomInit();
        }
        ...
        public GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
