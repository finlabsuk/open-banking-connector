...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetInternationalScheduledPaymentConsentsConsentId
    /// operation.
    /// </summary>
    public partial class GetInternationalScheduledPaymentConsentsConsentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetInternationalScheduledPaymentConsentsConsentIdHeaders class.
        /// </summary>
        public GetInternationalScheduledPaymentConsentsConsentIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetInternationalScheduledPaymentConsentsConsentIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
