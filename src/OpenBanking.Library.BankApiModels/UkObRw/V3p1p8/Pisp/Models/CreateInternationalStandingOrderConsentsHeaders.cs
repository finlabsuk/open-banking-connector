...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateInternationalStandingOrderConsents operation.
    /// </summary>
    public partial class CreateInternationalStandingOrderConsentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateInternationalStandingOrderConsentsHeaders class.
        /// </summary>
        public CreateInternationalStandingOrderConsentsHeaders()
        {
            CustomInit();
        }
        ...
        public CreateInternationalStandingOrderConsentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
