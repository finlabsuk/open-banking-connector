...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateInternationalPaymentConsents operation.
    /// </summary>
    public partial class CreateInternationalPaymentConsentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateInternationalPaymentConsentsHeaders class.
        /// </summary>
        public CreateInternationalPaymentConsentsHeaders()
        {
            CustomInit();
        }
        ...
        public CreateInternationalPaymentConsentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
