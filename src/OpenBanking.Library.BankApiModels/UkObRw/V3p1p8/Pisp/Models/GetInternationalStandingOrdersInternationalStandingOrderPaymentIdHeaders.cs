...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// operation.
    /// </summary>
    public partial class GetInternationalStandingOrdersInternationalStandingOrderPaymentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetInternationalStandingOrdersInternationalStandingOrderPaymentIdHeaders
        /// class.
        /// </summary>
        public GetInternationalStandingOrdersInternationalStandingOrderPaymentIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetInternationalStandingOrdersInternationalStandingOrderPaymentIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
