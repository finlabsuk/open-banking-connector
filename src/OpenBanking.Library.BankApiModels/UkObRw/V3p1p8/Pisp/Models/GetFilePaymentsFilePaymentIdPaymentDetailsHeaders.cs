...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetFilePaymentsFilePaymentIdPaymentDetails
    /// operation.
    /// </summary>
    public partial class GetFilePaymentsFilePaymentIdPaymentDetailsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetFilePaymentsFilePaymentIdPaymentDetailsHeaders class.
        /// </summary>
        public GetFilePaymentsFilePaymentIdPaymentDetailsHeaders()
        {
            CustomInit();
        }
        ...
        public GetFilePaymentsFilePaymentIdPaymentDetailsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
