...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrderConsent6DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalStandingOrderConsent6DataInitiation class.
        /// </summary>
        ...
        public OBWriteInternationalStandingOrderConsent6DataInitiation(string frequency, System.DateTimeOffset firstPaymentDateTime, string currencyOfTransfer, OBWriteInternationalStandingOrderConsent6DataInitiationInstructedAmount instructedAmount, OBWriteInternationalStandingOrderConsent6DataInitiationCreditorAccount creditorAccount, string reference = default(string), string numberOfPayments = default(string), System.DateTimeOffset? finalPaymentDateTime = default(System.DateTimeOffset?), string purpose = default(string), string extendedPurpose = default(string), OBChargeBearerType1CodeEnum? chargeBearer = default(OBChargeBearerType1CodeEnum?), string destinationCountryCode = default(string), OBWriteInternationalStandingOrderConsent6DataInitiationDebtorAccount debtorAccount = default(OBWriteInternationalStandingOrderConsent6DataInitiationDebtorAccount), OBWriteInternationalStandingOrderConsent6DataInitiationCreditor creditor = default(OBWriteInternationalStandingOrderConsent6DataInitiationCreditor), OBWriteInternationalStandingOrderConsent6DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalStandingOrderConsent6DataInitiationCreditorAgent), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
            Frequency = frequency;
            Reference = reference;
        ...
        public virtual void Validate()
        {
            ...
            if (Frequency != null)
            {
                if (!System.Text.RegularExpressions.Regex.IsMatch(Frequency, "^(EvryDay)$|^(EvryWorkgDay)$|^(IntrvlDay:((0[2-9])|([1-2][0-9])|3[0-1]))$|^(IntrvlWkDay:0[1-9]:0[1-7])$|^(WkInMnthDay:0[1-5]:0[1-7])$|^(IntrvlMnthDay:(0[1-6]|12|24):(-0[1-5]|0[1-9]|[12][0-9]|3[01]))$|^(QtrDay:(ENGLISH|SCOTTISH|RECEIVED))$"))
                {
                    throw new ValidationException(ValidationRules.Pattern, "Frequency", "^(EvryDay)$|^(EvryWorkgDay)$|^(IntrvlDay:((0[2-9])|([1-2][0-9])|3[0-1]))$|^(IntrvlWkDay:0[1-9]:0[1-7])$|^(WkInMnthDay:0[1-5]:0[1-7])$|^(IntrvlMnthDay:(0[1-6]|12|24):(-0[1-5]|0[1-9]|[12][0-9]|3[01]))$|^(QtrDay:(ENGLISH|SCOTTISH|RECEIVED))$");
                }
            }
            if (Reference != null)
            {
            ...
            {
                if (NumberOfPayments.Length > 35)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "NumberOfPayments", 35);
                }
                if (NumberOfPayments.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "NumberOfPayments", 1);
                }
            }
            if (Purpose != null)
            {
