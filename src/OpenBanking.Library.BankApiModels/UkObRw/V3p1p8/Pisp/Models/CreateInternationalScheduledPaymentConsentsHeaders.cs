...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateInternationalScheduledPaymentConsents
    /// operation.
    /// </summary>
    public partial class CreateInternationalScheduledPaymentConsentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CreateInternationalScheduledPaymentConsentsHeaders class.
        /// </summary>
        public CreateInternationalScheduledPaymentConsentsHeaders()
        {
            CustomInit();
        }
        ...
        public CreateInternationalScheduledPaymentConsentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
