...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for CreateFilePaymentConsents operation.
    /// </summary>
    public partial class CreateFilePaymentConsentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the CreateFilePaymentConsentsHeaders
        /// class.
        /// </summary>
        public CreateFilePaymentConsentsHeaders()
        {
            CustomInit();
        }
        ...
        public CreateFilePaymentConsentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
