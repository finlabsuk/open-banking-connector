...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    /// <summary>
    /// Defines headers for GetDomesticPaymentsDomesticPaymentId operation.
    /// </summary>
    public partial class GetDomesticPaymentsDomesticPaymentIdHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetDomesticPaymentsDomesticPaymentIdHeaders class.
        /// </summary>
        public GetDomesticPaymentsDomesticPaymentIdHeaders()
        {
            CustomInit();
        }
        ...
        public GetDomesticPaymentsDomesticPaymentIdHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
