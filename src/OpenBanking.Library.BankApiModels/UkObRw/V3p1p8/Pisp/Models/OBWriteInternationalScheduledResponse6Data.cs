...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    public partial class OBWriteInternationalScheduledResponse6Data
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduledResponse6Data class.
        /// </summary>
        ...
        public OBWriteInternationalScheduledResponse6Data(string internationalScheduledPaymentId, string consentId, System.DateTimeOffset creationDateTime, OBWriteInternationalScheduledResponse6DataStatusEnum status, System.DateTimeOffset statusUpdateDateTime, OBWriteInternationalScheduledResponse6DataInitiation initiation, System.DateTimeOffset? expectedExecutionDateTime = default(System.DateTimeOffset?), System.DateTimeOffset? expectedSettlementDateTime = default(System.DateTimeOffset?), OBWriteInternationalScheduledResponse6DataRefund refund = default(OBWriteInternationalScheduledResponse6DataRefund), IList<OBWriteInternationalScheduledResponse6DataChargesItem> charges = default(IList<OBWriteInternationalScheduledResponse6DataChargesItem>), OBWriteInternationalScheduledResponse6DataExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalScheduledResponse6DataExchangeRateInformation), OBWriteInternationalScheduledResponse6DataMultiAuthorisation multiAuthorisation = default(OBWriteInternationalScheduledResponse6DataMultiAuthorisation), OBCashAccountDebtor4 debtor = default(OBCashAccountDebtor4))
        {
        ...
        public OBWriteInternationalScheduledResponse6DataStatusEnum Status { get; set; }
        ...
        public IList<OBWriteInternationalScheduledResponse6DataChargesItem> Charges { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            if (InternationalScheduledPaymentId != null)
            {
                if (InternationalScheduledPaymentId.Length > 40)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "InternationalScheduledPaymentId", 40);
                }
                if (InternationalScheduledPaymentId.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "InternationalScheduledPaymentId", 1);
                }
            }
            if (ConsentId != null)
            {
