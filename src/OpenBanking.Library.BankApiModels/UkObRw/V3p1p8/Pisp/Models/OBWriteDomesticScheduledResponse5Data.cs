...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    public partial class OBWriteDomesticScheduledResponse5Data
    {
        ...
        public virtual void Validate()
        {
            ...
            if (DomesticScheduledPaymentId != null)
            {
                if (DomesticScheduledPaymentId.Length > 40)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "DomesticScheduledPaymentId", 40);
                }
                if (DomesticScheduledPaymentId.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "DomesticScheduledPaymentId", 1);
                }
            }
            if (ConsentId != null)
            {
