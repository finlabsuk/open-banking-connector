...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Pisp.Models
{
    ...
    public partial class OBWriteInternationalResponse5Data
    {
        /// <summary>
        /// Initializes a new instance of the OBWriteInternationalResponse5Data
        /// class.
        /// </summary>
        ...
        public OBWriteInternationalResponse5Data(string internationalPaymentId, string consentId, System.DateTimeOffset creationDateTime, OBWriteInternationalResponse5DataStatusEnum status, System.DateTimeOffset statusUpdateDateTime, OBWriteInternationalResponse5DataInitiation initiation, System.DateTimeOffset? expectedExecutionDateTime = default(System.DateTimeOffset?), System.DateTimeOffset? expectedSettlementDateTime = default(System.DateTimeOffset?), OBWriteInternationalResponse5DataRefund refund = default(OBWriteInternationalResponse5DataRefund), IList<OBWriteInternationalResponse5DataChargesItem> charges = default(IList<OBWriteInternationalResponse5DataChargesItem>), OBWriteInternationalResponse5DataExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalResponse5DataExchangeRateInformation), OBWriteInternationalResponse5DataMultiAuthorisation multiAuthorisation = default(OBWriteInternationalResponse5DataMultiAuthorisation), OBCashAccountDebtor4 debtor = default(OBCashAccountDebtor4))
        {
        ...
        public OBWriteInternationalResponse5DataStatusEnum Status { get; set; }
        ...
        public IList<OBWriteInternationalResponse5DataChargesItem> Charges { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            if (InternationalPaymentId != null)
            {
                if (InternationalPaymentId.Length > 40)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "InternationalPaymentId", 40);
                }
                if (InternationalPaymentId.Length < 1)
                {
                    throw new ValidationException(ValidationRules.MinLength, "InternationalPaymentId", 1);
                }
            }
            if (ConsentId != null)
            {
