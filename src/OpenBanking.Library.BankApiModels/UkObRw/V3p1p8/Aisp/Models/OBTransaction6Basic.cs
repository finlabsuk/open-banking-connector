...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Aisp.Models
{
    ...
    internal partial class OBTransaction6Basic
    {
        /// <summary> Initializes a new instance of OBTransaction6Basic. </summary>
        ...
        internal OBTransaction6Basic(string accountId, OBCreditDebitCode1Enum creditDebitIndicator, OBEntryStatus1CodeEnum status, DateTimeOffset bookingDateTime, OBActiveOrHistoricCurrencyAndAmount9 amount)
        {
            if (accountId == null)
            {
