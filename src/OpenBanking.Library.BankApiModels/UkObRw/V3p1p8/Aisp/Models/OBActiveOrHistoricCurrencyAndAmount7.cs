...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Aisp.Models
{
    ...
    {
        /// <summary> Initializes a new instance of OBActiveOrHistoricCurrencyAndAmount7. </summary>
        ...
        internal OBActiveOrHistoricCurrencyAndAmount7(string amount, string currency)
        {
            if (amount == null)
            {
