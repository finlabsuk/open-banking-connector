...
namespace AccountAndTransactionAPISpecification.Models
{
    ...
    {
        /// <summary> Initializes a new instance of OBActiveOrHistoricCurrencyAndAmount3. </summary>
        ...
        internal OBActiveOrHistoricCurrencyAndAmount3(string amount, string currency)
        {
            if (amount == null)
            {
