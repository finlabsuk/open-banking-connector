...
{
    /// <summary> The OBOtherCodeType10. </summary>
    internal partial class OBOtherCodeType10
    {
        /// <summary> Initializes a new instance of OBOtherCodeType10. </summary>
        ...
        internal OBOtherCodeType10(string name, string description)
        {
            if (name == null)
            {
