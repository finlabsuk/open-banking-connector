...
{
    public class
        OBDomesticVRPConsentResponseValidator : AbstractValidator<
            OBDomesticVRPConsentResponse>
    {
        public OBDomesticVRPConsentResponseValidator()
        {
        ...
        private void CreateRules()
        {
            RuleFor(x => x)
                ...
                .Must(
                    ...
                    $"Invalid value for (nested) member of {typeof(OBDomesticVRPConsentResponse).FullName}: " +
                    "{ExceptionMessage}");
        }
    }
}
