...
{
    public class
        OBDomesticVRPConsentRequestValidator : AbstractValidator<OBDomesticVRPConsentRequest>
    {
        public OBDomesticVRPConsentRequestValidator()
        {
        ...
        private void CreateRules()
        {
            RuleFor(x => x)
                ...
                .Must(
                    ...
                    $"Invalid value for (nested) member of {typeof(OBDomesticVRPConsentRequest).FullName}: " +
                    "{ExceptionMessage}");
        }
    }
}
