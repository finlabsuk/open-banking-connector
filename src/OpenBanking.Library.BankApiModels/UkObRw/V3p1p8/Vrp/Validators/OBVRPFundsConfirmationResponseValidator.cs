...
{
    public class
        OBVRPFundsConfirmationResponseValidator : AbstractValidator<
            OBVRPFundsConfirmationResponse>
    {
        public OBVRPFundsConfirmationResponseValidator()
        {
        ...
        private void CreateRules()
        {
            RuleFor(x => x)
                ...
                .Must(
                    ...
                    $"Invalid value for (nested) member of {typeof(OBVRPFundsConfirmationResponse).FullName}: " +
                    "{ExceptionMessage}");
