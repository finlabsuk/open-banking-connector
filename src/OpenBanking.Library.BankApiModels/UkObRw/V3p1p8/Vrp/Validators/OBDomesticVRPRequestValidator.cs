...
{
    public class
        OBDomesticVRPRequestValidator : AbstractValidator<OBDomesticVRPRequest>
    {
        public OBDomesticVRPRequestValidator()
        {
        ...
        private void CreateRules()
        {
            RuleFor(x => x)
                ...
                .Must(
                    ...
                    $"Invalid value for (nested) member of {typeof(OBDomesticVRPRequest).FullName}: " +
                    "{ExceptionMessage}");
        }
    }
}
