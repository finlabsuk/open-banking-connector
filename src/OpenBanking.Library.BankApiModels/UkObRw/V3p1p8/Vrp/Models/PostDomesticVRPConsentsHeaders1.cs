...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Vrp.Models
{
    ...
    /// <summary>
    /// Defines headers for post  Domestic VRP Consents operation.
    /// </summary>
    public partial class PostDomesticVRPConsentsHeaders1
    {
        /// <summary>
        /// Initializes a new instance of the PostDomesticVRPConsentsHeaders1
        /// class.
        /// </summary>
        public PostDomesticVRPConsentsHeaders1()
        {
            CustomInit();
        }
        ...
        public PostDomesticVRPConsentsHeaders1(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
