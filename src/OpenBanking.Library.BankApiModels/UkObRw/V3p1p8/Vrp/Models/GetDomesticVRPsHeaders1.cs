...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Vrp.Models
{
    ...
    /// <summary>
    /// Defines headers for get  Domestic VRPs operation.
    /// </summary>
    public partial class GetDomesticVRPsHeaders1
    {
        /// <summary>
        /// Initializes a new instance of the GetDomesticVRPsHeaders1 class.
        /// </summary>
        public GetDomesticVRPsHeaders1()
        {
            CustomInit();
        }
        ...
        public GetDomesticVRPsHeaders1(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
