...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Vrp.Models
{
    ...
    /// <summary>
    /// Defines headers for post  Domestic VRPs operation.
    /// </summary>
    public partial class PostDomesticVRPsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PostDomesticVRPsHeaders class.
        /// </summary>
        public PostDomesticVRPsHeaders()
        {
            CustomInit();
        }
        ...
        public PostDomesticVRPsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
