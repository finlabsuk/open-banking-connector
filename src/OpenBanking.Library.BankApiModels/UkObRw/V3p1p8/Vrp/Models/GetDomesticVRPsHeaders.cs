...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Vrp.Models
{
    ...
    /// </summary>
    public partial class GetDomesticVRPsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDomesticVRPsHeaders class.
        /// </summary>
        public GetDomesticVRPsHeaders()
        {
            CustomInit();
        }
        ...
        public GetDomesticVRPsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
