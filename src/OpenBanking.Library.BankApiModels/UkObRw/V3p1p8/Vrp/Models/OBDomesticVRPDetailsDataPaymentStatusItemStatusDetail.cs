...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Vrp.Models
{
    ...
    public partial class OBDomesticVRPDetailsDataPaymentStatusItemStatusDetail
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBDomesticVRPDetailsDataPaymentStatusItemStatusDetail class.
        /// </summary>
        public OBDomesticVRPDetailsDataPaymentStatusItemStatusDetail()
        {
            CustomInit();
        }
        ...
        public OBDomesticVRPDetailsDataPaymentStatusItemStatusDetail(string status, string localInstrument = default(string), OBDomesticVRPDetailsDataPaymentStatusItemStatusDetailStatusReasonEnum? statusReason = default(OBDomesticVRPDetailsDataPaymentStatusItemStatusDetailStatusReasonEnum?), string statusReasonDescription = default(string))
        {
        ...
        public OBDomesticVRPDetailsDataPaymentStatusItemStatusDetailStatusReasonEnum? StatusReason { get; set; }
        ...
        public virtual void Validate()
        {
            ...
            if (Status != null)
            {
                ...
                {
                    throw new ValidationException(ValidationRules.MaxLength, "Status", 128);
                }
            }
            if (StatusReasonDescription != null)
            {
                if (StatusReasonDescription.Length > 128)
                {
                    throw new ValidationException(ValidationRules.MaxLength, "StatusReasonDescription", 128);
                }
            }
        }
    }
