...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Vrp.Models
{
    ...
    /// </summary>
    public partial class PostDomesticVRPConsentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PostDomesticVRPConsentsHeaders
        /// class.
        /// </summary>
        public PostDomesticVRPConsentsHeaders()
        {
            CustomInit();
        }
        ...
        public PostDomesticVRPConsentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
