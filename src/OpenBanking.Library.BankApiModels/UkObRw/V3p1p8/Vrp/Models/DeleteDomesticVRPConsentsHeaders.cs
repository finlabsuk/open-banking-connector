...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Vrp.Models
{
    ...
    /// <summary>
    /// Defines headers for delete  Domestic VRP Consents operation.
    /// </summary>
    public partial class DeleteDomesticVRPConsentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteDomesticVRPConsentsHeaders
        /// class.
        /// </summary>
        public DeleteDomesticVRPConsentsHeaders()
        {
            CustomInit();
        }
        ...
        /// signature of the body of the payload.</param>
        /// <param name="retryAfter">Number in seconds to wait</param>
        public DeleteDomesticVRPConsentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
