...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p8.Vrp.Models
{
    ...
    /// <summary>
    /// Defines headers for get  Domestic VRP Consents operation.
    /// </summary>
    public partial class GetDomesticVRPConsentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDomesticVRPConsentsHeaders
        /// class.
        /// </summary>
        public GetDomesticVRPConsentsHeaders()
        {
            CustomInit();
        }
        ...
        public GetDomesticVRPConsentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
