...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V4p0p1.NSwagVrp.Models
{
    ...
    /// <summary>
    /// Specifies the status of consent resource in code form. Only AWAU and RJCT can be returned on initial submission. For a full list of values see `OBInternalConsentStatus1Code` in *OB_Internal_CodeSet* [here](https://github.com/OpenBankingUK/External_Internal_CodeSets)
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    public partial record OBDomesticVRPControlParameters
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.MinLength(1)]
        public required System.Collections.Generic.IList<OBDomesticVRPPeriodicLimits> PeriodicLimits { get; set; }

        /// <summary>
        /// ^ The types of payments that can be made under this VRP consent. This can be used to indicate whether this includes sweeping payments or other ecommerce payments.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("VRPType", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.MinLength(1)]
        public required System.Collections.Generic.IList<string> VRPType { get; set; }
        ...
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.MinLength(1)]
        public required System.Collections.Generic.IList<string> PSUAuthenticationMethods { get; set; }
        ...
        public System.Collections.Generic.IList<OBVRPInteractionTypes>? PSUInteractionTypes { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum OBPeriodAlignment1Code
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial record OBDomesticVRPPeriodicLimits
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public required OBPeriodType1Code PeriodType { get; set; }
        ...
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public required OBPeriodAlignment1Code PeriodAlignment { get; set; }
    ...
    /// <summary>
    /// Specifies the amount type, as published in an external referred amount code set. For a full list of values refer to `ExternalCreditorReferenceType1Code` in *ISO_External_CodeSet* [here](https://github.com/OpenBankingUK/External_Internal_CodeSets)
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    public partial record OBRisk1
    {
        ...
        /// <summary>
        /// Specifies the payment context, for a full list of values refer to `OBInternalPaymentContext1Code` in *OB_Internal_CodeSet* [here](https://github.com/OpenBankingUK/External_Internal_CodeSets)&lt;br&gt;
        /// <br/>The following values are deprecated and can only be used to make a payment on an existing v3 consent which used one of the deprecated values and has been migrated to v4. They &lt;u&gt;**must not**&lt;/u&gt; be used in a new consent. They may optionally be returned for a historical payment/consent migrated to v4:&lt;br&gt;
    ...
    /// <br/>
    /// <br/>For a full list of values refer to `ExternalPaymentTransactionStatus5Code` in *OB_Internal_CodeSet* 
    /// <br/>[here](https://github.com/OpenBankingUK/External_Internal_CodeSets).
    /// <br/>
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum ExternalPaymentTransactionStatus5Code
    {
    ...
    public partial record Data5
    {
        ...
        public System.Collections.Generic.IList<PaymentStatus>? PaymentStatus { get; set; }
