...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p10.Aisp.Models
{
    ...
    public partial class OBStatement2DetailStatementFeeItem
    {
        ...
        public OBStatement2DetailStatementFeeItem(OBCreditDebitCode0Enum creditDebitIndicator, string type, OBActiveOrHistoricCurrencyAndAmount6 amount)
        {
            if (type == null)
            {
