...
{
    public class
        OBWriteFundsConfirmationResponse1Validator : AbstractValidator<
            OBWriteFundsConfirmationResponse1>
    {
        public OBWriteFundsConfirmationResponse1Validator()
        {
        ...
        private void CreateRules()
        {
            RuleFor(x => x)
                ...
                .Must(
                    ...
                    $"Invalid value for (nested) member of {typeof(OBWriteFundsConfirmationResponse1).FullName}: " +
                    "{ExceptionMessage}");
