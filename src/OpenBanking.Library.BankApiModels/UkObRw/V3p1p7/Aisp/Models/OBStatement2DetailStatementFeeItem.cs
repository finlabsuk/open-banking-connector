...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p7.Aisp.Models
{
    ...
    internal partial class OBStatement2DetailStatementFeeItem
    {
        /// <summary> Initializes a new instance of OBStatement2DetailStatementFeeItem. </summary>
        ...
        internal OBStatement2DetailStatementFeeItem(OBCreditDebitCode0Enum creditDebitIndicator, string type, OBActiveOrHistoricCurrencyAndAmount6 amount)
        {
            if (type == null)
            {
