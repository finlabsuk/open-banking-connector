...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p7.Aisp.Models
{
    ...
    public partial class OBAccount6
    {
        ...
        [JsonConstructor] public OBAccount6(string accountId, OBAccountStatus1CodeEnum? status, DateTimeOffset? statusUpdateDateTime, string currency, OBExternalAccountType1CodeEnum? accountType, OBExternalAccountSubType1CodeEnum? accountSubType, string description, string nickname, DateTimeOffset? openingDate, DateTimeOffset? maturityDate, string switchStatus, IReadOnlyList<OBAccount6AccountItem> account, OBBranchAndFinancialInstitutionIdentification50 servicer)
        {
            AccountId = accountId;
            Status = status;
