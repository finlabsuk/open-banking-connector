...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p7.Aisp.Models
{
    ...
    public partial class OBReadBalance1DataBalanceItem
    {
        ...
        [JsonConstructor] public OBReadBalance1DataBalanceItem(string accountId, OBCreditDebitCode2Enum creditDebitIndicator, OBBalanceType1CodeEnum type, DateTimeOffset dateTime, OBReadBalance1DataBalanceItemAmount amount, IReadOnlyList<OBReadBalance1DataBalancePropertiesItemsItem> creditLine)
        {
            AccountId = accountId;
            CreditDebitIndicator = creditDebitIndicator;
            Type = type;
