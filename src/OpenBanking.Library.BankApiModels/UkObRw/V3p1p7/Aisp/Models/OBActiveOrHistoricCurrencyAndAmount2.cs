...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p7.Aisp.Models
{
    ...
    {
        /// <summary> Initializes a new instance of OBActiveOrHistoricCurrencyAndAmount2. </summary>
        ...
        internal OBActiveOrHistoricCurrencyAndAmount2(string amount, string currency)
        {
            if (amount == null)
            {
