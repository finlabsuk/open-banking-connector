...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p7.Aisp.Models
{
    ...
    public partial class OBCurrencyExchange5
    {
        ...
        [JsonConstructor] public OBCurrencyExchange5(string sourceCurrency, string targetCurrency, string unitCurrency, float exchangeRate, string contractIdentification, DateTimeOffset? quotationDate, OBCurrencyExchange5InstructedAmount instructedAmount)
        {
            SourceCurrency = sourceCurrency;
