...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p7.Aisp.Models
{
    ...
    internal partial class OBAccount4Basic
    {
        /// <summary> Initializes a new instance of OBAccount4Basic. </summary>
        ...
        internal OBAccount4Basic(string accountId, string currency, OBExternalAccountType1CodeEnum accountType, OBExternalAccountSubType1CodeEnum accountSubType)
        {
            if (accountId == null)
            {
