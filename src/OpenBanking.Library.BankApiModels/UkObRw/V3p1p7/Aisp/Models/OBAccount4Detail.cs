...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p7.Aisp.Models
{
    ...
    internal partial class OBAccount4Detail
    {
        /// <summary> Initializes a new instance of OBAccount4Detail. </summary>
        ...
        internal OBAccount4Detail(string accountId, string currency, OBExternalAccountType1CodeEnum accountType, OBExternalAccountSubType1CodeEnum accountSubType, IEnumerable<OBAccount4DetailAccountItem> account)
        {
            if (accountId == null)
            {
        ...
        public IReadOnlyList<OBAccount4DetailAccountItem> Account { get; }
