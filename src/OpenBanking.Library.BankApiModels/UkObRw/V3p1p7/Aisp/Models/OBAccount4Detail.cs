...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p7.Aisp.Models
{
    ...
    public partial class OBAccount4Detail
    {
        ...
        public OBAccount4Detail(string accountId, string currency, OBExternalAccountType1CodeEnum accountType, OBExternalAccountSubType1CodeEnum accountSubType, IEnumerable<OBAccount4DetailAccountItem> account)
        {
            if (accountId == null)
            {
