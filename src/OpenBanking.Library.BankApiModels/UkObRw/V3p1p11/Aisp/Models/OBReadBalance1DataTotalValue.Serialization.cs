...
{
    public partial class OBReadBalance1DataTotalValue
    {
        internal static OBReadBalance1DataTotalValue DeserializeOBReadBalance1DataTotalValue(JsonElement element)
        {
            ...
            return new OBReadBalance1DataTotalValue(amount, currency);
        }
    }
}
