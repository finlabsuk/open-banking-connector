...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p11.Aisp.Models
{
    ...
    {
        internal static OBReadParty3 DeserializeOBReadParty3(JsonElement element)
        {
            OBReadParty3Data data = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    data = OBReadParty3Data.DeserializeOBReadParty3Data(property.Value);
                    continue;
                }
            ...
            return new OBReadParty3(data, links.Value, meta.Value);
        }
    }
}
