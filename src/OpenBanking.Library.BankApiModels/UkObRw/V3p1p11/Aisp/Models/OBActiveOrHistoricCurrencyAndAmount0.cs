...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p11.Aisp.Models
{
    ...
    {
        /// <summary> Initializes a new instance of OBActiveOrHistoricCurrencyAndAmount0. </summary>
        ...
        internal OBActiveOrHistoricCurrencyAndAmount0(string amount, string currency)
        {
            if (amount == null)
            {
