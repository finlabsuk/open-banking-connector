...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p11.Aisp.Models
{
    public partial class OBReadBalance1DataBalanceItem
    {
        internal static OBReadBalance1DataBalanceItem DeserializeOBReadBalance1DataBalanceItem(JsonElement element)
        {
            ...
            Optional<OBReadBalance1DataBalanceItemLocalAmount> localAmount = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("LocalAmount"))
                {
                    ...
                    localAmount = OBReadBalance1DataBalanceItemLocalAmount.DeserializeOBReadBalance1DataBalanceItemLocalAmount(property.Value);
                    continue;
                }
            }
            return new OBReadBalance1DataBalanceItem(accountId, creditDebitIndicator, type, dateTime, amount, Optional.ToList(creditLine), localAmount.Value);
        }
    }
}
