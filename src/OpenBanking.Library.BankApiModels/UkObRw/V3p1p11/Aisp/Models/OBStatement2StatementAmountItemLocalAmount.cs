...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p11.Aisp.Models
{
    ...
    public partial class OBStatement2StatementAmountItemLocalAmount
    {
        ...
        public OBStatement2StatementAmountItemLocalAmount(string amount, string currency)
        {
            if (amount == null)
            {
        ...
        [JsonConstructor]
        public OBStatement2StatementAmountItemLocalAmount(string amount, string currency, OBStatement2StatementAmountLocalAmountSubTypeEnum? subType)
        {
            Amount = amount;
            Currency = currency;
            SubType = subType;
