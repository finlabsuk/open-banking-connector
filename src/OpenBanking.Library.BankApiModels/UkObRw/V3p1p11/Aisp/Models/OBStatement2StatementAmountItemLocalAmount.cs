...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p11.Aisp.Models
{
    ...
    {
        /// <summary> Initializes a new instance of OBStatement2StatementAmountItemLocalAmount. </summary>
        ...
        internal OBStatement2StatementAmountItemLocalAmount(string amount, string currency)
        {
            if (amount == null)
            {
        ...
        /// <param name="amount"> A number of monetary units specified in an active currency where the unit of currency is explicit and compliant with ISO 4217. </param>
        /// <param name="currency"> A code allocated to a currency by a Maintenance Agency under an international identification scheme, as described in the latest edition of the international standard ISO 4217 &quot;Codes for the representation of currencies and funds&quot;. </param>
        /// <param name="subType"> The amount in the local market currency for which the asset is held. Default is Local Currency (LCUR) if not specified. </param>
        internal OBStatement2StatementAmountItemLocalAmount(string amount, string currency, OBStatement2StatementAmountLocalAmountSubTypeEnum? subType)
        {
            Amount = amount;
            Currency = currency;
            SubType = subType;
        ...
        public OBStatement2StatementAmountLocalAmountSubTypeEnum? SubType { get; }
    }
}
