...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p11.Aisp.Models
{
    ...
    internal partial class OBActiveOrHistoricCurrencyAndAmount8
    {
        /// <summary> Initializes a new instance of OBActiveOrHistoricCurrencyAndAmount8. </summary>
        ...
        internal OBActiveOrHistoricCurrencyAndAmount8(string amount, string currency)
        {
            if (amount == null)
            {
        ...
        public OBExternalBalanceSubType1CodeEnum? SubType { get; }
    }
}
