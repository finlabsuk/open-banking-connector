...
namespace FinnovationLabs.OpenBanking.Library.BankApiModels.UkObRw.V3p1p9.Aisp.Models
{
    ...
    {
        /// <summary> Initializes a new instance of OBActiveOrHistoricCurrencyAndAmount6. </summary>
        ...
        internal OBActiveOrHistoricCurrencyAndAmount6(string amount, string currency)
        {
            if (amount == null)
            {
