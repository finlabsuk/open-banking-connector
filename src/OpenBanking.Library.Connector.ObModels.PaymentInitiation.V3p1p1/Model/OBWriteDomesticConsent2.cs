...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDomesticConsent2 :  IEquatable<OBWriteDomesticConsent2>, IValidatableObject
    {
        ...
        public OBWriteDomesticConsent2(OBWriteDataDomesticConsent2 data = default(OBWriteDataDomesticConsent2), OBRisk1 risk = default(OBRisk1))
        {
            ...
            this.Data = data ?? throw new ArgumentNullException("data is a required property for OBWriteDomesticConsent2 and cannot be null");
            // to ensure "risk" is required (not null)
            this.Risk = risk ?? throw new ArgumentNullException("risk is a required property for OBWriteDomesticConsent2 and cannot be null");
        }
