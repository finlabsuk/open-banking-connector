...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDataInternationalStandingOrderConsentResponse3 :  IEquatable<OBWriteDataInternationalStandingOrderConsentResponse3>, IValidatableObject
    {
        ...
        public OBWriteDataInternationalStandingOrderConsentResponse3(string consentId = default(string), DateTimeOffset creationDateTime = default(DateTimeOffset), OBExternalConsentStatus1Code status = default(OBExternalConsentStatus1Code), DateTimeOffset statusUpdateDateTime = default(DateTimeOffset), OBExternalPermissions2Code permission = default(OBExternalPermissions2Code), DateTimeOffset cutOffDateTime = default(DateTimeOffset), List<OBCharge2> charges = default(List<OBCharge2>), OBInternationalStandingOrder3 initiation = default(OBInternationalStandingOrder3), OBAuthorisation1 authorisation = default(OBAuthorisation1))
        {
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteDataInternationalStandingOrderConsentResponse3 and cannot be null");
            this.CreationDateTime = creationDateTime;
            this.Status = status;
            this.StatusUpdateDateTime = statusUpdateDateTime;
            this.Permission = permission;
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDataInternationalStandingOrderConsentResponse3 and cannot be null");
