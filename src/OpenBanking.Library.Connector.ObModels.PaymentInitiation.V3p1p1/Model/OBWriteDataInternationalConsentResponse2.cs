...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDataInternationalConsentResponse2 :  IEquatable<OBWriteDataInternationalConsentResponse2>, IValidatableObject
    {
        ...
        public OBWriteDataInternationalConsentResponse2(string consentId = default(string), DateTimeOffset creationDateTime = default(DateTimeOffset), OBExternalConsentStatus1Code status = default(OBExternalConsentStatus1Code), DateTimeOffset statusUpdateDateTime = default(DateTimeOffset), DateTimeOffset cutOffDateTime = default(DateTimeOffset), DateTimeOffset expectedExecutionDateTime = default(DateTimeOffset), DateTimeOffset expectedSettlementDateTime = default(DateTimeOffset), List<OBCharge2> charges = default(List<OBCharge2>), OBExchangeRate2 exchangeRateInformation = default(OBExchangeRate2), OBInternational2 initiation = default(OBInternational2), OBAuthorisation1 authorisation = default(OBAuthorisation1))
        {
            ...
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteDataInternationalConsentResponse2 and cannot be null");
            this.CreationDateTime = creationDateTime;
            this.Status = status;
            this.StatusUpdateDateTime = statusUpdateDateTime;
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDataInternationalConsentResponse2 and cannot be null");
