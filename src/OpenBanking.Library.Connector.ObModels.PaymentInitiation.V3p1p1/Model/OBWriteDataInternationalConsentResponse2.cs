...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataInternationalConsentResponse2 :  IEquatable<OBWriteDataInternationalConsentResponse2>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataInternationalConsentResponse2" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataInternationalConsentResponse2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataInternationalConsentResponse2" /> class.
        /// </summary>
        ...
        public OBWriteDataInternationalConsentResponse2(string consentId = default(string), DateTime? creationDateTime = default(DateTime?), OBExternalConsentStatus1Code status = default(OBExternalConsentStatus1Code), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? cutOffDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), DateTime? expectedSettlementDateTime = default(DateTime?), List<OBCharge2> charges = default(List<OBCharge2>), OBExchangeRate2 exchangeRateInformation = default(OBExchangeRate2), OBInternational2 initiation = default(OBInternational2), OBAuthorisation1 authorisation = default(OBAuthorisation1))
        {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDataInternationalConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDataInternationalConsentResponse2 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDataInternationalConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataInternationalConsentResponse2 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDataInternationalConsentResponse2);
        }

        /// <summary>
        /// Returns true if OBWriteDataInternationalConsentResponse2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataInternationalConsentResponse2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataInternationalConsentResponse2 input)
        {
            if (input == null)
                return false;
