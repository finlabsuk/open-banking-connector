...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBDomesticStandingOrder3FinalPaymentAmount :  IEquatable<OBDomesticStandingOrder3FinalPaymentAmount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBDomesticStandingOrder3FinalPaymentAmount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBDomesticStandingOrder3FinalPaymentAmount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBDomesticStandingOrder3FinalPaymentAmount" /> class.
        /// </summary>
        ...
        public OBDomesticStandingOrder3FinalPaymentAmount(string amount = default(string), string currency = default(string))
        {
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for OBDomesticStandingOrder3FinalPaymentAmount and cannot be null");
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for OBDomesticStandingOrder3FinalPaymentAmount and cannot be null");
        }
        ...
        {
            return this.Equals(input as OBDomesticStandingOrder3FinalPaymentAmount);
        }

        /// <summary>
        /// Returns true if OBDomesticStandingOrder3FinalPaymentAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBDomesticStandingOrder3FinalPaymentAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBDomesticStandingOrder3FinalPaymentAmount input)
        {
            if (input == null)
                return false;
