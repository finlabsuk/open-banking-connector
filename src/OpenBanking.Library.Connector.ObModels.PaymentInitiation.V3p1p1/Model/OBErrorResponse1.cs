...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBErrorResponse1 :  IEquatable<OBErrorResponse1>, IValidatableObject
    {
        ...
        public OBErrorResponse1(string code = default(string), string id = default(string), string message = default(string), List<OBError1> errors = default(List<OBError1>))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for OBErrorResponse1 and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for OBErrorResponse1 and cannot be null");
            }
            else
            {
            ...
            if (errors == null)
            {
                throw new InvalidDataException("errors is a required property for OBErrorResponse1 and cannot be null");
            }
            else
            {
                this.Errors = errors;
