...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDataInternationalScheduled2 :  IEquatable<OBWriteDataInternationalScheduled2>, IValidatableObject
    {
        ...
        public OBWriteDataInternationalScheduled2(string consentId = default(string), OBInternationalScheduled2 initiation = default(OBInternationalScheduled2))
        {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataInternationalScheduled2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataInternationalScheduled2 and cannot be null");
            }
            else
            {
