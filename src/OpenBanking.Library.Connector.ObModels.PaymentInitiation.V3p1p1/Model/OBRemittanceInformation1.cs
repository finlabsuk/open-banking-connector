...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBRemittanceInformation1 :  IEquatable<OBRemittanceInformation1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBRemittanceInformation1" /> class.
        /// </summary>
        ...
        public OBRemittanceInformation1(string unstructured = default(string), string reference = default(string))
        {
        ...
        {
            return this.Equals(input as OBRemittanceInformation1);
        }

        /// <summary>
        /// Returns true if OBRemittanceInformation1 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBRemittanceInformation1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBRemittanceInformation1 input)
        {
            if (input == null)
                return false;
