...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBBranchAndFinancialInstitutionIdentification6 :  IEquatable<OBBranchAndFinancialInstitutionIdentification6>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OBBranchAndFinancialInstitutionIdentification6);
        }

        /// <summary>
        /// Returns true if OBBranchAndFinancialInstitutionIdentification6 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBBranchAndFinancialInstitutionIdentification6 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBBranchAndFinancialInstitutionIdentification6 input)
        {
            if (input == null)
                return false;
