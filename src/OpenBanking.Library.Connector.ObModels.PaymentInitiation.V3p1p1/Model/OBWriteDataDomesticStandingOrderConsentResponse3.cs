...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataDomesticStandingOrderConsentResponse3 :  IEquatable<OBWriteDataDomesticStandingOrderConsentResponse3>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataDomesticStandingOrderConsentResponse3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataDomesticStandingOrderConsentResponse3" /> class.
        /// </summary>
        ...
        public OBWriteDataDomesticStandingOrderConsentResponse3(string consentId = default(string), DateTime? creationDateTime = default(DateTime?), OBExternalConsentStatus1Code status = default(OBExternalConsentStatus1Code), DateTime? statusUpdateDateTime = default(DateTime?), OBExternalPermissions2Code permission = default(OBExternalPermissions2Code), DateTime? cutOffDateTime = default(DateTime?), List<OBCharge2> charges = default(List<OBCharge2>), OBDomesticStandingOrder3 initiation = default(OBDomesticStandingOrder3), OBAuthorisation1 authorisation = default(OBAuthorisation1))
        {
            // to ensure "consentId" is required (not null)
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataDomesticStandingOrderConsentResponse3 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDataDomesticStandingOrderConsentResponse3 and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDataDomesticStandingOrderConsentResponse3 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDataDomesticStandingOrderConsentResponse3 and cannot be null");
            }
            else
            {
            ...
            if (permission == null)
            {
                throw new InvalidDataException("permission is a required property for OBWriteDataDomesticStandingOrderConsentResponse3 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataDomesticStandingOrderConsentResponse3 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDataDomesticStandingOrderConsentResponse3);
        }

        /// <summary>
        /// Returns true if OBWriteDataDomesticStandingOrderConsentResponse3 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataDomesticStandingOrderConsentResponse3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataDomesticStandingOrderConsentResponse3 input)
        {
            if (input == null)
                return false;
