...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBCharge2Amount :  IEquatable<OBCharge2Amount>, IValidatableObject
    {
        ...
        public OBCharge2Amount(string amount = default(string), string currency = default(string))
        {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for OBCharge2Amount and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for OBCharge2Amount and cannot be null");
            }
            else
            {
