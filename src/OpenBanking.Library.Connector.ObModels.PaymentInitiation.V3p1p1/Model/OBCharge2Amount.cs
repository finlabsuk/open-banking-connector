...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBCharge2Amount :  IEquatable<OBCharge2Amount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBCharge2Amount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBCharge2Amount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBCharge2Amount" /> class.
        /// </summary>
        ...
        public OBCharge2Amount(string amount = default(string), string currency = default(string))
        {
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for OBCharge2Amount and cannot be null");
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for OBCharge2Amount and cannot be null");
        }
        ...
        {
            return this.Equals(input as OBCharge2Amount);
        }

        /// <summary>
        /// Returns true if OBCharge2Amount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBCharge2Amount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBCharge2Amount input)
        {
            if (input == null)
                return false;
