...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataInternationalStandingOrderResponse3 :  IEquatable<OBWriteDataInternationalStandingOrderResponse3>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataInternationalStandingOrderResponse3" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataInternationalStandingOrderResponse3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataInternationalStandingOrderResponse3" /> class.
        /// </summary>
        ...
        public OBWriteDataInternationalStandingOrderResponse3(string internationalStandingOrderId = default(string), string consentId = default(string), DateTime? creationDateTime = default(DateTime?), OBExternalStatus1Code status = default(OBExternalStatus1Code), DateTime? statusUpdateDateTime = default(DateTime?), List<OBCharge2> charges = default(List<OBCharge2>), OBInternationalStandingOrder3 initiation = default(OBInternationalStandingOrder3), OBMultiAuthorisation1 multiAuthorisation = default(OBMultiAuthorisation1))
        {
            // to ensure "internationalStandingOrderId" is required (not null)
            if (internationalStandingOrderId == null)
            {
                throw new InvalidDataException("internationalStandingOrderId is a required property for OBWriteDataInternationalStandingOrderResponse3 and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataInternationalStandingOrderResponse3 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDataInternationalStandingOrderResponse3 and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDataInternationalStandingOrderResponse3 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDataInternationalStandingOrderResponse3 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataInternationalStandingOrderResponse3 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDataInternationalStandingOrderResponse3);
        }

        /// <summary>
        /// Returns true if OBWriteDataInternationalStandingOrderResponse3 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataInternationalStandingOrderResponse3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataInternationalStandingOrderResponse3 input)
        {
            if (input == null)
                return false;
