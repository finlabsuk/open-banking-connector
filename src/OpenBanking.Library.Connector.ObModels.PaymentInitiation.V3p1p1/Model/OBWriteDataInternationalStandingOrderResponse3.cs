...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDataInternationalStandingOrderResponse3 :  IEquatable<OBWriteDataInternationalStandingOrderResponse3>, IValidatableObject
    {
        ...
        public OBWriteDataInternationalStandingOrderResponse3(string internationalStandingOrderId = default(string), string consentId = default(string), DateTimeOffset creationDateTime = default(DateTimeOffset), OBExternalStatus1Code status = default(OBExternalStatus1Code), DateTimeOffset statusUpdateDateTime = default(DateTimeOffset), List<OBCharge2> charges = default(List<OBCharge2>), OBInternationalStandingOrder3 initiation = default(OBInternationalStandingOrder3), OBMultiAuthorisation1 multiAuthorisation = default(OBMultiAuthorisation1))
        {
            // to ensure "internationalStandingOrderId" is required (not null)
            this.InternationalStandingOrderId = internationalStandingOrderId ?? throw new ArgumentNullException("internationalStandingOrderId is a required property for OBWriteDataInternationalStandingOrderResponse3 and cannot be null");
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteDataInternationalStandingOrderResponse3 and cannot be null");
            this.CreationDateTime = creationDateTime;
            this.Status = status;
            this.StatusUpdateDateTime = statusUpdateDateTime;
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDataInternationalStandingOrderResponse3 and cannot be null");
