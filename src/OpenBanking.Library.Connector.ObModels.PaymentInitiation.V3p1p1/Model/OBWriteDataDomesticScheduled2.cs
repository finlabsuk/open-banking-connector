...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataDomesticScheduled2 :  IEquatable<OBWriteDataDomesticScheduled2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataDomesticScheduled2" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataDomesticScheduled2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataDomesticScheduled2" /> class.
        /// </summary>
        ...
        public OBWriteDataDomesticScheduled2(string consentId = default(string), OBDomesticScheduled2 initiation = default(OBDomesticScheduled2))
        {
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteDataDomesticScheduled2 and cannot be null");
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDataDomesticScheduled2 and cannot be null");
        }
        ...
        {
            return this.Equals(input as OBWriteDataDomesticScheduled2);
        }

        /// <summary>
        /// Returns true if OBWriteDataDomesticScheduled2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataDomesticScheduled2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataDomesticScheduled2 input)
        {
            if (input == null)
                return false;
