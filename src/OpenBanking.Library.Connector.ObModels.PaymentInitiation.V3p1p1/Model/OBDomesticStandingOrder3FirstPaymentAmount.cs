...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBDomesticStandingOrder3FirstPaymentAmount :  IEquatable<OBDomesticStandingOrder3FirstPaymentAmount>, IValidatableObject
    {
        ...
        public OBDomesticStandingOrder3FirstPaymentAmount(string amount = default(string), string currency = default(string))
        {
            ...
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for OBDomesticStandingOrder3FirstPaymentAmount and cannot be null");
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for OBDomesticStandingOrder3FirstPaymentAmount and cannot be null");
        }
