...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteInternationalStandingOrderResponse3 :  IEquatable<OBWriteInternationalStandingOrderResponse3>, IValidatableObject
    {
        ...
        public OBWriteInternationalStandingOrderResponse3(OBWriteDataInternationalStandingOrderResponse3 data = default(OBWriteDataInternationalStandingOrderResponse3), Links links = default(Links), Meta meta = default(Meta))
        {
            ...
            this.Data = data ?? throw new ArgumentNullException("data is a required property for OBWriteInternationalStandingOrderResponse3 and cannot be null");
            // to ensure "links" is required (not null)
            this.Links = links ?? throw new ArgumentNullException("links is a required property for OBWriteInternationalStandingOrderResponse3 and cannot be null");
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for OBWriteInternationalStandingOrderResponse3 and cannot be null");
        }
