...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBExchangeRate2 :  IEquatable<OBExchangeRate2>, IValidatableObject
    {
        ...
        public OBExchangeRate2(string unitCurrency = default(string), decimal exchangeRate = default(decimal), OBExchangeRateType2Code rateType = default(OBExchangeRateType2Code), string contractIdentification = default(string), DateTimeOffset expirationDateTime = default(DateTimeOffset))
        {
            // to ensure "unitCurrency" is required (not null)
            this.UnitCurrency = unitCurrency ?? throw new ArgumentNullException("unitCurrency is a required property for OBExchangeRate2 and cannot be null");
