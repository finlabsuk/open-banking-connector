...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataDomesticConsentResponse2 :  IEquatable<OBWriteDataDomesticConsentResponse2>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataDomesticConsentResponse2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataDomesticConsentResponse2" /> class.
        /// </summary>
        ...
        public OBWriteDataDomesticConsentResponse2(string consentId = default(string), DateTime? creationDateTime = default(DateTime?), OBExternalConsentStatus1Code status = default(OBExternalConsentStatus1Code), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? cutOffDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), DateTime? expectedSettlementDateTime = default(DateTime?), List<OBCharge2> charges = default(List<OBCharge2>), OBDomestic2 initiation = default(OBDomestic2), OBAuthorisation1 authorisation = default(OBAuthorisation1))
        {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDataDomesticConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDataDomesticConsentResponse2 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDataDomesticConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataDomesticConsentResponse2 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDataDomesticConsentResponse2);
        }

        /// <summary>
        /// Returns true if OBWriteDataDomesticConsentResponse2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataDomesticConsentResponse2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataDomesticConsentResponse2 input)
        {
            if (input == null)
                return false;
