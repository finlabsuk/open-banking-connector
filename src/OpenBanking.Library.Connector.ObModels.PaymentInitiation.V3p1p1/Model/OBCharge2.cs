...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBCharge2 :  IEquatable<OBCharge2>, IValidatableObject
    {
        /// <summary>
        ...
        public OBCharge2(OBChargeBearerType1Code chargeBearer = default(OBChargeBearerType1Code), string type = default(string), OBCharge2Amount amount = default(OBCharge2Amount))
        {
            ...
            {
                throw new InvalidDataException("chargeBearer is a required property for OBCharge2 and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for OBCharge2 and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for OBCharge2 and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        public OBCharge2Amount Amount { get; set; }
        ...
        {
            return this.Equals(input as OBCharge2);
        }

        /// <summary>
        /// Returns true if OBCharge2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBCharge2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBCharge2 input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.Type != null && this.Type.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Type, length must be less than 40.", new [] { "Type" });
            }
