...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDomesticStandingOrder3 :  IEquatable<OBWriteDomesticStandingOrder3>, IValidatableObject
    {
        ...
        public OBWriteDomesticStandingOrder3(OBWriteDataDomesticStandingOrder3 data = default(OBWriteDataDomesticStandingOrder3), OBRisk1 risk = default(OBRisk1))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for OBWriteDomesticStandingOrder3 and cannot be null");
            }
            else
            {
                this.Data = data;
            ...
            if (risk == null)
            {
                throw new InvalidDataException("risk is a required property for OBWriteDomesticStandingOrder3 and cannot be null");
            }
            else
            {
                this.Risk = risk;
        ...
        public OBWriteDataDomesticStandingOrder3 Data { get; set; }
