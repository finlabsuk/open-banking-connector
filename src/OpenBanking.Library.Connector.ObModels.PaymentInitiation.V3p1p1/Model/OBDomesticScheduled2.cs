...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBDomesticScheduled2 :  IEquatable<OBDomesticScheduled2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBDomesticScheduled2" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBDomesticScheduled2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBDomesticScheduled2" /> class.
        /// </summary>
        ...
        public OBDomesticScheduled2(string instructionIdentification = default(string), string endToEndIdentification = default(string), string localInstrument = default(string), DateTime? requestedExecutionDateTime = default(DateTime?), OBInternational2InstructedAmount instructedAmount = default(OBInternational2InstructedAmount), OBCashAccountDebtor4 debtorAccount = default(OBCashAccountDebtor4), OBCashAccountCreditor3 creditorAccount = default(OBCashAccountCreditor3), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6), OBRemittanceInformation1 remittanceInformation = default(OBRemittanceInformation1), OBSupplementaryData1 supplementaryData = default(OBSupplementaryData1))
        {
            // to ensure "instructionIdentification" is required (not null)
            if (instructionIdentification == null)
            {
                throw new InvalidDataException("instructionIdentification is a required property for OBDomesticScheduled2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("requestedExecutionDateTime is a required property for OBDomesticScheduled2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instructedAmount is a required property for OBDomesticScheduled2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditorAccount is a required property for OBDomesticScheduled2 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBDomesticScheduled2);
        }

        /// <summary>
        /// Returns true if OBDomesticScheduled2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBDomesticScheduled2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBDomesticScheduled2 input)
        {
            if (input == null)
                return false;
