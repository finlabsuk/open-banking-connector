...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDataDomesticStandingOrderResponse3 :  IEquatable<OBWriteDataDomesticStandingOrderResponse3>, IValidatableObject
    {
        ...
        public OBWriteDataDomesticStandingOrderResponse3(string domesticStandingOrderId = default(string), string consentId = default(string), DateTimeOffset creationDateTime = default(DateTimeOffset), OBExternalStatus1Code status = default(OBExternalStatus1Code), DateTimeOffset statusUpdateDateTime = default(DateTimeOffset), List<OBCharge2> charges = default(List<OBCharge2>), OBDomesticStandingOrder3 initiation = default(OBDomesticStandingOrder3), OBMultiAuthorisation1 multiAuthorisation = default(OBMultiAuthorisation1))
        {
            // to ensure "domesticStandingOrderId" is required (not null)
            this.DomesticStandingOrderId = domesticStandingOrderId ?? throw new ArgumentNullException("domesticStandingOrderId is a required property for OBWriteDataDomesticStandingOrderResponse3 and cannot be null");
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteDataDomesticStandingOrderResponse3 and cannot be null");
            this.CreationDateTime = creationDateTime;
            this.Status = status;
            this.StatusUpdateDateTime = statusUpdateDateTime;
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDataDomesticStandingOrderResponse3 and cannot be null");
