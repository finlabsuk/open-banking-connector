...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBDomestic2InstructedAmount :  IEquatable<OBDomestic2InstructedAmount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBDomestic2InstructedAmount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBDomestic2InstructedAmount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBDomestic2InstructedAmount" /> class.
        /// </summary>
        ...
        public OBDomestic2InstructedAmount(string amount = default(string), string currency = default(string))
        {
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for OBDomestic2InstructedAmount and cannot be null");
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for OBDomestic2InstructedAmount and cannot be null");
        }
        ...
        {
            return this.Equals(input as OBDomestic2InstructedAmount);
        }

        /// <summary>
        /// Returns true if OBDomestic2InstructedAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBDomestic2InstructedAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBDomestic2InstructedAmount input)
        {
            if (input == null)
                return false;
