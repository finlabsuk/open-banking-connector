...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBInternationalScheduled2 :  IEquatable<OBInternationalScheduled2>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets InstructionPriority
        /// </summary>
        [DataMember(Name="InstructionPriority", EmitDefaultValue=false)]
        public OBPriority2Code? InstructionPriority { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBInternationalScheduled2" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBInternationalScheduled2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBInternationalScheduled2" /> class.
        /// </summary>
        ...
        public OBInternationalScheduled2(string instructionIdentification = default(string), string endToEndIdentification = default(string), string localInstrument = default(string), OBPriority2Code? instructionPriority = default(OBPriority2Code?), string purpose = default(string), OBChargeBearerType1Code? chargeBearer = default(OBChargeBearerType1Code?), DateTime? requestedExecutionDateTime = default(DateTime?), string currencyOfTransfer = default(string), OBInternational2InstructedAmount instructedAmount = default(OBInternational2InstructedAmount), OBExchangeRate1 exchangeRateInformation = default(OBExchangeRate1), OBCashAccountDebtor4 debtorAccount = default(OBCashAccountDebtor4), OBPartyIdentification43 creditor = default(OBPartyIdentification43), OBBranchAndFinancialInstitutionIdentification6 creditorAgent = default(OBBranchAndFinancialInstitutionIdentification6), OBCashAccountCreditor3 creditorAccount = default(OBCashAccountCreditor3), OBRemittanceInformation1 remittanceInformation = default(OBRemittanceInformation1), OBSupplementaryData1 supplementaryData = default(OBSupplementaryData1))
        {
            // to ensure "instructionIdentification" is required (not null)
            if (instructionIdentification == null)
            {
                throw new InvalidDataException("instructionIdentification is a required property for OBInternationalScheduled2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("requestedExecutionDateTime is a required property for OBInternationalScheduled2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("currencyOfTransfer is a required property for OBInternationalScheduled2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instructedAmount is a required property for OBInternationalScheduled2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditorAccount is a required property for OBInternationalScheduled2 and cannot be null");
            }
            else
            {
        ...
        public OBInternational2InstructedAmount InstructedAmount { get; set; }

        /// <summary>
        /// Gets or Sets ExchangeRateInformation
        /// </summary>
        [DataMember(Name="ExchangeRateInformation", EmitDefaultValue=false)]
        public OBExchangeRate1 ExchangeRateInformation { get; set; }
        ...
        {
            return this.Equals(input as OBInternationalScheduled2);
        }

        /// <summary>
        /// Returns true if OBInternationalScheduled2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBInternationalScheduled2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBInternationalScheduled2 input)
        {
            if (input == null)
                return false;
