...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBInternationalScheduled2 :  IEquatable<OBInternationalScheduled2>, IValidatableObject
    {
        ...
        public OBInternationalScheduled2(string instructionIdentification = default(string), string endToEndIdentification = default(string), string localInstrument = default(string), OBPriority2Code? instructionPriority = default(OBPriority2Code?), string purpose = default(string), OBChargeBearerType1Code? chargeBearer = default(OBChargeBearerType1Code?), DateTimeOffset requestedExecutionDateTime = default(DateTimeOffset), string currencyOfTransfer = default(string), OBDomestic2InstructedAmount instructedAmount = default(OBDomestic2InstructedAmount), OBExchangeRate1 exchangeRateInformation = default(OBExchangeRate1), OBCashAccountDebtor4 debtorAccount = default(OBCashAccountDebtor4), OBPartyIdentification43 creditor = default(OBPartyIdentification43), OBBranchAndFinancialInstitutionIdentification6 creditorAgent = default(OBBranchAndFinancialInstitutionIdentification6), OBCashAccountCreditor3 creditorAccount = default(OBCashAccountCreditor3), OBRemittanceInformation1 remittanceInformation = default(OBRemittanceInformation1), Object supplementaryData = default(Object))
        {
            ...
            this.InstructionIdentification = instructionIdentification ?? throw new ArgumentNullException("instructionIdentification is a required property for OBInternationalScheduled2 and cannot be null");
            this.RequestedExecutionDateTime = requestedExecutionDateTime;
            // to ensure "currencyOfTransfer" is required (not null)
            this.CurrencyOfTransfer = currencyOfTransfer ?? throw new ArgumentNullException("currencyOfTransfer is a required property for OBInternationalScheduled2 and cannot be null");
            // to ensure "instructedAmount" is required (not null)
            this.InstructedAmount = instructedAmount ?? throw new ArgumentNullException("instructedAmount is a required property for OBInternationalScheduled2 and cannot be null");
            // to ensure "creditorAccount" is required (not null)
            this.CreditorAccount = creditorAccount ?? throw new ArgumentNullException("creditorAccount is a required property for OBInternationalScheduled2 and cannot be null");
