...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataInternationalResponse2 :  IEquatable<OBWriteDataInternationalResponse2>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataInternationalResponse2" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataInternationalResponse2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataInternationalResponse2" /> class.
        /// </summary>
        ...
        public OBWriteDataInternationalResponse2(string internationalPaymentId = default(string), string consentId = default(string), DateTime? creationDateTime = default(DateTime?), OBTransactionIndividualStatus1Code status = default(OBTransactionIndividualStatus1Code), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), DateTime? expectedSettlementDateTime = default(DateTime?), List<OBCharge2> charges = default(List<OBCharge2>), OBExchangeRate2 exchangeRateInformation = default(OBExchangeRate2), OBInternational2 initiation = default(OBInternational2), OBMultiAuthorisation1 multiAuthorisation = default(OBMultiAuthorisation1))
        {
            // to ensure "internationalPaymentId" is required (not null)
            if (internationalPaymentId == null)
            {
                throw new InvalidDataException("internationalPaymentId is a required property for OBWriteDataInternationalResponse2 and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataInternationalResponse2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDataInternationalResponse2 and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDataInternationalResponse2 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDataInternationalResponse2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataInternationalResponse2 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDataInternationalResponse2);
        }

        /// <summary>
        /// Returns true if OBWriteDataInternationalResponse2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataInternationalResponse2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataInternationalResponse2 input)
        {
            if (input == null)
                return false;
