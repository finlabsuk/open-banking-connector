...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataInternationalScheduledConsentResponse2 :  IEquatable<OBWriteDataInternationalScheduledConsentResponse2>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataInternationalScheduledConsentResponse2" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataInternationalScheduledConsentResponse2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataInternationalScheduledConsentResponse2" /> class.
        /// </summary>
        ...
        public OBWriteDataInternationalScheduledConsentResponse2(string consentId = default(string), DateTime? creationDateTime = default(DateTime?), OBExternalConsentStatus1Code status = default(OBExternalConsentStatus1Code), DateTime? statusUpdateDateTime = default(DateTime?), OBExternalPermissions2Code permission = default(OBExternalPermissions2Code), DateTime? cutOffDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), DateTime? expectedSettlementDateTime = default(DateTime?), List<OBCharge2> charges = default(List<OBCharge2>), OBExchangeRate2 exchangeRateInformation = default(OBExchangeRate2), OBInternationalScheduled2 initiation = default(OBInternationalScheduled2), OBAuthorisation1 authorisation = default(OBAuthorisation1))
        {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDataInternationalScheduledConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDataInternationalScheduledConsentResponse2 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDataInternationalScheduledConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            if (permission == null)
            {
                throw new InvalidDataException("permission is a required property for OBWriteDataInternationalScheduledConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataInternationalScheduledConsentResponse2 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDataInternationalScheduledConsentResponse2);
        }

        /// <summary>
        /// Returns true if OBWriteDataInternationalScheduledConsentResponse2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataInternationalScheduledConsentResponse2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataInternationalScheduledConsentResponse2 input)
        {
            if (input == null)
                return false;
