...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataDomesticResponse2 :  IEquatable<OBWriteDataDomesticResponse2>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataDomesticResponse2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataDomesticResponse2" /> class.
        /// </summary>
        ...
        public OBWriteDataDomesticResponse2(string domesticPaymentId = default(string), string consentId = default(string), DateTime? creationDateTime = default(DateTime?), OBTransactionIndividualStatus1Code status = default(OBTransactionIndividualStatus1Code), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), DateTime? expectedSettlementDateTime = default(DateTime?), List<OBCharge2> charges = default(List<OBCharge2>), OBDomestic2 initiation = default(OBDomestic2), OBMultiAuthorisation1 multiAuthorisation = default(OBMultiAuthorisation1))
        {
            // to ensure "domesticPaymentId" is required (not null)
            if (domesticPaymentId == null)
            {
                throw new InvalidDataException("domesticPaymentId is a required property for OBWriteDataDomesticResponse2 and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataDomesticResponse2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDataDomesticResponse2 and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDataDomesticResponse2 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDataDomesticResponse2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataDomesticResponse2 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDataDomesticResponse2);
        }

        /// <summary>
        /// Returns true if OBWriteDataDomesticResponse2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataDomesticResponse2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataDomesticResponse2 input)
        {
            if (input == null)
                return false;
