...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBCashAccountCreditor3 :  IEquatable<OBCashAccountCreditor3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBCashAccountCreditor3" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBCashAccountCreditor3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBCashAccountCreditor3" /> class.
        /// </summary>
        ...
        public OBCashAccountCreditor3(string schemeName = default(string), string identification = default(string), string name = default(string), string secondaryIdentification = default(string))
        {
            // to ensure "schemeName" is required (not null)
            this.SchemeName = schemeName ?? throw new ArgumentNullException("schemeName is a required property for OBCashAccountCreditor3 and cannot be null");
            // to ensure "identification" is required (not null)
            this.Identification = identification ?? throw new ArgumentNullException("identification is a required property for OBCashAccountCreditor3 and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for OBCashAccountCreditor3 and cannot be null");
        ...
        {
            return this.Equals(input as OBCashAccountCreditor3);
        }

        /// <summary>
        /// Returns true if OBCashAccountCreditor3 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBCashAccountCreditor3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBCashAccountCreditor3 input)
        {
            if (input == null)
                return false;
