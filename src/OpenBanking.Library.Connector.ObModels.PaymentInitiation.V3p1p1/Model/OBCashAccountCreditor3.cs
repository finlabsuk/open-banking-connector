...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBCashAccountCreditor3 :  IEquatable<OBCashAccountCreditor3>, IValidatableObject
    {
        ...
        public OBCashAccountCreditor3(string schemeName = default(string), string identification = default(string), string name = default(string), string secondaryIdentification = default(string))
        {
            ...
            if (schemeName == null)
            {
                throw new InvalidDataException("schemeName is a required property for OBCashAccountCreditor3 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identification is a required property for OBCashAccountCreditor3 and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for OBCashAccountCreditor3 and cannot be null");
            }
            else
            {
                this.Name = name;
