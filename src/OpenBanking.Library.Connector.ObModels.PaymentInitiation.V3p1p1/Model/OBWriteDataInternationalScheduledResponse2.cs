...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDataInternationalScheduledResponse2 :  IEquatable<OBWriteDataInternationalScheduledResponse2>, IValidatableObject
    {
        ...
        public OBWriteDataInternationalScheduledResponse2(string internationalScheduledPaymentId = default(string), string consentId = default(string), DateTime? creationDateTime = default(DateTime?), OBExternalStatus1Code status = default(OBExternalStatus1Code), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), DateTime? expectedSettlementDateTime = default(DateTime?), List<OBCharge2> charges = default(List<OBCharge2>), OBExchangeRate2 exchangeRateInformation = default(OBExchangeRate2), OBInternationalScheduled2 initiation = default(OBInternationalScheduled2), OBMultiAuthorisation1 multiAuthorisation = default(OBMultiAuthorisation1))
        {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataInternationalScheduledResponse2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDataInternationalScheduledResponse2 and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDataInternationalScheduledResponse2 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDataInternationalScheduledResponse2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataInternationalScheduledResponse2 and cannot be null");
            }
            else
            {
