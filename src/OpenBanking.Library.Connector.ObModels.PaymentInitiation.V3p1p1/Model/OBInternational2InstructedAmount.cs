...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBInternational2InstructedAmount :  IEquatable<OBInternational2InstructedAmount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBInternational2InstructedAmount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBInternational2InstructedAmount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBInternational2InstructedAmount" /> class.
        /// </summary>
        ...
        public OBInternational2InstructedAmount(string amount = default(string), string currency = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for OBInternational2InstructedAmount and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for OBInternational2InstructedAmount and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OBInternational2InstructedAmount {\n");
        ...
        {
            return this.Equals(input as OBInternational2InstructedAmount);
        }

        /// <summary>
        /// Returns true if OBInternational2InstructedAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBInternational2InstructedAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBInternational2InstructedAmount input)
        {
            if (input == null)
                return false;
