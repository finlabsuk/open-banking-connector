...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBInternationalStandingOrder3 :  IEquatable<OBInternationalStandingOrder3>, IValidatableObject
    {
        ...
        public OBInternationalStandingOrder3(string frequency = default(string), string reference = default(string), string numberOfPayments = default(string), DateTime? firstPaymentDateTime = default(DateTime?), DateTime? finalPaymentDateTime = default(DateTime?), string purpose = default(string), OBChargeBearerType1Code? chargeBearer = default(OBChargeBearerType1Code?), string currencyOfTransfer = default(string), OBInternational2InstructedAmount instructedAmount = default(OBInternational2InstructedAmount), OBCashAccountDebtor4 debtorAccount = default(OBCashAccountDebtor4), OBPartyIdentification43 creditor = default(OBPartyIdentification43), OBBranchAndFinancialInstitutionIdentification6 creditorAgent = default(OBBranchAndFinancialInstitutionIdentification6), OBCashAccountCreditor3 creditorAccount = default(OBCashAccountCreditor3), OBSupplementaryData1 supplementaryData = default(OBSupplementaryData1))
        {
            ...
            {
                throw new InvalidDataException("firstPaymentDateTime is a required property for OBInternationalStandingOrder3 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("currencyOfTransfer is a required property for OBInternationalStandingOrder3 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instructedAmount is a required property for OBInternationalStandingOrder3 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditorAccount is a required property for OBInternationalStandingOrder3 and cannot be null");
            }
            else
            {
