...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBWriteDataDomesticScheduledConsentResponse2 :  IEquatable<OBWriteDataDomesticScheduledConsentResponse2>, IValidatableObject
    {
        ...
        public OBWriteDataDomesticScheduledConsentResponse2(string consentId = default(string), DateTime? creationDateTime = default(DateTime?), OBExternalConsentStatus1Code status = default(OBExternalConsentStatus1Code), DateTime? statusUpdateDateTime = default(DateTime?), OBExternalPermissions2Code permission = default(OBExternalPermissions2Code), DateTime? cutOffDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), DateTime? expectedSettlementDateTime = default(DateTime?), List<OBCharge2> charges = default(List<OBCharge2>), OBDomesticScheduled2 initiation = default(OBDomesticScheduled2), OBAuthorisation1 authorisation = default(OBAuthorisation1))
        {
            // to ensure "consentId" is required (not null)
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDataDomesticScheduledConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDataDomesticScheduledConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDataDomesticScheduledConsentResponse2 and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDataDomesticScheduledConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            if (permission == null)
            {
                throw new InvalidDataException("permission is a required property for OBWriteDataDomesticScheduledConsentResponse2 and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDataDomesticScheduledConsentResponse2 and cannot be null");
            }
            else
            {
