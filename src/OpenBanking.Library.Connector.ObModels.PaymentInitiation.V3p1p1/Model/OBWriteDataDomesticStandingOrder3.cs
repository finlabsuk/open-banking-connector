...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDataDomesticStandingOrder3 :  IEquatable<OBWriteDataDomesticStandingOrder3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataDomesticStandingOrder3" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDataDomesticStandingOrder3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDataDomesticStandingOrder3" /> class.
        /// </summary>
        ...
        public OBWriteDataDomesticStandingOrder3(string consentId = default(string), OBDomesticStandingOrder3 initiation = default(OBDomesticStandingOrder3))
        {
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteDataDomesticStandingOrder3 and cannot be null");
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDataDomesticStandingOrder3 and cannot be null");
        }
        ...
        {
            return this.Equals(input as OBWriteDataDomesticStandingOrder3);
        }

        /// <summary>
        /// Returns true if OBWriteDataDomesticStandingOrder3 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDataDomesticStandingOrder3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDataDomesticStandingOrder3 input)
        {
            if (input == null)
                return false;
