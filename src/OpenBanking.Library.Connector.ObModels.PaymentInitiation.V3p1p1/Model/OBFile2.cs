...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBFile2 :  IEquatable<OBFile2>, IValidatableObject
    {
        /// <summary>
        ...
        public OBFile2(string fileType = default(string), string fileHash = default(string), string fileReference = default(string), string numberOfTransactions = default(string), decimal? controlSum = default(decimal?), DateTime? requestedExecutionDateTime = default(DateTime?), string localInstrument = default(string), OBCashAccountDebtor4 debtorAccount = default(OBCashAccountDebtor4), OBRemittanceInformation1 remittanceInformation = default(OBRemittanceInformation1), OBSupplementaryData1 supplementaryData = default(OBSupplementaryData1))
        {
            // to ensure "fileType" is required (not null)
            if (fileType == null)
            {
                throw new InvalidDataException("fileType is a required property for OBFile2 and cannot be null");
            }
            else
            {
            ...
            if (fileHash == null)
            {
                throw new InvalidDataException("fileHash is a required property for OBFile2 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBFile2);
        }

        /// <summary>
        /// Returns true if OBFile2 instances are equal
        /// </summary>
        /// <param name="input">Instance of OBFile2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBFile2 input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.FileType != null && this.FileType.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FileType, length must be less than 40.", new [] { "FileType" });
            }

            // FileType (string) minLength
            if(this.FileType != null && this.FileType.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FileType, length must be greater than 1.", new [] { "FileType" });
            }
            ...
            // NumberOfTransactions (string) maxLength
            if(this.NumberOfTransactions != null && this.NumberOfTransactions.Length > 15)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumberOfTransactions, length must be less than 15.", new [] { "NumberOfTransactions" });
            }

            // NumberOfTransactions (string) minLength
            if(this.NumberOfTransactions != null && this.NumberOfTransactions.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for NumberOfTransactions, length must be greater than 1.", new [] { "NumberOfTransactions" });
            }
