...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p1.Model
{
    ...
    public partial class OBDomesticStandingOrder3 :  IEquatable<OBDomesticStandingOrder3>, IValidatableObject
    {
        ...
        public OBDomesticStandingOrder3(string frequency = default(string), string reference = default(string), string numberOfPayments = default(string), DateTime? firstPaymentDateTime = default(DateTime?), DateTime? recurringPaymentDateTime = default(DateTime?), DateTime? finalPaymentDateTime = default(DateTime?), OBDomesticStandingOrder3FirstPaymentAmount firstPaymentAmount = default(OBDomesticStandingOrder3FirstPaymentAmount), OBDomesticStandingOrder3RecurringPaymentAmount recurringPaymentAmount = default(OBDomesticStandingOrder3RecurringPaymentAmount), OBDomesticStandingOrder3FinalPaymentAmount finalPaymentAmount = default(OBDomesticStandingOrder3FinalPaymentAmount), OBCashAccountDebtor4 debtorAccount = default(OBCashAccountDebtor4), OBCashAccountCreditor3 creditorAccount = default(OBCashAccountCreditor3), OBSupplementaryData1 supplementaryData = default(OBSupplementaryData1))
        {
            // to ensure "frequency" is required (not null)
            if (frequency == null)
            {
                throw new InvalidDataException("frequency is a required property for OBDomesticStandingOrder3 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("firstPaymentDateTime is a required property for OBDomesticStandingOrder3 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("firstPaymentAmount is a required property for OBDomesticStandingOrder3 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditorAccount is a required property for OBDomesticStandingOrder3 and cannot be null");
            }
            else
            {
