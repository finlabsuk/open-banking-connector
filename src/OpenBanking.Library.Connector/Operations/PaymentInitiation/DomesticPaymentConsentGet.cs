...
{
    internal class
        DomesticPaymentConsentGet : ConsentRead<DomesticPaymentConsentPersisted, DomesticPaymentConsentResponse,
            PaymentInitiationModelsPublic.OBWriteDomesticConsentResponse5, ConsentReadParams>
    {
