...
internal class BalanceGet : IAccountAccessConsentExternalRead<BalancesResponse, AccountAccessConsentExternalReadParams>
{
        ...
        ReadAsync(AccountAccessConsentExternalReadParams readParams)
    {
        ...
        ReadWriteGetCustomBehaviour?
            readWriteGetCustomBehaviour = customBehaviour?.BalanceGet;
        ...
        var tppReportingRequestInfo = new TppReportingRequestInfo
        {
            EndpointDescription = readParams.ExternalApiAccountId is null
                ? "GET {AispBaseUrl}/balances"
                : "GET {AispBaseUrl}/accounts/{AccountId}/balances",
            BankProfile = bankProfile.BankProfileEnum
        };
        (AccountAndTransactionModelsPublic.OBReadBalance1 externalApiResponse, string? xFapiInteractionId,
