    ...
    TransactionGet : IAccountAccessConsentExternalRead<TransactionsResponse, TransactionsReadParams>
{
        ...
        ReadAsync(TransactionsReadParams readParams)
    {
        ...
        ReadWriteGetCustomBehaviour?
            readWriteGetCustomBehaviour = customBehaviour?.TransactionGet;
        ...
        string urlStringWihoutQuery = (externalAccountId: readParams.ExternalApiAccountId,
        ...
        var tppReportingRequestInfo = new TppReportingRequestInfo
        {
            EndpointDescription = readParams.ExternalApiAccountId is null
                ? "GET {AispBaseUrl}/transactions"
                : "GET {AispBaseUrl}/accounts/{AccountId}/transactions",
            BankProfile = bankProfile.BankProfileEnum
        };

        (AccountAndTransactionModelsPublic.OBReadTransaction6 externalApiResponse, string? xFapiInteractionId,
