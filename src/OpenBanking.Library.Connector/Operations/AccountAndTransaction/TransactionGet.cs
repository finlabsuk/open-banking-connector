...
{
    internal class
        TransactionGet : ApiEntityGet<TransactionsResponse, AccountAndTransactionModelsPublic.OBReadTransaction6>
    {
        ...
        protected override string RelativePath => "/transactions";

        protected override string RelativePath2 => "/transactions";
