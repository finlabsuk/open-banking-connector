...
{
    internal class Party2Get : ApiEntityGet<Parties2Response, AccountAndTransactionModelsPublic.OBReadParty3>
    {
        public Party2Get(
        ...
        protected override string RelativePath => "/parties";
        protected override string RelativePath2 => "/parties";
