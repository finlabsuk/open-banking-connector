...
internal class Party2Get : IAccountAccessConsentExternalRead<Parties2Response, ExternalEntityReadParams>
{
        ...
        ReadAsync(ExternalEntityReadParams readParams)
    {
        ...
        IApiGetRequests<OBReadParty3> apiRequests = accountAndTransactionApi.AccountAndTransactionApiVersion switch
        {
            AccountAndTransactionApiVersion.Version3p1p7 => new ApiGetRequests<
                OBReadParty3,
                BankApiModels.UkObRw.V3p1p7.Aisp.Models.OBReadParty3>(
                new ApiGetRequestProcessor(bankFinancialId, accessToken)),
            AccountAndTransactionApiVersion.Version3p1p10 => new ApiGetRequests<
                OBReadParty3,
                OBReadParty3>(new ApiGetRequestProcessor(bankFinancialId, accessToken)),
            _ => throw new ArgumentOutOfRangeException(
                $"AISP API version {accountAndTransactionApi.AccountAndTransactionApiVersion} not supported.")
        };
        OBReadParty3 apiResponse;
        ...
        var response = new Parties2Response(apiResponse);
