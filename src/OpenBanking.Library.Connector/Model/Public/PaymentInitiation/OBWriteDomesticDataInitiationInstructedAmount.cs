...
namespace FinnovationLabs.OpenBanking.Library.Connector.Model.Public.PaymentInitiation
{
    ...
    ///     chain.
    /// </summary>
    [OpenBankingEquivalent(typeof(OBInternational2InstructedAmount), EquivalentTypeMapper = typeof(OBWriteDomesticDataInitiationInstructedAmountConverter))]
    [PersistenceEquivalent(typeof(Persistent.PaymentInitiation.OBWriteDomesticDataInitiationInstructedAmount))]
