...
namespace FinnovationLabs.OpenBanking.Library.Connector.Model.Public.PaymentInitiation
{
    ...
    ///     transaction.
    /// </summary>
    [OpenBankingEquivalent(typeof(OBCashAccountDebtor4), EquivalentTypeMapper = typeof(OBWriteDomesticDataInitiationDebtorAccountConverter))]
    [PersistenceEquivalent(typeof(Persistent.PaymentInitiation.OBWriteDomesticDataInitiationDebtorAccount))]
