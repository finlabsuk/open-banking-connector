...
public class Bank : Base, ISupportsValidation
{
    ...
    ///     Normally null which means value obtained from BankProfile.
    /// </summary>
    public bool? AllowNullRegistrationEndpoint { get; set; }
    ...
    /// <summary>
    ///     ID token "sub" claim type. Determined by how bank uses ID token. Normally null which means value obtained from
    ///     BankProfile.
    /// </summary>
