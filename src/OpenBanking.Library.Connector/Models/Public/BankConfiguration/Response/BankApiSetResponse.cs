...
namespace FinnovationLabs.OpenBanking.Library.Connector.Models.Public.BankConfiguration.Response
{
    ...
    {
        public BankApiSetResponse(Guid id, string? name, DateTimeOffset created, string? createdBy, Guid bankId, PaymentInitiationApi? paymentInitiationApi, VariableRecurringPaymentsApi? variableRecurringPaymentsApi) : base(id, name, created, createdBy)
        {
            BankId = bankId;
