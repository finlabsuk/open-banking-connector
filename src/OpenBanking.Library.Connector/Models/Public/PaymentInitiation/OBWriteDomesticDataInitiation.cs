...
namespace FinnovationLabs.OpenBanking.Library.Connector.Models.Public.PaymentInitiation
{
    ...
    /// </summary>
    [OpenBankingEquivalent(typeof(OBDomestic2), EquivalentTypeMapper = typeof(OBWriteDomesticDataInitiationConverter))]
    [OpenBankingEquivalent(typeof(OBWriteFile2DataInitiation))]
    [PersistenceEquivalent(typeof(Persistent.PaymentInitiation.OBWriteDomesticDataInitiation))]
