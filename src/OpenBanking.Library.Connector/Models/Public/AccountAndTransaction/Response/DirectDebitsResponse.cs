...
/// <summary>
///     Response to Direct Debit read requests
/// </summary>
public class DirectDebitsResponse : BaseResponse
{
    /// <summary>
    ///     Response object OBReadDirectDebit2 from UK Open Banking Read-Write Account and Transaction API spec
    ///     <a
    ...
    /// </summary>
    public required AccountAndTransactionModelsPublic.OBReadDirectDebit2 ExternalApiResponse { get; init; }
