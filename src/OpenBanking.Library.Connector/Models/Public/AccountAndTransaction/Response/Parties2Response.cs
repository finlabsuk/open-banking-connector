...
{
    /// <summary>
    ///     Response to Parties read requests
    /// </summary>
    public class Parties2Response
    {
        internal Parties2Response(OBReadParty3 externalApiResponse, IList<string>? warnings)
        {
        ...
        /// </summary>
        public OBReadParty3 ExternalApiResponse { get; }
