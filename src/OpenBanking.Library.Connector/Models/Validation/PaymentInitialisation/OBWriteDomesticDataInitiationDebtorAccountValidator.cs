...
{
    public class
        OBWriteDomesticDataInitiationDebtorAccountValidator : AbstractValidator<
            OBWriteDomesticDataInitiationDebtorAccount>
    {
        public OBWriteDomesticDataInitiationDebtorAccountValidator()
        {
