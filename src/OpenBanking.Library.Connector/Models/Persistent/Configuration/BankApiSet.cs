    ...
    internal class BankApiSet : Base<Persistent.BankApiSet>
    {
        ...
        public override void Configure(EntityTypeBuilder<Persistent.BankApiSet> builder)
        {
            ...
            builder.Property(e => e.PaymentInitiationApiBaseUrl)
                .Metadata.SetAfterSaveBehavior(PropertySaveBehavior.Throw);
            builder.Property(e => e.AccountAndTransactionApiVersion)
                .HasConversion(new EnumToStringConverter<AccountAndTransactionApiVersionEnum>())
                .Metadata.SetAfterSaveBehavior(PropertySaveBehavior.Throw);
            builder.Property(e => e.AccountAndTransactionBaseUrl)
                .Metadata.SetAfterSaveBehavior(PropertySaveBehavior.Throw);
