...
namespace FinnovationLabs.OpenBanking.Library.Connector.Migrations.PostgreSql
{
    ...
    [Migration("20231216190658_AddSoftwareStatementTable")]
    partial class AddSoftwareStatementTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinnovationLabs.OpenBanking.Library.Connector.Models.Persistent.BankConfiguration.ObSealCertificateEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FinnovationLabs.OpenBanking.Library.Connector.Models.Persistent.BankConfiguration.ObWacCertificateEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FinnovationLabs.OpenBanking.Library.Connector.Models.Persistent.BankConfiguration.SoftwareStatementEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FinnovationLabs.OpenBanking.Library.Connector.Models.Persistent.BankConfiguration.BankRegistration", b =>
                {
                    b.HasOne("FinnovationLabs.OpenBanking.Library.Connector.Models.Persistent.BankConfiguration.SoftwareStatementEntity", "SoftwareStatementNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("FinnovationLabs.OpenBanking.Library.Connector.Models.Persistent.BankConfiguration.SoftwareStatementEntity", b =>
                {
                    b.HasOne("FinnovationLabs.OpenBanking.Library.Connector.Models.Persistent.BankConfiguration.ObSealCertificateEntity", "DefaultObSealCertificateNavigation")
                        .WithMany()
                        .HasForeignKey("DefaultObSealCertificateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_software_statement_ob_seal_certificate_default_ob_seal_certifi");

                    b.HasOne("FinnovationLabs.OpenBanking.Library.Connector.Models.Persistent.BankConfiguration.ObWacCertificateEntity", "DefaultObWacCertificateNavigation")
                        .WithMany()
                        .HasForeignKey("DefaultObWacCertificateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_software_statement_ob_wac_certificate_default_ob_wac_certifica");
