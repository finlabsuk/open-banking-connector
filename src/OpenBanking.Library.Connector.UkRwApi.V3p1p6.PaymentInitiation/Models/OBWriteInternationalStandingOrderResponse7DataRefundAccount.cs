...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrderResponse7DataRefundAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalStandingOrderResponse7DataRefundAccount class.
        /// </summary>
        public OBWriteInternationalStandingOrderResponse7DataRefundAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalStandingOrderResponse7DataRefundAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
