...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsentResponse6DataInitiationRemittanceInformation
    {
        /// <summary>
        ...
        /// be mapped.</param>
        public OBWriteInternationalConsentResponse6DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
