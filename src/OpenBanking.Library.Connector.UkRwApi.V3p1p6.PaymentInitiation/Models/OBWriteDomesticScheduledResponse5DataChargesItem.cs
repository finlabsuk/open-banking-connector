...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// initiation.
    /// </summary>
    public partial class OBWriteDomesticScheduledResponse5DataChargesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledResponse5DataChargesItem class.
        /// </summary>
        public OBWriteDomesticScheduledResponse5DataChargesItem()
        {
            CustomInit();
        }
        ...
        /// 'Shared'</param>
        public OBWriteDomesticScheduledResponse5DataChargesItem(OBChargeBearerType1CodeEnum chargeBearer, string type, OBActiveOrHistoricCurrencyAndAmount amount)
        {
