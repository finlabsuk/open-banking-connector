...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [SourceApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomesticResponse4DataRefundAccount))]
    public partial class OBWriteDomesticResponse5DataRefundAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticResponse5DataRefundAccount class.
        /// </summary>
        ...
        public OBWriteDomesticResponse5DataRefundAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
