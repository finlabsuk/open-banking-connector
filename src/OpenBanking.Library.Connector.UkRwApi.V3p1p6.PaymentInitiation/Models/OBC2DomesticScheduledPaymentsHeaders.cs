...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2DomesticScheduledPaymentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBC2DomesticScheduledPaymentsHeaders class.
        /// </summary>
        public OBC2DomesticScheduledPaymentsHeaders()
        {
            CustomInit();
        }
        ...
        public OBC2DomesticScheduledPaymentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
