...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [TargetApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomestic2DataInitiationCreditorAccount))]
    [SourceApiEquivalent(typeof(OBWriteDomesticConsent4DataInitiationCreditorAccount))]
    public partial class OBWriteDomestic2DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomestic2DataInitiationCreditorAccount class.
        /// </summary>
        ...
        public OBWriteDomestic2DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
