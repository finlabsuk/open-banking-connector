...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrderResponse7DataInitiationDebtorAccount
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteInternationalStandingOrderResponse7DataInitiationDebtorAccount()
        {
            CustomInit();
        }
        ...
        /// the account.</param>
        public OBWriteInternationalStandingOrderResponse7DataInitiationDebtorAccount(string schemeName, string identification, string name = default(string), string secondaryIdentification = default(string))
        {
