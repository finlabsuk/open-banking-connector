...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2InternationalPaymentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OBC2InternationalPaymentsHeaders
        /// class.
        /// </summary>
        public OBC2InternationalPaymentsHeaders()
        {
            CustomInit();
        }
        ...
        public OBC2InternationalPaymentsHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
