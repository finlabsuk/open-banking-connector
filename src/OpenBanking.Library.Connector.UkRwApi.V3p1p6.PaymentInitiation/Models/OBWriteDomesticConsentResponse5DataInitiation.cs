...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [SourceApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomesticConsentResponse4DataInitiation))]
    [SourceApiEquivalent(typeof(V3p1p6.PaymentInitiation.Models.OBWriteDomesticConsent4DataInitiation))]
    public partial class OBWriteDomesticConsentResponse5DataInitiation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticConsentResponse5DataInitiation class.
        /// </summary>
        public OBWriteDomesticConsentResponse5DataInitiation()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticConsentResponse5DataInitiation(string instructionIdentification, string endToEndIdentification, OBWriteDomesticConsentResponse5DataInitiationInstructedAmount instructedAmount, OBWriteDomesticConsentResponse5DataInitiationCreditorAccount creditorAccount, string localInstrument = default(string), OBWriteDomesticConsentResponse5DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticConsentResponse5DataInitiationDebtorAccount), OBPostalAddress6 creditorPostalAddress = default(OBPostalAddress6), OBWriteDomesticConsentResponse5DataInitiationRemittanceInformation remittanceInformation = default(OBWriteDomesticConsentResponse5DataInitiationRemittanceInformation), IDictionary<string, object> supplementaryData = default(IDictionary<string, object>))
        {
