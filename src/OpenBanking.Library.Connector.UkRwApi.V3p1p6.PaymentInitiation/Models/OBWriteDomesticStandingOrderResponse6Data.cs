...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    public partial class OBWriteDomesticStandingOrderResponse6Data
    {
        ...
        public OBWriteDomesticStandingOrderResponse6Data(string domesticStandingOrderId, string consentId, System.DateTimeOffset creationDateTime, OBWriteDomesticStandingOrderResponse6DataStatusEnum status, System.DateTimeOffset statusUpdateDateTime, OBWriteDomesticStandingOrderResponse6DataInitiation initiation, OBWriteDomesticStandingOrderResponse6DataRefund refund = default(OBWriteDomesticStandingOrderResponse6DataRefund), IList<OBWriteDomesticStandingOrderResponse6DataChargesItem> charges = default(IList<OBWriteDomesticStandingOrderResponse6DataChargesItem>), OBWriteDomesticStandingOrderResponse6DataMultiAuthorisation multiAuthorisation = default(OBWriteDomesticStandingOrderResponse6DataMultiAuthorisation), OBDebtorIdentification1 debtor = default(OBDebtorIdentification1))
        {
