...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    public partial class OBWriteDomesticStandingOrderConsentResponse6
    {
        ...
        /// OBWriteDomesticStandingOrderConsentResponse6 class.
        /// </summary>
        public OBWriteDomesticStandingOrderConsentResponse6(OBWriteDomesticStandingOrderConsentResponse6Data data, OBRisk1 risk, Links links = default(Links), Meta meta = default(Meta))
        {
            Data = data;
            Risk = risk;
            Links = links;
