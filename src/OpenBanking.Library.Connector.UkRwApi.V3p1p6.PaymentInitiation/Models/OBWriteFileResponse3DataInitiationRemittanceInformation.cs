...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteFileResponse3DataInitiationRemittanceInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteFileResponse3DataInitiationRemittanceInformation class.
        /// </summary>
        ...
        /// be mapped.</param>
        public OBWriteFileResponse3DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
