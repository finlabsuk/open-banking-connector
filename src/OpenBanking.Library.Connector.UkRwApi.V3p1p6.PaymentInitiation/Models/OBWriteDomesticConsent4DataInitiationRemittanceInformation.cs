...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [TargetApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomesticConsent4DataInitiationRemittanceInformation))]
    public partial class OBWriteDomesticConsent4DataInitiationRemittanceInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticConsent4DataInitiationRemittanceInformation class.
        /// </summary>
        public OBWriteDomesticConsent4DataInitiationRemittanceInformation()
        {
            CustomInit();
        }
        ...
        /// be mapped.</param>
        public OBWriteDomesticConsent4DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
