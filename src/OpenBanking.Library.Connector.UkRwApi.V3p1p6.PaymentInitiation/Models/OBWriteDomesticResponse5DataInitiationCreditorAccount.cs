...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [SourceApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomesticResponse4DataInitiationCreditorAccount))]
    public partial class OBWriteDomesticResponse5DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticResponse5DataInitiationCreditorAccount class.
        /// </summary>
        public OBWriteDomesticResponse5DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticResponse5DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
