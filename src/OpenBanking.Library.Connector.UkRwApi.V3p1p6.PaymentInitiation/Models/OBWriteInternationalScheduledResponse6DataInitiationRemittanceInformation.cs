...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledResponse6DataInitiationRemittanceInformation
    {
        /// <summary>
        ...
        /// be mapped.</param>
        public OBWriteInternationalScheduledResponse6DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
