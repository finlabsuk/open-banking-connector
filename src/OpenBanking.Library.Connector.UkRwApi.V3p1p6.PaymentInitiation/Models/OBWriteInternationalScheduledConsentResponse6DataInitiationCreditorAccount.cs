...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledConsentResponse6DataInitiationCreditorAccount
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteInternationalScheduledConsentResponse6DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalScheduledConsentResponse6DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
