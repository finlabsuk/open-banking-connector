...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteFileConsentResponse4DataInitiationRemittanceInformation
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteFileConsentResponse4DataInitiationRemittanceInformation()
        {
            CustomInit();
        }
        ...
        /// be mapped.</param>
        public OBWriteFileConsentResponse4DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
