...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalConsent5DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalConsent5DataInitiationCreditorAccount class.
        /// </summary>
        public OBWriteInternationalConsent5DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalConsent5DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
