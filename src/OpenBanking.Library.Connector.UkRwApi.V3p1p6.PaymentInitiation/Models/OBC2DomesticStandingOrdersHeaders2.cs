...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2DomesticStandingOrdersHeaders2
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBC2DomesticStandingOrdersHeaders2 class.
        /// </summary>
        public OBC2DomesticStandingOrdersHeaders2()
        {
            CustomInit();
        }
        ...
        public OBC2DomesticStandingOrdersHeaders2(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
