...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// initiation.
    /// </summary>
    public partial class OBWriteFileConsentResponse4DataChargesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteFileConsentResponse4DataChargesItem class.
        /// </summary>
        public OBWriteFileConsentResponse4DataChargesItem()
        {
            CustomInit();
        }
        ...
        /// 'Shared'</param>
        public OBWriteFileConsentResponse4DataChargesItem(OBChargeBearerType1CodeEnum chargeBearer, string type, OBActiveOrHistoricCurrencyAndAmount amount)
        {
