...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduled3DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalScheduled3DataInitiationCreditorAccount class.
        /// </summary>
        public OBWriteInternationalScheduled3DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalScheduled3DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
