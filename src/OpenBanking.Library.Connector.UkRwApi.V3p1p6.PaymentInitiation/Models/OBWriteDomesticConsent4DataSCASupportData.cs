...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [TargetApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomesticConsent4DataSCASupportData))]
    public partial class OBWriteDomesticConsent4DataSCASupportData
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticConsent4DataSCASupportData class.
        /// </summary>
        public OBWriteDomesticConsent4DataSCASupportData()
        {
            CustomInit();
        }
        ...
        /// occurrence.</param>
        public OBWriteDomesticConsent4DataSCASupportData(OBWriteDomesticConsent4DataSCASupportDataRequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(OBWriteDomesticConsent4DataSCASupportDataRequestedSCAExemptionTypeEnum?), OBWriteDomesticConsent4DataSCASupportDataAppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(OBWriteDomesticConsent4DataSCASupportDataAppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        public OBWriteDomesticConsent4DataSCASupportDataRequestedSCAExemptionTypeEnum? RequestedSCAExemptionType { get; set; }
        ...
        public OBWriteDomesticConsent4DataSCASupportDataAppliedAuthenticationApproachEnum? AppliedAuthenticationApproach { get; set; }
