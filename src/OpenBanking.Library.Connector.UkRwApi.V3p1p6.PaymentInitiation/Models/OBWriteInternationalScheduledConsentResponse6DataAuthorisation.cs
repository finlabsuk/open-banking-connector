...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalScheduledConsentResponse6DataAuthorisation
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteInternationalScheduledConsentResponse6DataAuthorisation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalScheduledConsentResponse6DataAuthorisation(OBWriteInternationalScheduledConsentResponse6DataAuthorisationAuthorisationTypeEnum authorisationType, System.DateTimeOffset? completionDateTime = default(System.DateTimeOffset?))
        {
        ...
        public OBWriteInternationalScheduledConsentResponse6DataAuthorisationAuthorisationTypeEnum AuthorisationType { get; set; }
