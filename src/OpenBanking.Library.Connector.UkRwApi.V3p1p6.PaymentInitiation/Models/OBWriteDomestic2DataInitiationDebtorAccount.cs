...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [TargetApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomestic2DataInitiationDebtorAccount))]
    [SourceApiEquivalent(typeof(OBWriteDomesticConsent4DataInitiationDebtorAccount))]
    public partial class OBWriteDomestic2DataInitiationDebtorAccount
    {
        /// <summary>
        ...
        /// the account.</param>
        public OBWriteDomestic2DataInitiationDebtorAccount(string schemeName, string identification, string name = default(string), string secondaryIdentification = default(string))
        {
