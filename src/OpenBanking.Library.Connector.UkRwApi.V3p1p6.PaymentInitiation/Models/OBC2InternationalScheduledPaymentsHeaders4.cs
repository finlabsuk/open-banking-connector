...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2InternationalScheduledPaymentsHeaders4
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBC2InternationalScheduledPaymentsHeaders4 class.
        /// </summary>
        public OBC2InternationalScheduledPaymentsHeaders4()
        {
            CustomInit();
        }
        ...
        public OBC2InternationalScheduledPaymentsHeaders4(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
