...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticScheduledConsent4DataInitiationRemittanceInformation
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteDomesticScheduledConsent4DataInitiationRemittanceInformation()
        {
            CustomInit();
        }
        ...
        /// be mapped.</param>
        public OBWriteDomesticScheduledConsent4DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
