...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteFileConsentResponse4DataInitiationDebtorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteFileConsentResponse4DataInitiationDebtorAccount class.
        /// </summary>
        public OBWriteFileConsentResponse4DataInitiationDebtorAccount()
        {
            CustomInit();
        }
        ...
        /// the account.</param>
        public OBWriteFileConsentResponse4DataInitiationDebtorAccount(string schemeName, string identification, string name = default(string), string secondaryIdentification = default(string))
        {
