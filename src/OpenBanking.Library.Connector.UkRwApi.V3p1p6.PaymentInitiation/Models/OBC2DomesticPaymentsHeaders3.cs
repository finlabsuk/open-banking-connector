...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBC2DomesticPaymentsHeaders3
    {
        /// <summary>
        /// Initializes a new instance of the OBC2DomesticPaymentsHeaders3
        /// class.
        /// </summary>
        public OBC2DomesticPaymentsHeaders3()
        {
            CustomInit();
        }
        ...
        public OBC2DomesticPaymentsHeaders3(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
