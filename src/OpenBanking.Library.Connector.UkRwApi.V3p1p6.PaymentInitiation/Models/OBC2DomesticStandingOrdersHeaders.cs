...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// <summary>
    /// Defines headers for Domestic Standing Orders operation.
    /// </summary>
    public partial class OBC2DomesticStandingOrdersHeaders
    {
        /// <summary>
        /// Initializes a new instance of the OBC2DomesticStandingOrdersHeaders
        /// class.
        /// </summary>
        public OBC2DomesticStandingOrdersHeaders()
        {
            CustomInit();
        }
        ...
        public OBC2DomesticStandingOrdersHeaders(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
