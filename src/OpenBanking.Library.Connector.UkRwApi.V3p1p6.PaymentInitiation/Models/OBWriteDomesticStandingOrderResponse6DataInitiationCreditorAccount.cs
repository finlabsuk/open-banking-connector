...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderResponse6DataInitiationCreditorAccount
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteDomesticStandingOrderResponse6DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticStandingOrderResponse6DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
