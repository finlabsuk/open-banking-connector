...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// initiation.
    /// </summary>
    public partial class OBWriteInternationalResponse5DataChargesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalResponse5DataChargesItem class.
        /// </summary>
        public OBWriteInternationalResponse5DataChargesItem()
        {
            CustomInit();
        }
        ...
        /// 'Shared'</param>
        public OBWriteInternationalResponse5DataChargesItem(OBChargeBearerType1CodeEnum chargeBearer, string type, OBActiveOrHistoricCurrencyAndAmount amount)
        {
