...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// <summary>
    /// Defines headers for Payment Details operation.
    /// </summary>
    public partial class OBC2PaymentDetailsHeaders1
    {
        /// <summary>
        /// Initializes a new instance of the OBC2PaymentDetailsHeaders1 class.
        /// </summary>
        public OBC2PaymentDetailsHeaders1()
        {
            CustomInit();
        }
        ...
        public OBC2PaymentDetailsHeaders1(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
