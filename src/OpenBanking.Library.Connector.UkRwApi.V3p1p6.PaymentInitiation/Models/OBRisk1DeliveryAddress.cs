...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [SourceApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBRisk1DeliveryAddress),
    ...
    [TargetApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBRisk1DeliveryAddress),
        ValueMappingSourceMembers = new string[]
        {
            "CountrySubDivision",
        },
