...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteFileConsentResponse4DataSCASupportData
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteFileConsentResponse4DataSCASupportData class.
        /// </summary>
        public OBWriteFileConsentResponse4DataSCASupportData()
        {
            CustomInit();
        }
        ...
        /// occurrence.</param>
        public OBWriteFileConsentResponse4DataSCASupportData(OBWriteFileConsentResponse4DataSCASupportDataRequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(OBWriteFileConsentResponse4DataSCASupportDataRequestedSCAExemptionTypeEnum?), OBWriteFileConsentResponse4DataSCASupportDataAppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(OBWriteFileConsentResponse4DataSCASupportDataAppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        public OBWriteFileConsentResponse4DataSCASupportDataRequestedSCAExemptionTypeEnum? RequestedSCAExemptionType { get; set; }
        ...
        public OBWriteFileConsentResponse4DataSCASupportDataAppliedAuthenticationApproachEnum? AppliedAuthenticationApproach { get; set; }
