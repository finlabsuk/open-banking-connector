...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalResponse5DataRefundAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteInternationalResponse5DataRefundAccount class.
        /// </summary>
        ...
        public OBWriteInternationalResponse5DataRefundAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
