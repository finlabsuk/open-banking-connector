...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteInternationalStandingOrderConsentResponse7DataAuthorisation
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public OBWriteInternationalStandingOrderConsentResponse7DataAuthorisation()
        {
            CustomInit();
        }
        ...
        public OBWriteInternationalStandingOrderConsentResponse7DataAuthorisation(OBWriteInternationalStandingOrderConsentResponse7DataAuthorisationAuthorisationTypeEnum authorisationType, System.DateTimeOffset? completionDateTime = default(System.DateTimeOffset?))
        {
        ...
        public OBWriteInternationalStandingOrderConsentResponse7DataAuthorisationAuthorisationTypeEnum AuthorisationType { get; set; }
