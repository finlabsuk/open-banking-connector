...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    public partial class OBWriteDomesticScheduledConsentResponse5
    {
        ...
        /// OBWriteDomesticScheduledConsentResponse5 class.
        /// </summary>
        public OBWriteDomesticScheduledConsentResponse5(OBWriteDomesticScheduledConsentResponse5Data data, OBRisk1 risk, Links links = default(Links), Meta meta = default(Meta))
        {
            Data = data;
            Risk = risk;
            Links = links;
