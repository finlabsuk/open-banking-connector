...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [TargetApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomestic2DataInitiation))]
    [SourceApiEquivalent(typeof(OBWriteDomesticConsent4DataInitiation))]
