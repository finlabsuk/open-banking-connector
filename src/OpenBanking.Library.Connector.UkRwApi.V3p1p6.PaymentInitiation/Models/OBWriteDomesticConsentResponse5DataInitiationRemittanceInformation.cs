...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [SourceApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomesticConsentResponse4DataInitiationRemittanceInformation))]
    [SourceApiEquivalent(typeof(V3p1p6.PaymentInitiation.Models.OBWriteDomesticConsent4DataInitiationRemittanceInformation))]
    public partial class OBWriteDomesticConsentResponse5DataInitiationRemittanceInformation
    {
        /// <summary>
        ...
        /// be mapped.</param>
        public OBWriteDomesticConsentResponse5DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
