...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [SourceApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomesticConsentResponse4DataAuthorisation))]
    public partial class OBWriteDomesticConsentResponse5DataAuthorisation
    {
        /// <summary>
        ...
        public OBWriteDomesticConsentResponse5DataAuthorisationAuthorisationTypeEnum AuthorisationType { get; set; }
