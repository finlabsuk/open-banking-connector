...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [SourceApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomesticConsentResponse4DataInitiationCreditorAccount))]
    [SourceApiEquivalent(typeof(V3p1p6.PaymentInitiation.Models.OBWriteDomesticConsent4DataInitiationCreditorAccount))]
    public partial class OBWriteDomesticConsentResponse5DataInitiationCreditorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticConsentResponse5DataInitiationCreditorAccount class.
        /// </summary>
        public OBWriteDomesticConsentResponse5DataInitiationCreditorAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticConsentResponse5DataInitiationCreditorAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
