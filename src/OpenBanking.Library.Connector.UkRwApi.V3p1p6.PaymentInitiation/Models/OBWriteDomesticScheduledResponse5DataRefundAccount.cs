...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticScheduledResponse5DataRefundAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticScheduledResponse5DataRefundAccount class.
        /// </summary>
        public OBWriteDomesticScheduledResponse5DataRefundAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticScheduledResponse5DataRefundAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
