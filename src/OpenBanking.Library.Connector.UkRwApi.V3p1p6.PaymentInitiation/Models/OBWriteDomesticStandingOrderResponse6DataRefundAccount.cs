...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    public partial class OBWriteDomesticStandingOrderResponse6DataRefundAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticStandingOrderResponse6DataRefundAccount class.
        /// </summary>
        public OBWriteDomesticStandingOrderResponse6DataRefundAccount()
        {
            CustomInit();
        }
        ...
        public OBWriteDomesticStandingOrderResponse6DataRefundAccount(string schemeName, string identification, string name, string secondaryIdentification = default(string))
        {
