...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// <summary>
    /// Defines headers for International Standing Orders operation.
    /// </summary>
    public partial class OBC2InternationalStandingOrdersHeaders1
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBC2InternationalStandingOrdersHeaders1 class.
        /// </summary>
        public OBC2InternationalStandingOrdersHeaders1()
        {
            CustomInit();
        }
        ...
        public OBC2InternationalStandingOrdersHeaders1(string xFapiInteractionId = default(string), string xJwsSignature = default(string), int? retryAfter = default(int?))
        {
