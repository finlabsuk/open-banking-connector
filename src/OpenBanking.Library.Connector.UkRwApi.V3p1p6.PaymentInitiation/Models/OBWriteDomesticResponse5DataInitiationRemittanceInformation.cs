...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [SourceApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomesticResponse4DataInitiationRemittanceInformation))]
    public partial class OBWriteDomesticResponse5DataInitiationRemittanceInformation
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticResponse5DataInitiationRemittanceInformation class.
        /// </summary>
        ...
        /// be mapped.</param>
        public OBWriteDomesticResponse5DataInitiationRemittanceInformation(string unstructured = default(string), string reference = default(string))
        {
