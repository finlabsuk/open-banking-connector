...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    public partial class OBWriteInternationalScheduledResponse6Data
    {
        ...
        public OBWriteInternationalScheduledResponse6Data(string internationalScheduledPaymentId, string consentId, System.DateTimeOffset creationDateTime, OBWriteInternationalScheduledResponse6DataStatusEnum status, System.DateTimeOffset statusUpdateDateTime, OBWriteInternationalScheduledResponse6DataInitiation initiation, System.DateTimeOffset? expectedExecutionDateTime = default(System.DateTimeOffset?), System.DateTimeOffset? expectedSettlementDateTime = default(System.DateTimeOffset?), OBWriteInternationalScheduledResponse6DataRefund refund = default(OBWriteInternationalScheduledResponse6DataRefund), IList<OBWriteInternationalScheduledResponse6DataChargesItem> charges = default(IList<OBWriteInternationalScheduledResponse6DataChargesItem>), OBWriteInternationalScheduledResponse6DataExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalScheduledResponse6DataExchangeRateInformation), OBWriteInternationalScheduledResponse6DataMultiAuthorisation multiAuthorisation = default(OBWriteInternationalScheduledResponse6DataMultiAuthorisation), OBDebtorIdentification1 debtor = default(OBDebtorIdentification1))
        {
