...
namespace FinnovationLabs.OpenBanking.Library.Connector.UkRwApi.V3p1p6.PaymentInitiation.Models
{
    ...
    /// </summary>
    [SourceApiEquivalent(typeof(V3p1p4.PaymentInitiation.Models.OBWriteDomesticConsentResponse4DataInitiationDebtorAccount))]
    [SourceApiEquivalent(typeof(V3p1p6.PaymentInitiation.Models.OBWriteDomesticConsent4DataInitiationDebtorAccount))]
    public partial class OBWriteDomesticConsentResponse5DataInitiationDebtorAccount
    {
        /// <summary>
        /// Initializes a new instance of the
        /// OBWriteDomesticConsentResponse5DataInitiationDebtorAccount class.
        /// </summary>
        public OBWriteDomesticConsentResponse5DataInitiationDebtorAccount()
        {
            CustomInit();
        }
        ...
        /// the account.</param>
        public OBWriteDomesticConsentResponse5DataInitiationDebtorAccount(string schemeName, string identification, string name = default(string), string secondaryIdentification = default(string))
        {
