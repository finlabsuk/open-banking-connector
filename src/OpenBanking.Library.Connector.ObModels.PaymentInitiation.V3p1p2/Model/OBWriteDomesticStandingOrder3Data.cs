...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteDomesticStandingOrder3Data :  IEquatable<OBWriteDomesticStandingOrder3Data>, IValidatableObject
    {
        ...
        public OBWriteDomesticStandingOrder3Data(string consentId = default(string), OBWriteDomesticStandingOrderResponse4DataInitiation initiation = default(OBWriteDomesticStandingOrderResponse4DataInitiation))
        {
            // to ensure "consentId" is required (not null)
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDomesticStandingOrder3Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDomesticStandingOrder3Data and cannot be null");
            }
            else
            {
