...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalConsent3DataInitiationExchangeRateInformation :  IEquatable<OBWriteInternationalConsent3DataInitiationExchangeRateInformation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalConsent3DataInitiationExchangeRateInformation" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalConsent3DataInitiationExchangeRateInformation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalConsent3DataInitiationExchangeRateInformation" /> class.
        /// </summary>
        ...
        public OBWriteInternationalConsent3DataInitiationExchangeRateInformation(decimal? exchangeRate = default(decimal?), RateTypeEnum rateType = default(RateTypeEnum), string unitCurrency = default(string), string contractIdentification = default(string))
        {
            // to ensure "rateType" is required (not null)
            if (rateType == null)
            {
                throw new InvalidDataException("rateType is a required property for OBWriteInternationalConsent3DataInitiationExchangeRateInformation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("unitCurrency is a required property for OBWriteInternationalConsent3DataInitiationExchangeRateInformation and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteInternationalConsent3DataInitiationExchangeRateInformation);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalConsent3DataInitiationExchangeRateInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalConsent3DataInitiationExchangeRateInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalConsent3DataInitiationExchangeRateInformation input)
        {
            if (input == null)
                return false;
