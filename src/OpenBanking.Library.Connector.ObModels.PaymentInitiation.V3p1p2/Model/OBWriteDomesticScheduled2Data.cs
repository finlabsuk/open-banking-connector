...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticScheduled2Data :  IEquatable<OBWriteDomesticScheduled2Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticScheduled2Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticScheduled2Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticScheduled2Data" /> class.
        /// </summary>
        ...
        public OBWriteDomesticScheduled2Data(string consentId = default(string), OBWriteDomesticScheduled2DataInitiation initiation = default(OBWriteDomesticScheduled2DataInitiation))
        {
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteDomesticScheduled2Data and cannot be null");
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDomesticScheduled2Data and cannot be null");
        }
        ...
        {
            return this.Equals(input as OBWriteDomesticScheduled2Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticScheduled2Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticScheduled2Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticScheduled2Data input)
        {
            if (input == null)
                return false;
