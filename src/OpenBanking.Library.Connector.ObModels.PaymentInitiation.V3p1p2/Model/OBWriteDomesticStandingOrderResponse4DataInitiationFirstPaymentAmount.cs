...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount :  IEquatable<OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount" /> class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount(string amount = default(string), string currency = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount {\n");
        ...
        {
            return this.Equals(input as OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticStandingOrderResponse4DataInitiationFirstPaymentAmount input)
        {
            if (input == null)
                return false;
