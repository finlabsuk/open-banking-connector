...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount :  IEquatable<OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount" /> class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount(string secondaryIdentification = default(string), string schemeName = default(string), string identification = default(string), string name = default(string))
        {
            // to ensure "schemeName" is required (not null)
            if (schemeName == null)
            {
                throw new InvalidDataException("schemeName is a required property for OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("identification is a required property for OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticStandingOrderResponse4DataInitiationCreditorAccount input)
        {
            if (input == null)
                return false;
