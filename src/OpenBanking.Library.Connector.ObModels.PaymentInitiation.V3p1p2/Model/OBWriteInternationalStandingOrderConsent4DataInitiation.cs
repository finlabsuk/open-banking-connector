...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalStandingOrderConsent4DataInitiation :  IEquatable<OBWriteInternationalStandingOrderConsent4DataInitiation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalStandingOrderConsent4DataInitiation" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalStandingOrderConsent4DataInitiation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalStandingOrderConsent4DataInitiation" /> class.
        /// </summary>
        ...
        public OBWriteInternationalStandingOrderConsent4DataInitiation(OBSupplementaryData1 supplementaryData = default(OBSupplementaryData1), OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount debtorAccount = default(OBWriteDomesticStandingOrderResponse4DataInitiationDebtorAccount), OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAgent creditorAgent = default(OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAgent), string reference = default(string), string currencyOfTransfer = default(string), OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount creditorAccount = default(OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount), string purpose = default(string), OBChargeBearerType1Code? chargeBearer = default(OBChargeBearerType1Code?), DateTime? finalPaymentDateTime = default(DateTime?), string frequency = default(string), DateTime? firstPaymentDateTime = default(DateTime?), string numberOfPayments = default(string), OBWriteInternationalConsent3DataInitiationCreditor creditor = default(OBWriteInternationalConsent3DataInitiationCreditor), OBWriteDomesticScheduled2DataInitiationInstructedAmount instructedAmount = default(OBWriteDomesticScheduled2DataInitiationInstructedAmount))
        {
            // to ensure "currencyOfTransfer" is required (not null)
            if (currencyOfTransfer == null)
            {
                throw new InvalidDataException("currencyOfTransfer is a required property for OBWriteInternationalStandingOrderConsent4DataInitiation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditorAccount is a required property for OBWriteInternationalStandingOrderConsent4DataInitiation and cannot be null");
            }
            else
            {
            ...
            if (frequency == null)
            {
                throw new InvalidDataException("frequency is a required property for OBWriteInternationalStandingOrderConsent4DataInitiation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("firstPaymentDateTime is a required property for OBWriteInternationalStandingOrderConsent4DataInitiation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("instructedAmount is a required property for OBWriteInternationalStandingOrderConsent4DataInitiation and cannot be null");
            }
            else
            {
        ...
        public OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAgent CreditorAgent { get; set; }
        ...
        public OBWriteInternationalStandingOrderConsent4DataInitiationCreditorAccount CreditorAccount { get; set; }
        ...
        {
            return this.Equals(input as OBWriteInternationalStandingOrderConsent4DataInitiation);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalStandingOrderConsent4DataInitiation instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalStandingOrderConsent4DataInitiation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalStandingOrderConsent4DataInitiation input)
        {
            if (input == null)
                return false;
