...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount :  IEquatable<OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount" /> class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount(string amount = default(string), string currency = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount {\n");
        ...
        {
            return this.Equals(input as OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticStandingOrderResponse4DataInitiationFinalPaymentAmount input)
        {
            if (input == null)
                return false;
