...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteFileConsentResponse3Data :  IEquatable<OBWriteFileConsentResponse3Data>, IValidatableObject
    {
        ...
        public OBWriteFileConsentResponse3Data(StatusEnum status = default(StatusEnum), DateTime? statusUpdateDateTime = default(DateTime?), OBWriteFileConsent3DataSCASupportData sCASupportData = default(OBWriteFileConsent3DataSCASupportData), DateTime? creationDateTime = default(DateTime?), DateTime? cutOffDateTime = default(DateTime?), OBWriteFileConsent3DataAuthorisation authorisation = default(OBWriteFileConsent3DataAuthorisation), List<OBWriteDomesticStandingOrderResponse4DataCharges> charges = default(List<OBWriteDomesticStandingOrderResponse4DataCharges>), string consentId = default(string), OBWriteFile2DataInitiation initiation = default(OBWriteFile2DataInitiation))
        {
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteFileConsentResponse3Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteFileConsentResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteFileConsentResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteFileConsentResponse3Data and cannot be null");
            }
            else
            {
