...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteInternational2Data :  IEquatable<OBWriteInternational2Data>, IValidatableObject
    {
        ...
        public OBWriteInternational2Data(string consentId = default(string), OBWriteInternationalConsent3DataInitiation initiation = default(OBWriteInternationalConsent3DataInitiation))
        {
            // to ensure "consentId" is required (not null)
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteInternational2Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteInternational2Data and cannot be null");
            }
            else
            {
