...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternational2Data :  IEquatable<OBWriteInternational2Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternational2Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternational2Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternational2Data" /> class.
        /// </summary>
        ...
        public OBWriteInternational2Data(string consentId = default(string), OBWriteInternational2DataInitiation initiation = default(OBWriteInternational2DataInitiation))
        {
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteInternational2Data and cannot be null");
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteInternational2Data and cannot be null");
        }
        ...
        {
            return this.Equals(input as OBWriteInternational2Data);
        }

        /// <summary>
        /// Returns true if OBWriteInternational2Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternational2Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternational2Data input)
        {
            if (input == null)
                return false;
