...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteFileConsent3DataSCASupportData :  IEquatable<OBWriteFileConsent3DataSCASupportData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteFileConsent3DataSCASupportData" /> class.
        /// </summary>
        ...
        public OBWriteFileConsent3DataSCASupportData(RequestedSCAExemptionTypeEnum? requestedSCAExemptionType = default(RequestedSCAExemptionTypeEnum?), AppliedAuthenticationApproachEnum? appliedAuthenticationApproach = default(AppliedAuthenticationApproachEnum?), string referencePaymentOrderId = default(string))
        {
        ...
        {
            return this.Equals(input as OBWriteFileConsent3DataSCASupportData);
        }

        /// <summary>
        /// Returns true if OBWriteFileConsent3DataSCASupportData instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteFileConsent3DataSCASupportData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteFileConsent3DataSCASupportData input)
        {
            if (input == null)
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.RequestedSCAExemptionType != null)
                    hashCode = hashCode * 59 + this.RequestedSCAExemptionType.GetHashCode();
                if (this.AppliedAuthenticationApproach != null)
