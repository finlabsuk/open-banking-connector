...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteInternationalStandingOrder3Data :  IEquatable<OBWriteInternationalStandingOrder3Data>, IValidatableObject
    {
        ...
        public OBWriteInternationalStandingOrder3Data(string consentId = default(string), OBWriteInternationalStandingOrderConsent4DataInitiation initiation = default(OBWriteInternationalStandingOrderConsent4DataInitiation))
        {
            // to ensure "consentId" is required (not null)
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteInternationalStandingOrder3Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteInternationalStandingOrder3Data and cannot be null");
            }
            else
            {
