...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticScheduled2DataInitiationInstructedAmount :  IEquatable<OBWriteDomesticScheduled2DataInitiationInstructedAmount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticScheduled2DataInitiationInstructedAmount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticScheduled2DataInitiationInstructedAmount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticScheduled2DataInitiationInstructedAmount" /> class.
        /// </summary>
        ...
        public OBWriteDomesticScheduled2DataInitiationInstructedAmount(string amount = default(string), string currency = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for OBWriteDomesticScheduled2DataInitiationInstructedAmount and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for OBWriteDomesticScheduled2DataInitiationInstructedAmount and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OBWriteDomesticScheduled2DataInitiationInstructedAmount {\n");
        ...
        {
            return this.Equals(input as OBWriteDomesticScheduled2DataInitiationInstructedAmount);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticScheduled2DataInitiationInstructedAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticScheduled2DataInitiationInstructedAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticScheduled2DataInitiationInstructedAmount input)
        {
            if (input == null)
                return false;
