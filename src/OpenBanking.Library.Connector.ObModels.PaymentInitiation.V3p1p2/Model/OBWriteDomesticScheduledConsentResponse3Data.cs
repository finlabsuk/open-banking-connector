...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticScheduledConsentResponse3Data :  IEquatable<OBWriteDomesticScheduledConsentResponse3Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticScheduledConsentResponse3Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticScheduledConsentResponse3Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticScheduledConsentResponse3Data" /> class.
        /// </summary>
        ...
        public OBWriteDomesticScheduledConsentResponse3Data(StatusEnum status = default(StatusEnum), DateTime? statusUpdateDateTime = default(DateTime?), OBWriteFileConsent3DataSCASupportData sCASupportData = default(OBWriteFileConsent3DataSCASupportData), DateTime? creationDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), DateTime? cutOffDateTime = default(DateTime?), OBWriteFileConsent3DataAuthorisation authorisation = default(OBWriteFileConsent3DataAuthorisation), PermissionEnum permission = default(PermissionEnum), List<OBWriteDomesticStandingOrderResponse4DataCharges> charges = default(List<OBWriteDomesticStandingOrderResponse4DataCharges>), string consentId = default(string), OBWriteDomesticScheduled2DataInitiation initiation = default(OBWriteDomesticScheduled2DataInitiation), DateTime? expectedSettlementDateTime = default(DateTime?))
        {
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDomesticScheduledConsentResponse3Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDomesticScheduledConsentResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (permission == null)
            {
                throw new InvalidDataException("permission is a required property for OBWriteDomesticScheduledConsentResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDomesticScheduledConsentResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDomesticScheduledConsentResponse3Data and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDomesticScheduledConsentResponse3Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticScheduledConsentResponse3Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticScheduledConsentResponse3Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticScheduledConsentResponse3Data input)
        {
            if (input == null)
                return false;
