...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalStandingOrder3DataInitiationCreditorAgent :  IEquatable<OBWriteInternationalStandingOrder3DataInitiationCreditorAgent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalStandingOrder3DataInitiationCreditorAgent" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OBWriteInternationalStandingOrder3DataInitiationCreditorAgent);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalStandingOrder3DataInitiationCreditorAgent instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalStandingOrder3DataInitiationCreditorAgent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalStandingOrder3DataInitiationCreditorAgent input)
        {
            if (input == null)
                return false;
