...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteInternationalResponse3Data :  IEquatable<OBWriteInternationalResponse3Data>, IValidatableObject
    {
        ...
        public OBWriteInternationalResponse3Data(StatusEnum status = default(StatusEnum), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? creationDateTime = default(DateTime?), DateTime? expectedExecutionDateTime = default(DateTime?), OBWriteInternationalScheduledResponse3DataExchangeRateInformation exchangeRateInformation = default(OBWriteInternationalScheduledResponse3DataExchangeRateInformation), List<OBWriteDomesticStandingOrderResponse4DataCharges> charges = default(List<OBWriteDomesticStandingOrderResponse4DataCharges>), string internationalPaymentId = default(string), string consentId = default(string), OBWriteInternationalConsent3DataInitiation initiation = default(OBWriteInternationalConsent3DataInitiation), DateTime? expectedSettlementDateTime = default(DateTime?), OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation multiAuthorisation = default(OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation))
        {
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteInternationalResponse3Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteInternationalResponse3Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("internationalPaymentId is a required property for OBWriteInternationalResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteInternationalResponse3Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteInternationalResponse3Data and cannot be null");
            }
            else
            {
