...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteDomesticConsent3Data :  IEquatable<OBWriteDomesticConsent3Data>, IValidatableObject
    {
        ...
        public OBWriteDomesticConsent3Data(OBWriteFileConsent3DataSCASupportData sCASupportData = default(OBWriteFileConsent3DataSCASupportData), OBWriteFileConsent3DataAuthorisation authorisation = default(OBWriteFileConsent3DataAuthorisation), OBWriteDomesticResponse3DataInitiation initiation = default(OBWriteDomesticResponse3DataInitiation))
        {
            // to ensure "initiation" is required (not null)
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDomesticConsent3Data and cannot be null");
            }
            else
            {
