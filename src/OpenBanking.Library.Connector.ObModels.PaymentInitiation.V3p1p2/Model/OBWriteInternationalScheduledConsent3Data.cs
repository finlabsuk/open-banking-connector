...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteInternationalScheduledConsent3Data :  IEquatable<OBWriteInternationalScheduledConsent3Data>, IValidatableObject
    {
        ...
        public OBWriteInternationalScheduledConsent3Data(OBWriteFileConsent3DataSCASupportData sCASupportData = default(OBWriteFileConsent3DataSCASupportData), OBWriteFileConsent3DataAuthorisation authorisation = default(OBWriteFileConsent3DataAuthorisation), PermissionEnum permission = default(PermissionEnum), OBWriteInternationalScheduledResponse3DataInitiation initiation = default(OBWriteInternationalScheduledResponse3DataInitiation))
        {
            // to ensure "permission" is required (not null)
            if (permission == null)
            {
                throw new InvalidDataException("permission is a required property for OBWriteInternationalScheduledConsent3Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteInternationalScheduledConsent3Data and cannot be null");
            }
            else
            {
