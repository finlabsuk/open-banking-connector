...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternational2DataInitiationCreditorAgent :  IEquatable<OBWriteInternational2DataInitiationCreditorAgent>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OBWriteInternational2DataInitiationCreditorAgent);
        }

        /// <summary>
        /// Returns true if OBWriteInternational2DataInitiationCreditorAgent instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternational2DataInitiationCreditorAgent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternational2DataInitiationCreditorAgent input)
        {
            if (input == null)
                return false;
