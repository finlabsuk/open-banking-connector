...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalScheduled2DataInitiation :  IEquatable<OBWriteInternationalScheduled2DataInitiation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalScheduled2DataInitiation" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalScheduled2DataInitiation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalScheduled2DataInitiation" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OBWriteInternationalScheduled2DataInitiation);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalScheduled2DataInitiation instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalScheduled2DataInitiation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalScheduled2DataInitiation input)
        {
            if (input == null)
                return false;
