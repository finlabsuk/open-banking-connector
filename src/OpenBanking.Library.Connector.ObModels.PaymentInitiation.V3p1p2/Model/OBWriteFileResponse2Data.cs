...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteFileResponse2Data :  IEquatable<OBWriteFileResponse2Data>, IValidatableObject
    {
        ...
        public OBWriteFileResponse2Data(string filePaymentId = default(string), string consentId = default(string), DateTimeOffset creationDateTime = default(DateTimeOffset), StatusEnum status = default(StatusEnum), DateTimeOffset statusUpdateDateTime = default(DateTimeOffset), List<OBWriteDomesticConsentResponse3DataCharges> charges = default(List<OBWriteDomesticConsentResponse3DataCharges>), OBWriteFile2DataInitiation initiation = default(OBWriteFile2DataInitiation), OBWriteDomesticResponse3DataMultiAuthorisation multiAuthorisation = default(OBWriteDomesticResponse3DataMultiAuthorisation))
        {
