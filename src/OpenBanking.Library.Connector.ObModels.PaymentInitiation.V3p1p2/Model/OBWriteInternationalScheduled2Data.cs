...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalScheduled2Data :  IEquatable<OBWriteInternationalScheduled2Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalScheduled2Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalScheduled2Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalScheduled2Data" /> class.
        /// </summary>
        ...
        public OBWriteInternationalScheduled2Data(string consentId = default(string), OBWriteInternationalScheduled2DataInitiation initiation = default(OBWriteInternationalScheduled2DataInitiation))
        {
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteInternationalScheduled2Data and cannot be null");
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteInternationalScheduled2Data and cannot be null");
        }
        ...
        {
            return this.Equals(input as OBWriteInternationalScheduled2Data);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalScheduled2Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalScheduled2Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalScheduled2Data input)
        {
            if (input == null)
                return false;
