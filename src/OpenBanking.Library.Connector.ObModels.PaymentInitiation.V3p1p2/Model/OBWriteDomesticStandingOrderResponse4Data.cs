...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticStandingOrderResponse4Data :  IEquatable<OBWriteDomesticStandingOrderResponse4Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticStandingOrderResponse4Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderResponse4Data" /> class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrderResponse4Data(StatusEnum status = default(StatusEnum), DateTime? statusUpdateDateTime = default(DateTime?), DateTime? creationDateTime = default(DateTime?), List<OBWriteDomesticStandingOrderResponse4DataCharges> charges = default(List<OBWriteDomesticStandingOrderResponse4DataCharges>), string domesticStandingOrderId = default(string), string consentId = default(string), OBWriteDomesticStandingOrderResponse4DataInitiation initiation = default(OBWriteDomesticStandingOrderResponse4DataInitiation), OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation multiAuthorisation = default(OBWriteDomesticStandingOrderResponse4DataMultiAuthorisation))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OBWriteDomesticStandingOrderResponse4Data and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusUpdateDateTime is a required property for OBWriteDomesticStandingOrderResponse4Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creationDateTime is a required property for OBWriteDomesticStandingOrderResponse4Data and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("domesticStandingOrderId is a required property for OBWriteDomesticStandingOrderResponse4Data and cannot be null");
            }
            else
            {
            ...
            if (consentId == null)
            {
                throw new InvalidDataException("consentId is a required property for OBWriteDomesticStandingOrderResponse4Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDomesticStandingOrderResponse4Data and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDomesticStandingOrderResponse4Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticStandingOrderResponse4Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticStandingOrderResponse4Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticStandingOrderResponse4Data input)
        {
            if (input == null)
                return false;
