...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteInternationalStandingOrderConsent4Data :  IEquatable<OBWriteInternationalStandingOrderConsent4Data>, IValidatableObject
    {
        ...
        public OBWriteInternationalStandingOrderConsent4Data(PermissionEnum permission = default(PermissionEnum), OBWriteInternationalStandingOrder3DataInitiation initiation = default(OBWriteInternationalStandingOrder3DataInitiation), OBWriteDomesticConsent3DataAuthorisation authorisation = default(OBWriteDomesticConsent3DataAuthorisation), OBWriteDomesticConsent3DataSCASupportData sCASupportData = default(OBWriteDomesticConsent3DataSCASupportData))
        {
            this.Permission = permission;
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteInternationalStandingOrderConsent4Data and cannot be null");
