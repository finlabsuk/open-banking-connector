...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalStandingOrderConsent4Data :  IEquatable<OBWriteInternationalStandingOrderConsent4Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalStandingOrderConsent4Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalStandingOrderConsent4Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalStandingOrderConsent4Data" /> class.
        /// </summary>
        ...
        public OBWriteInternationalStandingOrderConsent4Data(OBWriteFileConsent3DataSCASupportData sCASupportData = default(OBWriteFileConsent3DataSCASupportData), OBWriteFileConsent3DataAuthorisation authorisation = default(OBWriteFileConsent3DataAuthorisation), PermissionEnum permission = default(PermissionEnum), OBWriteInternationalStandingOrderConsent4DataInitiation initiation = default(OBWriteInternationalStandingOrderConsent4DataInitiation))
        {
            // to ensure "permission" is required (not null)
            if (permission == null)
            {
                throw new InvalidDataException("permission is a required property for OBWriteInternationalStandingOrderConsent4Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteInternationalStandingOrderConsent4Data and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteInternationalStandingOrderConsent4Data);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalStandingOrderConsent4Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalStandingOrderConsent4Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalStandingOrderConsent4Data input)
        {
            if (input == null)
                return false;
