...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteFile2Data :  IEquatable<OBWriteFile2Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteFile2Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteFile2Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteFile2Data" /> class.
        /// </summary>
        ...
        public OBWriteFile2Data(string consentId = default(string), OBWriteFile2DataInitiation initiation = default(OBWriteFile2DataInitiation))
        {
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteFile2Data and cannot be null");
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteFile2Data and cannot be null");
        }
        ...
        {
            return this.Equals(input as OBWriteFile2Data);
        }

        /// <summary>
        /// Returns true if OBWriteFile2Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteFile2Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteFile2Data input)
        {
            if (input == null)
                return false;
