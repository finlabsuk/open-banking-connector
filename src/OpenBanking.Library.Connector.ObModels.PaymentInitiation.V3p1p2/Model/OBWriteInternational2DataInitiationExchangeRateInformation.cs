...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternational2DataInitiationExchangeRateInformation :  IEquatable<OBWriteInternational2DataInitiationExchangeRateInformation>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternational2DataInitiationExchangeRateInformation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternational2DataInitiationExchangeRateInformation" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OBWriteInternational2DataInitiationExchangeRateInformation);
        }

        /// <summary>
        /// Returns true if OBWriteInternational2DataInitiationExchangeRateInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternational2DataInitiationExchangeRateInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternational2DataInitiationExchangeRateInformation input)
        {
            if (input == null)
                return false;
