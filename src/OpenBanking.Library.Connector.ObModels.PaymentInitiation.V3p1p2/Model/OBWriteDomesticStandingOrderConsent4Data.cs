...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteDomesticStandingOrderConsent4Data :  IEquatable<OBWriteDomesticStandingOrderConsent4Data>, IValidatableObject
    {
        ...
        public OBWriteDomesticStandingOrderConsent4Data(PermissionEnum permission = default(PermissionEnum), OBWriteDomesticStandingOrder3DataInitiation initiation = default(OBWriteDomesticStandingOrder3DataInitiation), OBWriteDomesticConsent3DataAuthorisation authorisation = default(OBWriteDomesticConsent3DataAuthorisation), OBWriteDomesticConsent3DataSCASupportData sCASupportData = default(OBWriteDomesticConsent3DataSCASupportData))
        {
            this.Permission = permission;
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDomesticStandingOrderConsent4Data and cannot be null");
