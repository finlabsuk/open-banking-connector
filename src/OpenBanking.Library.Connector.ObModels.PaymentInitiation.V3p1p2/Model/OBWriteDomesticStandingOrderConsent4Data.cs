...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticStandingOrderConsent4Data :  IEquatable<OBWriteDomesticStandingOrderConsent4Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderConsent4Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticStandingOrderConsent4Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderConsent4Data" /> class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrderConsent4Data(OBWriteFileConsent3DataSCASupportData sCASupportData = default(OBWriteFileConsent3DataSCASupportData), OBWriteFileConsent3DataAuthorisation authorisation = default(OBWriteFileConsent3DataAuthorisation), PermissionEnum permission = default(PermissionEnum), OBWriteDomesticStandingOrderResponse4DataInitiation initiation = default(OBWriteDomesticStandingOrderResponse4DataInitiation))
        {
            // to ensure "permission" is required (not null)
            if (permission == null)
            {
                throw new InvalidDataException("permission is a required property for OBWriteDomesticStandingOrderConsent4Data and cannot be null");
            }
            else
            {
            ...
            if (initiation == null)
            {
                throw new InvalidDataException("initiation is a required property for OBWriteDomesticStandingOrderConsent4Data and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OBWriteDomesticStandingOrderConsent4Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticStandingOrderConsent4Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticStandingOrderConsent4Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticStandingOrderConsent4Data input)
        {
            if (input == null)
                return false;
