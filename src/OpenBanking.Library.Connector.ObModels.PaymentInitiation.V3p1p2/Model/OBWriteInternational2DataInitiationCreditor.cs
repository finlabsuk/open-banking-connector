...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternational2DataInitiationCreditor :  IEquatable<OBWriteInternational2DataInitiationCreditor>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as OBWriteInternational2DataInitiationCreditor);
        }

        /// <summary>
        /// Returns true if OBWriteInternational2DataInitiationCreditor instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternational2DataInitiationCreditor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternational2DataInitiationCreditor input)
        {
            if (input == null)
                return false;
