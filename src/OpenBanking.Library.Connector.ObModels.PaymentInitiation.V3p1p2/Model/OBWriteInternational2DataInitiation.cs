...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternational2DataInitiation :  IEquatable<OBWriteInternational2DataInitiation>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternational2DataInitiation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternational2DataInitiation" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OBWriteInternational2DataInitiation);
        }

        /// <summary>
        /// Returns true if OBWriteInternational2DataInitiation instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternational2DataInitiation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternational2DataInitiation input)
        {
            if (input == null)
                return false;
