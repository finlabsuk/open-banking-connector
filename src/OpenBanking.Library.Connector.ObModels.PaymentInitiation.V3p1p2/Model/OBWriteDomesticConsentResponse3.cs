...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p2.Model
{
    ...
    public partial class OBWriteDomesticConsentResponse3 :  IEquatable<OBWriteDomesticConsentResponse3>, IValidatableObject
    {
        ...
        public OBWriteDomesticConsentResponse3(OBWriteDomesticConsentResponse3Data data = default(OBWriteDomesticConsentResponse3Data), OBRisk1 risk = default(OBRisk1), Links links = default(Links), Meta meta = default(Meta))
        {
            ...
            this.Data = data ?? throw new ArgumentNullException("data is a required property for OBWriteDomesticConsentResponse3 and cannot be null");
            // to ensure "risk" is required (not null)
            this.Risk = risk ?? throw new ArgumentNullException("risk is a required property for OBWriteDomesticConsentResponse3 and cannot be null");
            this.Links = links;
            this.Meta = meta;
        }
