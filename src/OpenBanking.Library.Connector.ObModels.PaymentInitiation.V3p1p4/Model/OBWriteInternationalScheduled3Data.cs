...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalScheduled3Data :  IEquatable<OBWriteInternationalScheduled3Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalScheduled3Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalScheduled3Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalScheduled3Data" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OBWriteInternationalScheduled3Data);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalScheduled3Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalScheduled3Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalScheduled3Data input)
        {
            if (input == null)
                return false;
