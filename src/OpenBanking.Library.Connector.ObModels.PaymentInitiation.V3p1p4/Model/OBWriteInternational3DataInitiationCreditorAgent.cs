...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternational3DataInitiationCreditorAgent :  IEquatable<OBWriteInternational3DataInitiationCreditorAgent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternational3DataInitiationCreditorAgent" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OBWriteInternational3DataInitiationCreditorAgent);
        }

        /// <summary>
        /// Returns true if OBWriteInternational3DataInitiationCreditorAgent instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternational3DataInitiationCreditorAgent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternational3DataInitiationCreditorAgent input)
        {
            if (input == null)
                return false;
