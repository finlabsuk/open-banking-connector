...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalStandingOrder4DataInitiationCreditorAccount :  IEquatable<OBWriteInternationalStandingOrder4DataInitiationCreditorAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalStandingOrder4DataInitiationCreditorAccount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalStandingOrder4DataInitiationCreditorAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalStandingOrder4DataInitiationCreditorAccount" /> class.
        /// </summary>
        ...
        public OBWriteInternationalStandingOrder4DataInitiationCreditorAccount(string schemeName = default(string), string identification = default(string), string name = default(string), string secondaryIdentification = default(string))
        {
            // to ensure "schemeName" is required (not null)
            this.SchemeName = schemeName ?? throw new ArgumentNullException("schemeName is a required property for OBWriteInternationalStandingOrder4DataInitiationCreditorAccount and cannot be null");
            // to ensure "identification" is required (not null)
            this.Identification = identification ?? throw new ArgumentNullException("identification is a required property for OBWriteInternationalStandingOrder4DataInitiationCreditorAccount and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for OBWriteInternationalStandingOrder4DataInitiationCreditorAccount and cannot be null");
        ...
        {
            return this.Equals(input as OBWriteInternationalStandingOrder4DataInitiationCreditorAccount);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalStandingOrder4DataInitiationCreditorAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalStandingOrder4DataInitiationCreditorAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalStandingOrder4DataInitiationCreditorAccount input)
        {
            if (input == null)
                return false;
