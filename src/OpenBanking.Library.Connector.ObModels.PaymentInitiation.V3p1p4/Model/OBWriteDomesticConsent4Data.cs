...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [TargetApiEquivalent(typeof(ObModels.PaymentInitiation.V3p1p1.Model.OBWriteDataDomesticConsent2))]
    [DataContract]
    public partial class OBWriteDomesticConsent4Data :  IEquatable<OBWriteDomesticConsent4Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticConsent4Data" /> class.
        /// </summary>
        [JsonConstructor]
        ...
        public OBWriteDomesticConsent4Data(ReadRefundAccountEnum? readRefundAccount = default(ReadRefundAccountEnum?), OBWriteDomestic2DataInitiation initiation = default(OBWriteDomestic2DataInitiation), OBWriteDomesticConsent4DataAuthorisation authorisation = default(OBWriteDomesticConsent4DataAuthorisation), OBWriteDomesticConsent4DataSCASupportData sCASupportData = default(OBWriteDomesticConsent4DataSCASupportData))
        {
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDomesticConsent4Data and cannot be null");
        ...
        {
            return this.Equals(input as OBWriteDomesticConsent4Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticConsent4Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticConsent4Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticConsent4Data input)
        {
            if (input == null)
                return false;
