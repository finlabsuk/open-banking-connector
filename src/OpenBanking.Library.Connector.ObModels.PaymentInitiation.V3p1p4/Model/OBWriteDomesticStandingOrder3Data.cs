...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticStandingOrder3Data :  IEquatable<OBWriteDomesticStandingOrder3Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrder3Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticStandingOrder3Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrder3Data" /> class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrder3Data(string consentId = default(string), OBWriteDomesticStandingOrder3DataInitiation initiation = default(OBWriteDomesticStandingOrder3DataInitiation))
        {
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteDomesticStandingOrder3Data and cannot be null");
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDomesticStandingOrder3Data and cannot be null");
        }
        ...
        {
            return this.Equals(input as OBWriteDomesticStandingOrder3Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticStandingOrder3Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticStandingOrder3Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticStandingOrder3Data input)
        {
            if (input == null)
                return false;
