...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalResponse4DataRefundCreditor :  IEquatable<OBWriteInternationalResponse4DataRefundCreditor>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalResponse4DataRefundCreditor" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OBWriteInternationalResponse4DataRefundCreditor);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalResponse4DataRefundCreditor instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalResponse4DataRefundCreditor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalResponse4DataRefundCreditor input)
        {
            if (input == null)
                return false;
