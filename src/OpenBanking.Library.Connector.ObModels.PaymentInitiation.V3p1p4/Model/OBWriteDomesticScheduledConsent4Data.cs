...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticScheduledConsent4Data :  IEquatable<OBWriteDomesticScheduledConsent4Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticScheduledConsent4Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticScheduledConsent4Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticScheduledConsent4Data" /> class.
        /// </summary>
        ...
        public OBWriteDomesticScheduledConsent4Data(PermissionEnum permission = default(PermissionEnum), ReadRefundAccountEnum? readRefundAccount = default(ReadRefundAccountEnum?), OBWriteDomesticScheduled2DataInitiation initiation = default(OBWriteDomesticScheduled2DataInitiation), OBWriteDomesticConsent4DataAuthorisation authorisation = default(OBWriteDomesticConsent4DataAuthorisation), OBWriteDomesticConsent4DataSCASupportData sCASupportData = default(OBWriteDomesticConsent4DataSCASupportData))
        {
            ...
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDomesticScheduledConsent4Data and cannot be null");
        ...
        {
            return this.Equals(input as OBWriteDomesticScheduledConsent4Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticScheduledConsent4Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticScheduledConsent4Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticScheduledConsent4Data input)
        {
            if (input == null)
                return false;
