...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternational3DataInitiation :  IEquatable<OBWriteInternational3DataInitiation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternational3DataInitiation" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternational3DataInitiation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternational3DataInitiation" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OBWriteInternational3DataInitiation);
        }

        /// <summary>
        /// Returns true if OBWriteInternational3DataInitiation instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternational3DataInitiation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternational3DataInitiation input)
        {
            if (input == null)
                return false;
