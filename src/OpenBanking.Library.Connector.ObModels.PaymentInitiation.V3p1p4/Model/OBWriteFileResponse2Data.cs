...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    public partial class OBWriteFileResponse2Data :  IEquatable<OBWriteFileResponse2Data>, IValidatableObject
    {
        ...
        public OBWriteFileResponse2Data(string filePaymentId = default(string), string consentId = default(string), DateTimeOffset creationDateTime = default(DateTimeOffset), StatusEnum status = default(StatusEnum), DateTimeOffset statusUpdateDateTime = default(DateTimeOffset), List<OBWriteDomesticConsentResponse4DataCharges> charges = default(List<OBWriteDomesticConsentResponse4DataCharges>), OBWriteFile2DataInitiation initiation = default(OBWriteFile2DataInitiation), OBWriteDomesticResponse4DataMultiAuthorisation multiAuthorisation = default(OBWriteDomesticResponse4DataMultiAuthorisation))
        {
            // to ensure "filePaymentId" is required (not null)
            this.FilePaymentId = filePaymentId ?? throw new ArgumentNullException("filePaymentId is a required property for OBWriteFileResponse2Data and cannot be null");
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteFileResponse2Data and cannot be null");
            this.CreationDateTime = creationDateTime;
            this.Status = status;
            this.StatusUpdateDateTime = statusUpdateDateTime;
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteFileResponse2Data and cannot be null");
