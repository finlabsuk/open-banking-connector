...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticStandingOrder3DataInitiationDebtorAccount :  IEquatable<OBWriteDomesticStandingOrder3DataInitiationDebtorAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrder3DataInitiationDebtorAccount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticStandingOrder3DataInitiationDebtorAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrder3DataInitiationDebtorAccount" /> class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrder3DataInitiationDebtorAccount(string schemeName = default(string), string identification = default(string), string name = default(string), string secondaryIdentification = default(string))
        {
            // to ensure "schemeName" is required (not null)
            this.SchemeName = schemeName ?? throw new ArgumentNullException("schemeName is a required property for OBWriteDomesticStandingOrder3DataInitiationDebtorAccount and cannot be null");
            // to ensure "identification" is required (not null)
            this.Identification = identification ?? throw new ArgumentNullException("identification is a required property for OBWriteDomesticStandingOrder3DataInitiationDebtorAccount and cannot be null");
            this.Name = name;
        ...
        {
            return this.Equals(input as OBWriteDomesticStandingOrder3DataInitiationDebtorAccount);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticStandingOrder3DataInitiationDebtorAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticStandingOrder3DataInitiationDebtorAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticStandingOrder3DataInitiationDebtorAccount input)
        {
            if (input == null)
                return false;
