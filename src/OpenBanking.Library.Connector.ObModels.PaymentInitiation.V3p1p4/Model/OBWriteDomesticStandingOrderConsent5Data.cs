...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticStandingOrderConsent5Data :  IEquatable<OBWriteDomesticStandingOrderConsent5Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderConsent5Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticStandingOrderConsent5Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderConsent5Data" /> class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrderConsent5Data(PermissionEnum permission = default(PermissionEnum), ReadRefundAccountEnum? readRefundAccount = default(ReadRefundAccountEnum?), OBWriteDomesticStandingOrder3DataInitiation initiation = default(OBWriteDomesticStandingOrder3DataInitiation), OBWriteDomesticConsent4DataAuthorisation authorisation = default(OBWriteDomesticConsent4DataAuthorisation), OBWriteDomesticConsent4DataSCASupportData sCASupportData = default(OBWriteDomesticConsent4DataSCASupportData))
        {
            this.Permission = permission;
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDomesticStandingOrderConsent5Data and cannot be null");
        ...
        {
            return this.Equals(input as OBWriteDomesticStandingOrderConsent5Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticStandingOrderConsent5Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticStandingOrderConsent5Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticStandingOrderConsent5Data input)
        {
            if (input == null)
                return false;
