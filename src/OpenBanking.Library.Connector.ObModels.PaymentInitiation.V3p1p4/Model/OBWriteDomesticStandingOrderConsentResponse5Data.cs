...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticStandingOrderConsentResponse5Data :  IEquatable<OBWriteDomesticStandingOrderConsentResponse5Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderConsentResponse5Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticStandingOrderConsentResponse5Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticStandingOrderConsentResponse5Data" /> class.
        /// </summary>
        ...
        public OBWriteDomesticStandingOrderConsentResponse5Data(string consentId = default(string), DateTimeOffset creationDateTime = default(DateTimeOffset), StatusEnum status = default(StatusEnum), DateTimeOffset statusUpdateDateTime = default(DateTimeOffset), PermissionEnum permission = default(PermissionEnum), ReadRefundAccountEnum? readRefundAccount = default(ReadRefundAccountEnum?), DateTimeOffset cutOffDateTime = default(DateTimeOffset), List<OBWriteDomesticConsentResponse4DataCharges> charges = default(List<OBWriteDomesticConsentResponse4DataCharges>), OBWriteDomesticStandingOrder3DataInitiation initiation = default(OBWriteDomesticStandingOrder3DataInitiation), OBWriteDomesticConsent4DataAuthorisation authorisation = default(OBWriteDomesticConsent4DataAuthorisation), OBWriteDomesticConsent4DataSCASupportData sCASupportData = default(OBWriteDomesticConsent4DataSCASupportData))
        {
            ...
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteDomesticStandingOrderConsentResponse5Data and cannot be null");
            this.CreationDateTime = creationDateTime;
            this.Status = status;
            this.StatusUpdateDateTime = statusUpdateDateTime;
            this.Permission = permission;
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDomesticStandingOrderConsentResponse5Data and cannot be null");
        ...
        {
            return this.Equals(input as OBWriteDomesticStandingOrderConsentResponse5Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticStandingOrderConsentResponse5Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticStandingOrderConsentResponse5Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticStandingOrderConsentResponse5Data input)
        {
            if (input == null)
                return false;
