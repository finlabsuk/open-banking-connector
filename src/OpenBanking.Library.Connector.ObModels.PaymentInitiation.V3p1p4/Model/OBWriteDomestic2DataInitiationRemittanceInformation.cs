...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [TargetApiEquivalent(typeof(ObModels.PaymentInitiation.V3p1p1.Model.OBRemittanceInformation1))]
    [SourceApiEquivalent(typeof(ObModels.PaymentInitiation.V3p1p1.Model.OBRemittanceInformation1))]
    [DataContract]
