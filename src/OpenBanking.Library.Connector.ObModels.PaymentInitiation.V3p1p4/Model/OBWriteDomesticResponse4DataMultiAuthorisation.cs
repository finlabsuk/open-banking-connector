...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticResponse4DataMultiAuthorisation :  IEquatable<OBWriteDomesticResponse4DataMultiAuthorisation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticResponse4DataMultiAuthorisation" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticResponse4DataMultiAuthorisation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticResponse4DataMultiAuthorisation" /> class.
        /// </summary>
        ...
        public OBWriteDomesticResponse4DataMultiAuthorisation(StatusEnum status = default(StatusEnum), int numberRequired = default(int), int numberReceived = default(int), DateTimeOffset lastUpdateDateTime = default(DateTimeOffset), DateTimeOffset expirationDateTime = default(DateTimeOffset))
        {
            this.Status = status;
        ...
        {
            return this.Equals(input as OBWriteDomesticResponse4DataMultiAuthorisation);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticResponse4DataMultiAuthorisation instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticResponse4DataMultiAuthorisation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticResponse4DataMultiAuthorisation input)
        {
            if (input == null)
                return false;
