...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalScheduledResponse5Data :  IEquatable<OBWriteInternationalScheduledResponse5Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalScheduledResponse5Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalScheduledResponse5Data" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OBWriteInternationalScheduledResponse5Data);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalScheduledResponse5Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalScheduledResponse5Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalScheduledResponse5Data input)
        {
            if (input == null)
                return false;
