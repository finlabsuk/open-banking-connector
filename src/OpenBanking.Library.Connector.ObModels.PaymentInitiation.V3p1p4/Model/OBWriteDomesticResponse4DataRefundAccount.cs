...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticResponse4DataRefundAccount :  IEquatable<OBWriteDomesticResponse4DataRefundAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticResponse4DataRefundAccount" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticResponse4DataRefundAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticResponse4DataRefundAccount" /> class.
        /// </summary>
        ...
        public OBWriteDomesticResponse4DataRefundAccount(string schemeName = default(string), string identification = default(string), string name = default(string), string secondaryIdentification = default(string))
        {
            // to ensure "schemeName" is required (not null)
            this.SchemeName = schemeName ?? throw new ArgumentNullException("schemeName is a required property for OBWriteDomesticResponse4DataRefundAccount and cannot be null");
            // to ensure "identification" is required (not null)
            this.Identification = identification ?? throw new ArgumentNullException("identification is a required property for OBWriteDomesticResponse4DataRefundAccount and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for OBWriteDomesticResponse4DataRefundAccount and cannot be null");
        ...
        {
            return this.Equals(input as OBWriteDomesticResponse4DataRefundAccount);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticResponse4DataRefundAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticResponse4DataRefundAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticResponse4DataRefundAccount input)
        {
            if (input == null)
                return false;
