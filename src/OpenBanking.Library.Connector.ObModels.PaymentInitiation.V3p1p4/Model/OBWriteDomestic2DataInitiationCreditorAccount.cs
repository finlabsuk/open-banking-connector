...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [TargetApiEquivalent(typeof(ObModels.PaymentInitiation.V3p1p1.Model.OBCashAccountCreditor3))]
    [SourceApiEquivalent(typeof(ObModels.PaymentInitiation.V3p1p1.Model.OBCashAccountCreditor3))]
    [DataContract]
    public partial class OBWriteDomestic2DataInitiationCreditorAccount :  IEquatable<OBWriteDomestic2DataInitiationCreditorAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomestic2DataInitiationCreditorAccount" /> class.
        /// </summary>
        [JsonConstructor]
        ...
        public OBWriteDomestic2DataInitiationCreditorAccount(string schemeName = default(string), string identification = default(string), string name = default(string), string secondaryIdentification = default(string))
        {
            // to ensure "schemeName" is required (not null)
            this.SchemeName = schemeName ?? throw new ArgumentNullException("schemeName is a required property for OBWriteDomestic2DataInitiationCreditorAccount and cannot be null");
            // to ensure "identification" is required (not null)
            this.Identification = identification ?? throw new ArgumentNullException("identification is a required property for OBWriteDomestic2DataInitiationCreditorAccount and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for OBWriteDomestic2DataInitiationCreditorAccount and cannot be null");
        ...
        {
            return this.Equals(input as OBWriteDomestic2DataInitiationCreditorAccount);
        }

        /// <summary>
        /// Returns true if OBWriteDomestic2DataInitiationCreditorAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomestic2DataInitiationCreditorAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomestic2DataInitiationCreditorAccount input)
        {
            if (input == null)
                return false;
