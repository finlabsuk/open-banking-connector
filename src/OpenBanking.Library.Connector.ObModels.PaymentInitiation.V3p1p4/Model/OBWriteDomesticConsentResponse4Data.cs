...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [SourceApiEquivalent(typeof(ObModels.PaymentInitiation.V3p1p1.Model.OBWriteDataDomesticConsentResponse2))]
    [DataContract]
    public partial class OBWriteDomesticConsentResponse4Data :  IEquatable<OBWriteDomesticConsentResponse4Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticConsentResponse4Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticConsentResponse4Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticConsentResponse4Data" /> class.
        /// </summary>
        ...
        public OBWriteDomesticConsentResponse4Data(string consentId = default(string), DateTimeOffset creationDateTime = default(DateTimeOffset), StatusEnum status = default(StatusEnum), DateTimeOffset statusUpdateDateTime = default(DateTimeOffset), ReadRefundAccountEnum? readRefundAccount = default(ReadRefundAccountEnum?), DateTimeOffset cutOffDateTime = default(DateTimeOffset), DateTimeOffset expectedExecutionDateTime = default(DateTimeOffset), DateTimeOffset expectedSettlementDateTime = default(DateTimeOffset), List<OBWriteDomesticConsentResponse4DataCharges> charges = default(List<OBWriteDomesticConsentResponse4DataCharges>), OBWriteDomestic2DataInitiation initiation = default(OBWriteDomestic2DataInitiation), OBWriteDomesticConsent4DataAuthorisation authorisation = default(OBWriteDomesticConsent4DataAuthorisation), OBWriteDomesticConsent4DataSCASupportData sCASupportData = default(OBWriteDomesticConsent4DataSCASupportData))
        {
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteDomesticConsentResponse4Data and cannot be null");
            this.CreationDateTime = creationDateTime;
            this.Status = status;
            this.StatusUpdateDateTime = statusUpdateDateTime;
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDomesticConsentResponse4Data and cannot be null");
        ...
        {
            return this.Equals(input as OBWriteDomesticConsentResponse4Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticConsentResponse4Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticConsentResponse4Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticConsentResponse4Data input)
        {
            if (input == null)
                return false;
