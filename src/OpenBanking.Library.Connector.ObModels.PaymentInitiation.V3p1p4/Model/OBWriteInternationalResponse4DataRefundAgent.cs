...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalResponse4DataRefundAgent :  IEquatable<OBWriteInternationalResponse4DataRefundAgent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalResponse4DataRefundAgent" /> class.
        /// </summary>
        ...
        public OBWriteInternationalResponse4DataRefundAgent(string schemeName = default(string), string identification = default(string), string name = default(string), OBPostalAddress6 postalAddress = default(OBPostalAddress6))
        {
        ...
        {
            return this.Equals(input as OBWriteInternationalResponse4DataRefundAgent);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalResponse4DataRefundAgent instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalResponse4DataRefundAgent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalResponse4DataRefundAgent input)
        {
            if (input == null)
                return false;
