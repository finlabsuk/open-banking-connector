...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [TargetApiEquivalent(typeof(ObModels.PaymentInitiation.V3p1p1.Model.OBCashAccountDebtor4))]
    [DataContract]
    public partial class OBWriteDomestic2DataInitiationDebtorAccount :  IEquatable<OBWriteDomestic2DataInitiationDebtorAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomestic2DataInitiationDebtorAccount" /> class.
        /// </summary>
        [JsonConstructor]
        ...
        public OBWriteDomestic2DataInitiationDebtorAccount(string schemeName = default(string), string identification = default(string), string name = default(string), string secondaryIdentification = default(string))
        {
            // to ensure "schemeName" is required (not null)
            this.SchemeName = schemeName ?? throw new ArgumentNullException("schemeName is a required property for OBWriteDomestic2DataInitiationDebtorAccount and cannot be null");
            // to ensure "identification" is required (not null)
            this.Identification = identification ?? throw new ArgumentNullException("identification is a required property for OBWriteDomestic2DataInitiationDebtorAccount and cannot be null");
            this.Name = name;
        ...
        {
            return this.Equals(input as OBWriteDomestic2DataInitiationDebtorAccount);
        }

        /// <summary>
        /// Returns true if OBWriteDomestic2DataInitiationDebtorAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomestic2DataInitiationDebtorAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomestic2DataInitiationDebtorAccount input)
        {
            if (input == null)
                return false;
