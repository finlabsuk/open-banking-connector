...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteInternationalResponse4Data :  IEquatable<OBWriteInternationalResponse4Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalResponse4Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteInternationalResponse4Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteInternationalResponse4Data" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OBWriteInternationalResponse4Data);
        }

        /// <summary>
        /// Returns true if OBWriteInternationalResponse4Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteInternationalResponse4Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteInternationalResponse4Data input)
        {
            if (input == null)
                return false;
