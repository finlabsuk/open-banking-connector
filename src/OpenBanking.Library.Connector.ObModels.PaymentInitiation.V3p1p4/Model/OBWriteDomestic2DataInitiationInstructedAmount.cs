...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [TargetApiEquivalent(typeof(ObModels.PaymentInitiation.V3p1p1.Model.OBDomestic2InstructedAmount))]
    [SourceApiEquivalent(typeof(ObModels.PaymentInitiation.V3p1p1.Model.OBDomestic2InstructedAmount))]
    [DataContract]
    public partial class OBWriteDomestic2DataInitiationInstructedAmount :  IEquatable<OBWriteDomestic2DataInitiationInstructedAmount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomestic2DataInitiationInstructedAmount" /> class.
        /// </summary>
        [JsonConstructor]
        ...
        public OBWriteDomestic2DataInitiationInstructedAmount(string amount = default(string), string currency = default(string))
        {
            // to ensure "amount" is required (not null)
            this.Amount = amount ?? throw new ArgumentNullException("amount is a required property for OBWriteDomestic2DataInitiationInstructedAmount and cannot be null");
            // to ensure "currency" is required (not null)
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for OBWriteDomestic2DataInitiationInstructedAmount and cannot be null");
        }
        ...
        {
            return this.Equals(input as OBWriteDomestic2DataInitiationInstructedAmount);
        }

        /// <summary>
        /// Returns true if OBWriteDomestic2DataInitiationInstructedAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomestic2DataInitiationInstructedAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomestic2DataInitiationInstructedAmount input)
        {
            if (input == null)
                return false;
