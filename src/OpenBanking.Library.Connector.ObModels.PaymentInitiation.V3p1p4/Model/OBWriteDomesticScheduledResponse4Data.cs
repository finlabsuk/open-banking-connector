...
namespace FinnovationLabs.OpenBanking.Library.Connector.ObModels.PaymentInitiation.V3p1p4.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OBWriteDomesticScheduledResponse4Data :  IEquatable<OBWriteDomesticScheduledResponse4Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticScheduledResponse4Data" /> class.
        /// </summary>
        [JsonConstructor]
        protected OBWriteDomesticScheduledResponse4Data() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OBWriteDomesticScheduledResponse4Data" /> class.
        /// </summary>
        ...
        public OBWriteDomesticScheduledResponse4Data(string domesticScheduledPaymentId = default(string), string consentId = default(string), DateTimeOffset creationDateTime = default(DateTimeOffset), StatusEnum status = default(StatusEnum), DateTimeOffset statusUpdateDateTime = default(DateTimeOffset), DateTimeOffset expectedExecutionDateTime = default(DateTimeOffset), DateTimeOffset expectedSettlementDateTime = default(DateTimeOffset), OBWriteDomesticResponse4DataRefund refund = default(OBWriteDomesticResponse4DataRefund), List<OBWriteDomesticConsentResponse4DataCharges> charges = default(List<OBWriteDomesticConsentResponse4DataCharges>), OBWriteDomesticScheduled2DataInitiation initiation = default(OBWriteDomesticScheduled2DataInitiation), OBWriteDomesticResponse4DataMultiAuthorisation multiAuthorisation = default(OBWriteDomesticResponse4DataMultiAuthorisation))
        {
            ...
            this.DomesticScheduledPaymentId = domesticScheduledPaymentId ?? throw new ArgumentNullException("domesticScheduledPaymentId is a required property for OBWriteDomesticScheduledResponse4Data and cannot be null");
            // to ensure "consentId" is required (not null)
            this.ConsentId = consentId ?? throw new ArgumentNullException("consentId is a required property for OBWriteDomesticScheduledResponse4Data and cannot be null");
            this.CreationDateTime = creationDateTime;
            this.Status = status;
            this.StatusUpdateDateTime = statusUpdateDateTime;
            // to ensure "initiation" is required (not null)
            this.Initiation = initiation ?? throw new ArgumentNullException("initiation is a required property for OBWriteDomesticScheduledResponse4Data and cannot be null");
        ...
        {
            return this.Equals(input as OBWriteDomesticScheduledResponse4Data);
        }

        /// <summary>
        /// Returns true if OBWriteDomesticScheduledResponse4Data instances are equal
        /// </summary>
        /// <param name="input">Instance of OBWriteDomesticScheduledResponse4Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OBWriteDomesticScheduledResponse4Data input)
        {
            if (input == null)
                return false;
